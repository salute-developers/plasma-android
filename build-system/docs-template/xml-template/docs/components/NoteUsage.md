...
только для компонента [LinkButton](Button/LinkButtonUsage.md#стиль-linkbutton), для стилизации других компонентов необходимо  
...
Альтернативным вариантом является добавление компонента ImageView, с установленной заранее иконкой.
