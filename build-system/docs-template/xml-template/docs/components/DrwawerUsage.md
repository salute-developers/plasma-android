...
использования в качестве выдвижной панели другие view, для этого необходимо задать у этой view атрибут  
...
|sd_background|будет ли основной контент смещаться вместе с панелью|color, reference|
...
|sd_closeIconPadding|отступ от иконки закрытия|dimension|
...
|   sd_wrapContent    | позволяет Drawer занять ширину по контенту, когда sd_drawerPlacement left или right |boolean|
