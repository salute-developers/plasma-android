...
Define how DS Builder resolves local `.sdds/components` as a fallback components source, mirroring the existing
theme fallback in `theme-builder-dsbuilder-source`.
## Requirements
