# combobox-compose-motion Specification

## Purpose

Определить подключение существующего Motion API к полю и меню ComboBox, сохранив совместимость вызовов, поведение ввода и управления списком, независимость от миграции DropdownMenu и полную проверку Compose-библиотек.
