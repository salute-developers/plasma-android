# segment-item-compose-motion Specification

## Purpose

Определить поддержку StatefulValue и Motion API в Compose-компоненте SegmentItem: состояния и переходы текста, цветов и размеров, общий контекст встроенного Counter, корректную раскладку слотов и совместимость существующего API.
