...
public enum class ListItemViewColorState(
    ...
    DEFAULT(intArrayOf(R.attr.serv_listitemview_state_default)),
    POSITIVE(intArrayOf(R.attr.serv_listitemview_state_positive)),
    NEGATIVE(intArrayOf(R.attr.serv_listitemview_state_negative)),
}
...
internal class ListItemViewColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(
            R.styleable.ListItemView_serv_listitemviewColors,
            0,
        )
        typedArray.recycle()
