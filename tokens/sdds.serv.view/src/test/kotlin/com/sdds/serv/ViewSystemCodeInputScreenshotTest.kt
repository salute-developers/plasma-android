...
class ViewSystemCodeInputScreenshotTest(
    ...
    override fun testCodeInputLCodeLengthFourCaptionLeft() {
        themedComponent {
            codeInputCodeLengthFourCaptionLeft(R.style.Serv_Sdds_ComponentOverlays_CodeInputL)
        }
    }
    ...
    override fun testCodeInputMCodeLengthFiveCaptionCenter() {
        themedComponent {
            codeInputCodeLengthFiveCaptionCenter(R.style.Serv_Sdds_ComponentOverlays_CodeInputM)
        }
    }
    ...
    override fun testCodeInputSCodeLengthSixCaptionCenter() {
        themedComponent {
            codeInputCodeLengthSixCaptionCenter(R.style.Serv_Sdds_ComponentOverlays_CodeInputS)
        }
    }
    ...
    override fun testCodeInputLCodeLengthSixNoCaption() {
        themedComponent {
            codeInputCodeLengthSixNoCaption(R.style.Serv_Sdds_ComponentOverlays_CodeInputL)
        }
    }
    ...
    override fun testCodeInputCodeMLengthSixHidden() {
        themedComponent(
            ...
            codeInputCodeLengthSixHidden(R.style.Serv_Sdds_ComponentOverlays_CodeInputM)
        }
    }
    ...
    override fun testCodeInputLCodeLengthSixRemoveSymbol() {
        themedComponent(
            ...
            codeInputCodeLengthSixRemoveSymbol(R.style.Serv_Sdds_ComponentOverlays_CodeInputL)
        }
    }
    ...
    override fun testCodeInputLCodeLengthSixErrorKeep() {
        themedComponent(
            ...
            codeInputCodeLengthSixCaptionCenter(R.style.Serv_Sdds_ComponentOverlays_CodeInputL)
        }
    }
    ...
    override fun testCodeInputLLongText() {
        themedComponent {
            codeInputCodeLengthFourCaptionCenter(R.style.Serv_Sdds_ComponentOverlays_CodeInputL)
        }
    }
}
