...
class ViewSystemCheckBoxScreenshotTest(
    ...
    override fun testCheckBoxSizeM() {
        themedComponent {
            checkBoxSizeM(R.style.Serv_Sdds_ComponentOverlays_CheckBoxM)
        }
    }
    ...
    override fun testCheckBoxSizeSUnchecked() {
        themedComponent {
            checkBoxSizeSUnchecked(R.style.Serv_Sdds_ComponentOverlays_CheckBoxS)
        }
    }
    ...
    override fun testCheckBoxNoLabelAndDesc() {
        themedComponent {
            checkBoxNoLabelAndDesc(R.style.Serv_Sdds_ComponentOverlays_CheckBoxM)
        }
    }
    ...
    override fun testCheckBoxDisabled() {
        themedComponent {
            checkBoxDisabled(R.style.Serv_Sdds_ComponentOverlays_CheckBoxS)
        }
    }
    ...
    override fun testCheckBoxSizeMIndeterminate() {
        themedComponent {
            checkBoxSizeMIndeterminate(R.style.Serv_Sdds_ComponentOverlays_CheckBoxM)
        }
    }
    ...
    override fun testCheckBoxGroupSizeM() {
        themedComponent(
            ...
            checkBoxGroupSizeM(R.style.Serv_Sdds_ComponentOverlays_CheckBoxGroupM)
        }
    }
    ...
    override fun testCheckBoxGroupSizeS() {
        themedComponent(
            ...
            checkBoxGroupSizeS(R.style.Serv_Sdds_ComponentOverlays_CheckBoxGroupS)
        }
    }
