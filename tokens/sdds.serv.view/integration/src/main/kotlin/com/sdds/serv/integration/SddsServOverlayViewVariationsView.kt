...
internal object SddsServOverlayViewVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "Default" to viewStyleReference(DsR.style.Serv_Sdds_ComponentOverlays_OverlayView),
        )
}
