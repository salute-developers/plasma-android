...
android {
    namespace = "com.sdds.finai.sandbox"
...
kotlin {
    ...
    targets.named<KotlinNativeTarget>("macosArm64") {
        binaries.executable {
            baseName = "SddsFinAiSandbox"
            entryPoint = "com.sdds.finai.sandbox.main"
        }
    }
    ...
    sourceSets {
        commonMain {
            dependencies {
                implementation(project(":sdds-finai-compose:integration"))
...
compose.desktop {
    application {
        mainClass = "com.sdds.finai.sandbox.DesktopLauncherKt"
        nativeDistributions {
            packageName = "SddsFinAiSandbox"
...
val nativeMacosDebugApp = layout.buildDirectory.dir(
    "compose/binaries/main/native-macosArm64-debug-app-image/SddsFinAiSandbox.app",
)
