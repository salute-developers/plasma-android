...
/** Kotlin/Wasm browser entrypoint for the SddsServ sandbox. */
@OptIn(ExperimentalComposeUiApi::class, ExperimentalResourceApi::class)
fun main() {
    initializeSddsFinAiSandbox()
    ComposeViewport(viewportContainerId = "root") {
        PreloadedSddsFinAiSandbox()
    }
}
...
private fun PreloadedSddsFinAiSandbox() {
    val fontsLoaded = listOf(
        ...
        preloadFont(resource = Res.font.s_b_sans_text_light_italic, weight = FontWeight(300), style = FontStyle.Italic),
