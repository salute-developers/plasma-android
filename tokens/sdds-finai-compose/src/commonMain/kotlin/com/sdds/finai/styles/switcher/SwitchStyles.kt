...
package com.sdds.finai.styles.switcher
...
private val SwitchStyleBuilder.invariantProps: SwitchStyleBuilder
    ...
    get() = this
        ...
        .colorValues {
            ...
            toggleThumbColor(SolidColor(SddsFinAiTheme.colors.surfaceOnDarkSolidDefault).asStatefulValue())
            toggleTrackColor(
                SolidColor(SddsFinAiTheme.colors.surfaceDefaultTransparentTertiary).asStatefulValue(
                    setOf(SwitchStates.Checked)
                        to SolidColor(SddsFinAiTheme.colors.surfaceDefaultAccent),
                ),
            )
            toggleTrackBorderColor(SolidColor(SddsFinAiTheme.colors.surfaceDefaultClear).asStatefulValue())
        }
