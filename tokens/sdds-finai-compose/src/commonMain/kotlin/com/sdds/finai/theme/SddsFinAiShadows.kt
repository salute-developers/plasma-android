...
import com.sdds.finai.tokens.ShadowTokens
 ...
 */
@Immutable
public data class SddsFinAiShadows(
    /**
     * shadow down soft s
     */
...
/**
 * Возвращает [SddsFinAiShadows]
 */
@Suppress("LongMethod")
public fun defaultSddsFinAiShadows(): SddsFinAiShadows = SddsFinAiShadows(
