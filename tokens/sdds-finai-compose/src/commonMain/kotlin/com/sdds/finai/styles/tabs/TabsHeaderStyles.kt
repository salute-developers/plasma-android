...
import com.sdds.finai.styles.tabitem.H1
import com.sdds.finai.styles.tabitem.H2
import com.sdds.finai.styles.tabitem.H3
import com.sdds.finai.styles.tabitem.H4
import com.sdds.finai.styles.tabitem.H5
import com.sdds.finai.styles.tabitem.TabItemHeader
...
public val TabsHeader.H1: WrapperTabsHeaderH1
    ...
    get() = TabsStyle.builder(this)
        ...
        .disclosureTextStyle(SddsFinAiTheme.typography.headerH1Bold)
        .dimensions {
            minSpacing(56.0.dp)
        }
...
public val TabsHeader.H2: WrapperTabsHeaderH2
    ...
    get() = TabsStyle.builder(this)
        ...
        .dropdownMenuStyle(DropdownMenuNormal.M.style())
        .disclosureTextStyle(SddsFinAiTheme.typography.headerH2Bold)
        .dimensions {
            minSpacing(40.0.dp)
        }
...
public val TabsHeader.H3: WrapperTabsHeaderH3
    ...
    get() = TabsStyle.builder(this)
        ...
        .disclosureTextStyle(SddsFinAiTheme.typography.headerH3Bold)
        .dimensions {
            minSpacing(36.0.dp)
        }
...
public val TabsHeader.H4: WrapperTabsHeaderH4
    ...
    get() = TabsStyle.builder(this)
        ...
        .dropdownMenuStyle(DropdownMenuNormal.S.style())
        .disclosureTextStyle(SddsFinAiTheme.typography.headerH4Bold)
        .dimensions {
            minSpacing(32.0.dp)
        }
...
public val TabsHeader.H5: WrapperTabsHeaderH5
    ...
    get() = TabsStyle.builder(this)
        ...
        .disclosureTextStyle(SddsFinAiTheme.typography.headerH5Bold)
        .dimensions {
            minSpacing(28.0.dp)
        }
