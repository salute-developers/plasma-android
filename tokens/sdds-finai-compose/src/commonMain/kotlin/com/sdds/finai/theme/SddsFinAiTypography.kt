...
import androidx.compose.ui.unit.dp
import com.sdds.finai.tokens.TypographyLargeTokens
import com.sdds.finai.tokens.TypographyMediumTokens
import com.sdds.finai.tokens.TypographySmallTokens

/**
 * Типографика SddsFinAi
 */
@Immutable
public data class SddsFinAiTypography internal constructor(
    /**
...
internal val LocalSddsFinAiTypography: ProvidableCompositionLocal<SddsFinAiTypography> =
    staticCompositionLocalOf {
        SddsFinAiTypography()
    }

/**
 * Возвращает [SddsFinAiTypography] для WindowSizeClass.Compact
 */
@Composable
public fun smallSddsFinAiTypography(): SddsFinAiTypography = SddsFinAiTypography(
...
/**
 * Возвращает [SddsFinAiTypography] для WindowSizeClass.Medium
 */
@Composable
public fun mediumSddsFinAiTypography(): SddsFinAiTypography = SddsFinAiTypography(
...
/**
 * Возвращает [SddsFinAiTypography] для WindowSizeClass.Expanded
 */
@Composable
public fun largeSddsFinAiTypography(): SddsFinAiTypography = SddsFinAiTypography(
...
/**
 * Возвращает разные [SddsFinAiTypography] в зависимости от ширины окна. Значение динамически
 * изменяется при изменении ширины окна.
 */
@Composable
public fun dynamicSddsFinAiTypography(): SddsFinAiTypography {
    val widthClass = collectWindowSizeInfoAsState().value.widthClass
    return when (widthClass) {
        WindowSizeClass.Expanded -> largeSddsFinAiTypography()
        WindowSizeClass.Medium -> mediumSddsFinAiTypography()
        WindowSizeClass.Compact -> smallSddsFinAiTypography()
    }
}
