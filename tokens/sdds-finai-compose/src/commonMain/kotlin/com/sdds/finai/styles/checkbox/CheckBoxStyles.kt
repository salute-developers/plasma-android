...
package com.sdds.finai.styles.checkbox
...
public val WrapperCheckBoxView.Default: WrapperCheckBoxTerminate
    ...
    get() = builder
        .colorValues {
            toggleBorderColor(
                SolidColor(SddsFinAiTheme.colors.outlineDefaultSolidSecondary).asStatefulValue(
                    setOf(
                    ...
                    setOf(CheckBoxStates.Checked)
                        to SolidColor(SddsFinAiTheme.colors.outlineDefaultClear),
            ...
            toggleColor(
                SolidColor(SddsFinAiTheme.colors.surfaceDefaultClear).asStatefulValue(
                    ...
                    setOf(CheckBoxStates.Indeterminate) to
                        SolidColor(SddsFinAiTheme.colors.surfaceDefaultAccent),
                ),
            )
            toggleIconColor(SolidColor(SddsFinAiTheme.colors.textOnDarkPrimary).asStatefulValue())
        }
    ...
    get() = builder
        .colorValues {
            toggleBorderColor(
                SolidColor(SddsFinAiTheme.colors.outlineDefaultNegative).asStatefulValue(
                    setOf(
                        InteractiveState.Focused,
                        CheckBoxStates.Checked,
                    ) to SolidColor(SddsFinAiTheme.colors.outlineDefaultNegative),
                    setOf(InteractiveState.Focused, CheckBoxStates.Indeterminate) to
                        SolidColor(SddsFinAiTheme.colors.outlineDefaultNegative),
            ...
            toggleColor(
                SolidColor(SddsFinAiTheme.colors.surfaceDefaultClear).asStatefulValue(
                    setOf(CheckBoxStates.Checked)
                        to SolidColor(SddsFinAiTheme.colors.surfaceDefaultNegative),
                    setOf(CheckBoxStates.Indeterminate) to
                        SolidColor(SddsFinAiTheme.colors.surfaceDefaultNegative),
                ),
            )
            toggleIconColor(SolidColor(SddsFinAiTheme.colors.textOnDarkPrimary).asStatefulValue())
        }
...
public val CheckBox.L: WrapperCheckBoxL
    ...
    get() = CheckBoxStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.bodyLNormal)
...
public val CheckBox.S: WrapperCheckBoxS
    ...
    get() = CheckBoxStyle.builder(this)
        ...
        .shape(SddsFinAiTheme.shapes.roundXxs)
        .dimensionValues {
            toggleWidth(16.0.dp)
