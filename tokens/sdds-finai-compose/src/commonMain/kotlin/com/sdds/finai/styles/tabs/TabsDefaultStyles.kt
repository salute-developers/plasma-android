...
package com.sdds.finai.styles.tabs
...
import com.sdds.finai.styles.tabitem.Horizontal
import com.sdds.finai.styles.tabitem.L
import com.sdds.finai.styles.tabitem.M
import com.sdds.finai.styles.tabitem.S
import com.sdds.finai.styles.tabitem.TabItemDefault
import com.sdds.finai.styles.tabitem.Vertical
import com.sdds.finai.styles.tabitem.Xs
import com.sdds.finai.theme.SddsFinAiTheme
import com.sdds.icons.compose.DisclosureDownOutline24
import com.sdds.icons.compose.DisclosureLeftOutline24
import com.sdds.icons.compose.DisclosureRightOutline24
import com.sdds.icons.compose.DisclosureUpOutline24
...
private val TabsStyleBuilder.invariantProps: TabsStyleBuilder
    ...
    get() = this
        ...
        .colors {
            indicatorColor(SddsFinAiTheme.colors.surfaceDefaultSolidDefault.asInteractive())
            overflowNextIconColor(SddsFinAiTheme.colors.textDefaultSecondary.asInteractive())
            overflowPrevIconColor(SddsFinAiTheme.colors.textDefaultSecondary.asInteractive())
            disclosureColor(
                SddsFinAiTheme.colors.textDefaultPrimary.asInteractive(
                    setOf(InteractiveState.Hovered)
                        to SddsFinAiTheme.colors.textDefaultPrimaryHover,
                    setOf(InteractiveState.Pressed) to
                        SddsFinAiTheme.colors.textDefaultPrimaryActive,
                ),
            )
        }
        .dimensions {
...
public val TabsDefault.L: WrapperTabsDefaultL
    ...
    get() = TabsStyle.builder(this)
        ...
        .disclosureTextStyle(SddsFinAiTheme.typography.bodyLBold)
...
public val WrapperTabsDefaultL.Vertical: WrapperTabsDefaultLVertical
    ...
    get() = builder
        ...
        .overflowNextIcon(imageVectorSource(SddsIcons.DisclosureDownOutline24))
        .overflowPrevIcon(imageVectorSource(SddsIcons.DisclosureUpOutline24))
        .dimensions {
            minSpacing(0.0.dp)
        }
...
public val TabsDefault.M: WrapperTabsDefaultM
    ...
    get() = TabsStyle.builder(this)
        ...
        .disclosureTextStyle(SddsFinAiTheme.typography.bodyMBold)
...
public val TabsDefault.Xs: WrapperTabsDefaultXs
    ...
    get() = TabsStyle.builder(this)
        ...
        .dropdownMenuStyle(DropdownMenuNormal.Xs.style())
        .disclosureTextStyle(SddsFinAiTheme.typography.bodyXsBold)
