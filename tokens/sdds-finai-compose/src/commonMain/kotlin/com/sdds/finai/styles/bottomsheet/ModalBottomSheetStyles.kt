...
package com.sdds.finai.styles.bottomsheet
...
public val ModalBottomSheet.Default: WrapperModalBottomSheetDefault
    ...
    get() = ModalBottomSheetStyle.builder(this)
        .topShape(SddsFinAiTheme.shapes.roundL)
        ...
        .colors {
            ...
            handleColor(SolidColor(SddsFinAiTheme.colors.surfaceDefaultSolidTertiary).asStatefulValue())
        }
        .dimensions {
