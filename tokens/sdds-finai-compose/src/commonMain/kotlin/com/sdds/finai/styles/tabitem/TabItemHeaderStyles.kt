...
public val TabItemHeader.H1: WrapperTabItemHeaderH1
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.headerH1Normal)
        .valueStyle(SddsFinAiTheme.typography.headerH1Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H2: WrapperTabItemHeaderH2
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.headerH2Normal)
        .valueStyle(SddsFinAiTheme.typography.headerH2Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H3: WrapperTabItemHeaderH3
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.headerH3Normal)
        .valueStyle(SddsFinAiTheme.typography.headerH3Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H4: WrapperTabItemHeaderH4
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.headerH4Normal)
        .valueStyle(SddsFinAiTheme.typography.headerH4Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H5: WrapperTabItemHeaderH5
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsFinAiTheme.typography.headerH5Normal)
        .valueStyle(SddsFinAiTheme.typography.headerH5Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
            valuePadding(10.0.dp)
            actionPadding(2.0.dp)
            actionSize(24.0.dp)
        }
