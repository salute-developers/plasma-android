...
internal object SddsSbcomAvatarVariationsCompose : ComposeStyleProvider<AvatarStyle>() {
    override val variations: Map<String, ComposeStyleReference<AvatarStyle>> =
        mapOf(
            "Size180" to ComposeStyleReference { Avatar.Size180.style() },
            ...
            "Size48" to ComposeStyleReference { Avatar.Size48.style() },
            ...
            "Size20" to ComposeStyleReference { Avatar.Size20.style() },
        )
}
