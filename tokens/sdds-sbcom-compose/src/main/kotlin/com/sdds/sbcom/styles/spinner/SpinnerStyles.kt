...
public val WrapperSpinnerView.ModeColorPrimary: WrapperSpinnerTerminate
    ...
    get() = builder
        .colors {
            startColor(SddsSbComTheme.colors.textDefaultPrimary.asInteractive())
            endColor(SddsSbComTheme.colors.surfaceDefaultClear.asInteractive())
        }
...
public val WrapperSpinnerView.ModeColorSecondary: WrapperSpinnerTerminate
    ...
    get() = builder
        .colors {
            startColor(SddsSbComTheme.colors.textDefaultSecondary.asInteractive())
            endColor(SddsSbComTheme.colors.surfaceDefaultClear.asInteractive())
        }
        .wrap(::WrapperSpinnerTerminate)
...
public val WrapperSpinnerView.ModeColorGlobalWhite: WrapperSpinnerTerminate
    ...
    get() = builder
        .colors {
            startColor(SddsSbComTheme.colors.surfaceDefaultSolidPrimary.asInteractive())
            endColor(SddsSbComTheme.colors.surfaceDefaultClear.asInteractive())
        }
        .wrap(::WrapperSpinnerTerminate)
...
public val WrapperSpinnerView.ModeColorAccent: WrapperSpinnerTerminate
    ...
    get() = builder
        .colors {
            startColor(SddsSbComTheme.colors.surfaceDefaultAccent.asInteractive())
            endColor(SddsSbComTheme.colors.surfaceDefaultClear.asInteractive())
        }
        .wrap(::WrapperSpinnerTerminate)
...
public val WrapperSpinnerView.ModeColorDanger: WrapperSpinnerTerminate
    ...
    get() = builder
        .colors {
            startColor(SddsSbComTheme.colors.surfaceDefaultNegative.asInteractive())
            endColor(SddsSbComTheme.colors.surfaceDefaultClear.asInteractive())
        }
        .wrap(::WrapperSpinnerTerminate)
