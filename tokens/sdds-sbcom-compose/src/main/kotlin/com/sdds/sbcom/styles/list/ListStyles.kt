 ...
 */
@JvmInline
public value class WrapperListDefault(
    public override val builder: ListStyleBuilder,
) : WrapperList

public val List.Default: WrapperListDefault
    @Composable
    @JvmName("WrapperListDefault")
    get() = ListStyle.builder(this)
        .listItemStyle(ListItem.Default.style())
        .dividerStyle(Divider.Default.style())
        .wrap(::WrapperListDefault)
