...
package com.sdkit.star.designsystem.styles.image
 ...
 */
public fun ImageStyles.Companion.resolve(ratio: ImageRatio = ImageRatio.Ratio11): ImageStyles = when {
...
public fun ImageStyles.Companion.style(
    ratio: ImageRatio = ImageRatio.Ratio11,
    modify: @Composable
