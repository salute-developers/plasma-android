...
import androidx.compose.ui.unit.dp
import com.sdkit.star.designsystem.tokens.SpacingTokens

/**
 * Отступы StarDs
 */
@Immutable
public data class StarDsSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalStarDsSpacing: ProvidableCompositionLocal<StarDsSpacing> =
    staticCompositionLocalOf {
        StarDsSpacing()
    }

/**
 * Возвращает [StarDsSpacing]
 */
@Composable
@ReadOnlyComposable
public fun defaultStarDsSpacing(): StarDsSpacing = StarDsSpacing(
