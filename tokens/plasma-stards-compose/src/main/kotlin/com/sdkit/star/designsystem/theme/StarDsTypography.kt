...
import androidx.compose.ui.unit.dp
import com.sdkit.star.designsystem.tokens.TypographyLargeTokens
import com.sdkit.star.designsystem.tokens.TypographyMediumTokens
import com.sdkit.star.designsystem.tokens.TypographySmallTokens

/**
 * Типографика StarDs
 */
@Immutable
public data class StarDsTypography internal constructor(
    /**
...
internal val LocalStarDsTypography: ProvidableCompositionLocal<StarDsTypography> =
    staticCompositionLocalOf {
        StarDsTypography()
    }

/**
 * Возвращает [StarDsTypography] для WindowSizeClass.Compact
 */
@Composable
@ReadOnlyComposable
public fun smallStarDsTypography(): StarDsTypography = StarDsTypography(
...
/**
 * Возвращает [StarDsTypography] для WindowSizeClass.Medium
 */
@Composable
@ReadOnlyComposable
public fun mediumStarDsTypography(): StarDsTypography = StarDsTypography(
...
/**
 * Возвращает [StarDsTypography] для WindowSizeClass.Expanded
 */
@Composable
@ReadOnlyComposable
public fun largeStarDsTypography(): StarDsTypography = StarDsTypography(
...
/**
 * Возвращает разные [StarDsTypography] в зависимости от ширины окна. Значение динамически
 * изменяется при изменении ширины окна.
 */
@Composable
public fun dynamicStarDsTypography(): StarDsTypography {
    val widthClass = collectWindowSizeInfoAsState().value.widthClass
    return when (widthClass) {
        WindowSizeClass.Expanded -> largeStarDsTypography()
        WindowSizeClass.Medium -> mediumStarDsTypography()
        WindowSizeClass.Compact -> smallStarDsTypography()
    }
}
