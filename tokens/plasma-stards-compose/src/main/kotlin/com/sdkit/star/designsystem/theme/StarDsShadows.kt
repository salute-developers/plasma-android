...
import com.sdkit.star.designsystem.tokens.ShadowTokens
 ...
 */
@Immutable
public data class StarDsShadows(
    /**
     * shadow down soft s
     */
...
internal val LocalStarDsShadows: ProvidableCompositionLocal<StarDsShadows> =
    staticCompositionLocalOf {
        StarDsShadows()
    }

/**
 * Возвращает [StarDsShadows]
 */
@Composable
@ReadOnlyComposable
@Suppress("LongMethod")
public fun defaultStarDsShadows(): StarDsShadows = StarDsShadows(
