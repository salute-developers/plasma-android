...
public class StarDsColors(
    ...
    /**
     * Возвращает копию [StarDsColors]. Предоставляет возможность переопределять цвета.
     */
    public fun copy(overrideColors: ColorOverrideScope.() -> Unit = {}): StarDsColors {
        ...
        return StarDsColors(colors.mapValues { overrideMap[it.key] ?: it.value })
    }
}
...
internal val LocalStarDsColors: ProvidableCompositionLocal<StarDsColors> =
    staticCompositionLocalOf {
        lightStarDsColors()
    }

@Suppress("LongMethod")
internal fun StarDsColors.updateColorsFrom(other: StarDsColors) {
...
/**
 * Цвета [StarDsColors] для светлой темы
 */
@Suppress("LongMethod")
public fun lightStarDsColors(overrideColors: ColorOverrideScope.() -> Unit = {}): StarDsColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    ...
    return StarDsColors(initial)
}

/**
 * Цвета [StarDsColors] для темной темы
 */
@Suppress("LongMethod")
public fun darkStarDsColors(overrideColors: ColorOverrideScope.() -> Unit = {}): StarDsColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    val overwrite = colorOverrideScope.overrideMap
    val initial = mutableMapOf<String, Color>()
