...
public enum class SpinnerStyles(
    ...
    SpinnerXxlDefault("Spinner.Xxl.Default"),
    SpinnerXxlSecondary("Spinner.Xxl.Secondary"),
    SpinnerXxlAccent("Spinner.Xxl.Accent"),
    SpinnerXxlPositive("Spinner.Xxl.Positive"),
    SpinnerXxlNegative("Spinner.Xxl.Negative"),
    SpinnerXxlWarning("Spinner.Xxl.Warning"),
    SpinnerXxlInfo("Spinner.Xxl.Info"),
    SpinnerXlDefault("Spinner.Xl.Default"),
    SpinnerXlSecondary("Spinner.Xl.Secondary"),
    SpinnerXlAccent("Spinner.Xl.Accent"),
    SpinnerXlPositive("Spinner.Xl.Positive"),
    SpinnerXlNegative("Spinner.Xl.Negative"),
    SpinnerXlWarning("Spinner.Xl.Warning"),
    SpinnerXlInfo("Spinner.Xl.Info"),
    SpinnerLDefault("Spinner.L.Default"),
    SpinnerLSecondary("Spinner.L.Secondary"),
    SpinnerLAccent("Spinner.L.Accent"),
    SpinnerLPositive("Spinner.L.Positive"),
    SpinnerLNegative("Spinner.L.Negative"),
    SpinnerLWarning("Spinner.L.Warning"),
    SpinnerLInfo("Spinner.L.Info"),
...
public fun SpinnerStyles.style(modify: @Composable SpinnerStyleBuilder.() -> Unit = {}): SpinnerStyle {
    val builder = when (this) {
        SpinnerStyles.SpinnerXxlDefault -> Spinner.Xxl.Default
        SpinnerStyles.SpinnerXxlSecondary -> Spinner.Xxl.Secondary
        SpinnerStyles.SpinnerXxlAccent -> Spinner.Xxl.Accent
        SpinnerStyles.SpinnerXxlPositive -> Spinner.Xxl.Positive
        SpinnerStyles.SpinnerXxlNegative -> Spinner.Xxl.Negative
        SpinnerStyles.SpinnerXxlWarning -> Spinner.Xxl.Warning
        SpinnerStyles.SpinnerXxlInfo -> Spinner.Xxl.Info
        SpinnerStyles.SpinnerXlDefault -> Spinner.Xl.Default
        SpinnerStyles.SpinnerXlSecondary -> Spinner.Xl.Secondary
        SpinnerStyles.SpinnerXlAccent -> Spinner.Xl.Accent
        SpinnerStyles.SpinnerXlPositive -> Spinner.Xl.Positive
        SpinnerStyles.SpinnerXlNegative -> Spinner.Xl.Negative
        SpinnerStyles.SpinnerXlWarning -> Spinner.Xl.Warning
        SpinnerStyles.SpinnerXlInfo -> Spinner.Xl.Info
        SpinnerStyles.SpinnerLDefault -> Spinner.L.Default
        SpinnerStyles.SpinnerLSecondary -> Spinner.L.Secondary
        SpinnerStyles.SpinnerLAccent -> Spinner.L.Accent
        SpinnerStyles.SpinnerLPositive -> Spinner.L.Positive
        SpinnerStyles.SpinnerLNegative -> Spinner.L.Negative
        SpinnerStyles.SpinnerLWarning -> Spinner.L.Warning
        SpinnerStyles.SpinnerLInfo -> Spinner.L.Info
...
public fun SpinnerStyles.Companion.resolve(
    size: SpinnerSize = SpinnerSize.Xxl,
    view: SpinnerView =
        SpinnerView.Default,
): SpinnerStyles = when {
    size == SpinnerSize.Xxl && view == SpinnerView.Default -> SpinnerStyles.SpinnerXxlDefault
    size == SpinnerSize.Xxl && view == SpinnerView.Secondary -> SpinnerStyles.SpinnerXxlSecondary
    size == SpinnerSize.Xxl && view == SpinnerView.Accent -> SpinnerStyles.SpinnerXxlAccent
    size == SpinnerSize.Xxl && view == SpinnerView.Positive -> SpinnerStyles.SpinnerXxlPositive
    size == SpinnerSize.Xxl && view == SpinnerView.Negative -> SpinnerStyles.SpinnerXxlNegative
    size == SpinnerSize.Xxl && view == SpinnerView.Warning -> SpinnerStyles.SpinnerXxlWarning
    size == SpinnerSize.Xxl && view == SpinnerView.Info -> SpinnerStyles.SpinnerXxlInfo
    size == SpinnerSize.Xl && view == SpinnerView.Default -> SpinnerStyles.SpinnerXlDefault
    size == SpinnerSize.Xl && view == SpinnerView.Secondary -> SpinnerStyles.SpinnerXlSecondary
    size == SpinnerSize.Xl && view == SpinnerView.Accent -> SpinnerStyles.SpinnerXlAccent
    size == SpinnerSize.Xl && view == SpinnerView.Positive -> SpinnerStyles.SpinnerXlPositive
    size == SpinnerSize.Xl && view == SpinnerView.Negative -> SpinnerStyles.SpinnerXlNegative
    size == SpinnerSize.Xl && view == SpinnerView.Warning -> SpinnerStyles.SpinnerXlWarning
    size == SpinnerSize.Xl && view == SpinnerView.Info -> SpinnerStyles.SpinnerXlInfo
    size == SpinnerSize.L && view == SpinnerView.Default -> SpinnerStyles.SpinnerLDefault
    size == SpinnerSize.L && view == SpinnerView.Secondary -> SpinnerStyles.SpinnerLSecondary
    size == SpinnerSize.L && view == SpinnerView.Accent -> SpinnerStyles.SpinnerLAccent
    size == SpinnerSize.L && view == SpinnerView.Positive -> SpinnerStyles.SpinnerLPositive
    size == SpinnerSize.L && view == SpinnerView.Negative -> SpinnerStyles.SpinnerLNegative
    size == SpinnerSize.L && view == SpinnerView.Warning -> SpinnerStyles.SpinnerLWarning
    size == SpinnerSize.L && view == SpinnerView.Info -> SpinnerStyles.SpinnerLInfo
