...
internal object PlasmaGigaSegmentItemVariationsCompose : ComposeStyleProvider<SegmentItemStyle>() {
    override val variations: Map<String, ComposeStyleReference<SegmentItemStyle>> =
        mapOf(
            ...
            "Xl.Accent" to ComposeStyleReference { SegmentItem.Xl.Accent.style() },
            ...
            "Xl.Pilled.Accent" to ComposeStyleReference { SegmentItem.Xl.Pilled.Accent.style() },
            ...
            "L.Accent" to ComposeStyleReference { SegmentItem.L.Accent.style() },
            ...
            "L.Pilled.Accent" to ComposeStyleReference { SegmentItem.L.Pilled.Accent.style() },
            ...
            "M.Accent" to ComposeStyleReference { SegmentItem.M.Accent.style() },
            ...
            "M.Pilled.Accent" to ComposeStyleReference { SegmentItem.M.Pilled.Accent.style() },
            ...
            "S.Accent" to ComposeStyleReference { SegmentItem.S.Accent.style() },
            ...
            "S.Pilled.Accent" to ComposeStyleReference { SegmentItem.S.Pilled.Accent.style() },
            ...
            "Xs.Accent" to ComposeStyleReference { SegmentItem.Xs.Accent.style() },
            ...
            "Xs.Pilled.Accent" to ComposeStyleReference { SegmentItem.Xs.Pilled.Accent.style() },
        )
}
