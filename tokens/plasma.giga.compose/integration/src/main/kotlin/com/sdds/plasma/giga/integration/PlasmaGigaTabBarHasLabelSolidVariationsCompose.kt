...
import com.sdds.plasma.giga.styles.tabbar.TabBarHasLabelSolidSize
import com.sdds.plasma.giga.styles.tabbar.TabBarHasLabelSolidView
    ...
    override fun resolveStyleKey(bindings: Map<String, Any?>): String {
        return TabBarStyles.HasLabelSolid.resolve(
            size = when (bindings["size"]?.toString()) {
                ...
                else -> TabBarHasLabelSolidSize.L
            },
