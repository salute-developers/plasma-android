...
import com.sdds.plasma.giga.styles.tabbar.TabBarHasLabelClearSize
import com.sdds.plasma.giga.styles.tabbar.TabBarHasLabelClearView
import com.sdds.plasma.giga.styles.tabbar.TabBarStyles
import com.sdds.plasma.giga.styles.tabbar.resolve
import com.sdds.sandbox.Property

internal object PlasmaGigaTabBarHasLabelClearVariationsCompose : ComposeStyleProvider<TabBarStyle>() {
    ...
    override fun resolveStyleKey(bindings: Map<String, Any?>): String {
        return TabBarStyles.HasLabelClear.resolve(
            size = when (bindings["size"]?.toString()) {
                ...
                else -> TabBarHasLabelClearSize.L
            },
