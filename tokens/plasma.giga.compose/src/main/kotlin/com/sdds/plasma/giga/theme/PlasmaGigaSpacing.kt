...
import androidx.compose.ui.unit.dp
import com.sdds.plasma.giga.tokens.SpacingTokens

/**
 * Отступы PlasmaGiga
 */
@Immutable
public data class PlasmaGigaSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalPlasmaGigaSpacing: ProvidableCompositionLocal<PlasmaGigaSpacing> =
    staticCompositionLocalOf {
        PlasmaGigaSpacing()
    }

/**
 * Возвращает [PlasmaGigaSpacing]
 */
public fun defaultPlasmaGigaSpacing(): PlasmaGigaSpacing = PlasmaGigaSpacing(
