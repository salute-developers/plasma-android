...
public val CodeField.L: WrapperCodeFieldL
    ...
    get() = CodeFieldStyle.builder(this)
        .invariantProps
        .itemShape(PlasmaGigaTheme.shapes.roundM.adjustBy(all = 2.0.dp))
...
public val WrapperCodeFieldL.Segmented: WrapperCodeFieldLSegmented
    ...
    get() = builder
        .itemShape(PlasmaGigaTheme.shapes.roundXs)
        .groupShape(PlasmaGigaTheme.shapes.roundL.adjustBy(all = -2.0.dp))
...
public val CodeField.M: WrapperCodeFieldM
    ...
    get() = CodeFieldStyle.builder(this)
        .invariantProps
        .itemShape(PlasmaGigaTheme.shapes.roundM)
...
public val WrapperCodeFieldM.Segmented: WrapperCodeFieldMSegmented
    ...
    get() = builder
        .itemShape(PlasmaGigaTheme.shapes.roundXxs)
        .groupShape(PlasmaGigaTheme.shapes.roundM)
