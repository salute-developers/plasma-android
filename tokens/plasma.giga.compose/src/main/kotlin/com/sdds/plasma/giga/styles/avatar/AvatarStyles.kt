...
private val AvatarStyleBuilder.invariantProps: AvatarStyleBuilder
    ...
    get() = this
        .shape(CircleShape)
        .colors {
            textColor(PlasmaGigaTheme.gradients.textDefaultAccentGradient.asLayered().asStatefulValue())
            backgroundColor(PlasmaGigaTheme.gradients.surfaceDefaultAccentGradient.asLayered(0.2f).asStatefulValue())
        }
