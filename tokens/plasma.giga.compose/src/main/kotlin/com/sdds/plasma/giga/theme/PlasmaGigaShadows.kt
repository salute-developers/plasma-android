...
import com.sdds.plasma.giga.tokens.ShadowTokens
 ...
 */
@Immutable
public data class PlasmaGigaShadows(
    /**
     * shadow down soft s
     */
...
internal val LocalPlasmaGigaShadows: ProvidableCompositionLocal<PlasmaGigaShadows> =
    staticCompositionLocalOf {
        PlasmaGigaShadows()
    }

/**
 * Возвращает [PlasmaGigaShadows]
 */
@Suppress("LongMethod")
public fun defaultPlasmaGigaShadows(): PlasmaGigaShadows = PlasmaGigaShadows(
