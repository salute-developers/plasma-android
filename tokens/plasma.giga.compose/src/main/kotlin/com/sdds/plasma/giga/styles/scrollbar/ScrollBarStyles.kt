...
private val ScrollBarStyleBuilder.invariantProps: ScrollBarStyleBuilder
    ...
    get() = this
        ...
        .colors {
            thumbColor(PlasmaGigaTheme.colors.surfaceDefaultSolidTertiary.asInteractive())
            trackColor(PlasmaGigaTheme.colors.surfaceDefaultTransparentPrimary.asInteractive())
        }
