...
/**
 * Градиенты PlasmaGiga
 */
@Immutable
public class PlasmaGigaGradients(
    ...
    /**
     * Возвращает копию [PlasmaGigaGradients]. Предоставляет возможность переопределять градиенты.
     */
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaGigaGradients {
        ...
        return PlasmaGigaGradients(gradients.mapValues { overrideMap[it.key] ?: it.value })
    }

    /**
     * Возвращает копию [PlasmaGigaGradients]. Предоставляет возможность переопределять цвета.
     */
    internal fun copyAttrs(overrideGradients: GradientAttrOverrideScope.() -> Unit = {}): PlasmaGigaGradients {
        val gradientOverrideScope = GradientAttrOverrideScope()
        overrideGradients.invoke(gradientOverrideScope)
        val overrideMap = gradientOverrideScope.overrideMap
        return PlasmaGigaGradients(
            gradients.mapValues {
...
internal val LocalPlasmaGigaGradients: ProvidableCompositionLocal<PlasmaGigaGradients> =
...
/**
 * Градиенты [PlasmaGigaGradients] для светлой темы
 */
@Suppress("LongMethod")
public fun lightPlasmaGigaGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaGigaGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    ...
    return PlasmaGigaGradients(initial)
}

/**
 * Градиенты [PlasmaGigaGradients] для темной темы
 */
@Suppress("LongMethod")
public fun darkPlasmaGigaGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaGigaGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
    val initial = mutableMapOf<String, List<ShaderBrush>>()
