...
internal object PlasmaHomedsLinkButtonVariationsCompose : ComposeStyleProvider<ButtonStyle>() {
    override val variations: Map<String, ComposeStyleReference<ButtonStyle>> =
        mapOf(
            ...
            "Xl.Info" to ComposeStyleReference { LinkButton.Xl.Info.style() },
            ...
            "L.Info" to ComposeStyleReference { LinkButton.L.Info.style() },
            ...
            "M.Info" to ComposeStyleReference { LinkButton.M.Info.style() },
            ...
            "S.Info" to ComposeStyleReference { LinkButton.S.Info.style() },
            ...
            "Xs.Info" to ComposeStyleReference { LinkButton.Xs.Info.style() },
            ...
            "Xxs.Info" to ComposeStyleReference { LinkButton.Xxs.Info.style() },
        )
}
