...
/**
 * Градиенты PlasmaHomeDs
 */
@Immutable
public class PlasmaHomeDsGradients(
    ...
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaHomeDsGradients {
        ...
        return PlasmaHomeDsGradients(gradients.mapValues { overrideMap[it.key] ?: it.value })
    }

    /**
     * Возвращает копию [PlasmaHomeDsGradients]. Предоставляет возможность переопределять цвета.
     */
    internal fun copyAttrs(overrideGradients: GradientAttrOverrideScope.() -> Unit = {}): PlasmaHomeDsGradients {
        val gradientOverrideScope = GradientAttrOverrideScope()
        overrideGradients.invoke(gradientOverrideScope)
        val overrideMap = gradientOverrideScope.overrideMap
        return PlasmaHomeDsGradients(
            gradients.mapValues {
...
internal val LocalPlasmaHomeDsGradients: ProvidableCompositionLocal<PlasmaHomeDsGradients> =
...
/**
 * Градиенты [PlasmaHomeDsGradients] для светлой темы
 */
@Suppress("LongMethod")
public fun lightPlasmaHomeDsGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaHomeDsGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
...
/**
 * Градиенты [PlasmaHomeDsGradients] для темной темы
 */
@Suppress("LongMethod")
public fun darkPlasmaHomeDsGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaHomeDsGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
    val initial = mutableMapOf<String, List<ShaderBrush>>()
