 ...
 * применимых к этим оберткам.
 */
public interface WrapperChipGroupWideXxsView : WrapperChipGroupWide

/**
 * Обертка для вариации Xxs
 */
@JvmInline
public value class WrapperChipGroupWideXxs(
    public override val builder: ChipGroupStyleBuilder,
) : WrapperChipGroupWideXxsView
 ...
 * применимых к этим оберткам.
 */
public interface WrapperChipGroupWideXxsPilledView : WrapperChipGroupWideXxsView

/**
 * Обертка для вариации XxsPilled
 */
@JvmInline
public value class WrapperChipGroupWideXxsPilled(
    public override val builder: ChipGroupStyleBuilder,
) : WrapperChipGroupWideXxsPilledView
...
public val WrapperChipGroupWideXxsView.Default: WrapperChipGroupWideTerminate
    @Composable
    @JvmName("WrapperChipGroupWideXxsViewDefault")
    get() = builder
        .chipStyle(Chip.Xxs.Default.style())
        .wrap(::WrapperChipGroupWideTerminate)

public val WrapperChipGroupWideXxsView.Secondary: WrapperChipGroupWideTerminate
    @Composable
    @JvmName("WrapperChipGroupWideXxsViewSecondary")
    get() = builder
        .chipStyle(Chip.Xxs.Secondary.style())
        .wrap(::WrapperChipGroupWideTerminate)

public val ChipGroupWide.Xxs: WrapperChipGroupWideXxs
    @Composable
    @JvmName("WrapperChipGroupWideXxs")
    get() = ChipGroupStyle.builder(this)
        .invariantProps
        .wrap(::WrapperChipGroupWideXxs)

public val WrapperChipGroupWideXxsPilledView.Default: WrapperChipGroupWideTerminate
    @Composable
    @JvmName("WrapperChipGroupWideXxsPilledViewDefault")
    get() = builder
        .chipStyle(Chip.Xxs.Pilled.Default.style())
        .wrap(::WrapperChipGroupWideTerminate)

public val WrapperChipGroupWideXxsPilledView.Secondary: WrapperChipGroupWideTerminate
    @Composable
    @JvmName("WrapperChipGroupWideXxsPilledViewSecondary")
    get() = builder
        .chipStyle(Chip.Xxs.Pilled.Secondary.style())
        .wrap(::WrapperChipGroupWideTerminate)

public val WrapperChipGroupWideXxs.Pilled: WrapperChipGroupWideXxsPilled
    @Composable
    @JvmName("WrapperChipGroupWideXxsPilled")
    get() = builder
        .wrap(::WrapperChipGroupWideXxsPilled)
