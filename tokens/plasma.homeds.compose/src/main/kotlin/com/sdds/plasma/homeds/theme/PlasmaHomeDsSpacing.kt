...
import androidx.compose.ui.unit.dp
import com.sdds.plasma.homeds.tokens.SpacingTokens

/**
 * Отступы PlasmaHomeDs
 */
@Immutable
public data class PlasmaHomeDsSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalPlasmaHomeDsSpacing: ProvidableCompositionLocal<PlasmaHomeDsSpacing> =
    staticCompositionLocalOf {
        PlasmaHomeDsSpacing()
    }

/**
 * Возвращает [PlasmaHomeDsSpacing]
 */
public fun defaultPlasmaHomeDsSpacing(): PlasmaHomeDsSpacing = PlasmaHomeDsSpacing(
