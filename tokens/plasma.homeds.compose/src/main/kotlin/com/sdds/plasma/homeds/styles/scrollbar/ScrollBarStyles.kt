...
package com.sdds.plasma.homeds.styles.scrollbar
...
private val ScrollBarStyleBuilder.invariantProps: ScrollBarStyleBuilder
    ...
    get() = this
        ...
        .colors {
            thumbColor(PlasmaHomeDsTheme.colors.surfaceDefaultSolidTertiary.asInteractive())
            trackColor(PlasmaHomeDsTheme.colors.surfaceDefaultTransparentPrimary.asInteractive())
        }
