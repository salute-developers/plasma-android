 ...
 */
@Immutable
public class PlasmaHomeDsColors(
     ...
     */
    public fun copy(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaHomeDsColors {
        ...
        return PlasmaHomeDsColors(colors.mapValues { overrideMap[it.key] ?: it.value })
    }

    /**
     * Возвращает копию [PlasmaHomeDsColors]. Предоставляет возможность переопределять цвета.
     */
    internal fun copyAttrs(overrideColors: ColorAttrOverrideScope.() -> Unit = {}): PlasmaHomeDsColors {
        val colorOverrideScope = ColorAttrOverrideScope()
        overrideColors.invoke(colorOverrideScope)
        val overrideMap = colorOverrideScope.overrideMap
        return PlasmaHomeDsColors(colors.mapValues { colors[overrideMap[it.key]] ?: it.value })
    }
}
...
internal val LocalPlasmaHomeDsColors: ProvidableCompositionLocal<PlasmaHomeDsColors> =
...
/**
 * Цвета [PlasmaHomeDsColors] для светлой темы
 */
@Suppress("LongMethod")
public fun lightPlasmaHomeDsColors(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaHomeDsColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
...
/**
 * Цвета [PlasmaHomeDsColors] для темной темы
 */
@Suppress("LongMethod")
public fun darkPlasmaHomeDsColors(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaHomeDsColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    val overwrite = colorOverrideScope.overrideMap
    val initial = mutableMapOf<String, Color>()
