...
public val WrapperCircularProgressBarView.Default: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultSolidDefault).asStatefulValue())
        }
...
public val WrapperCircularProgressBarView.Secondary: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultTransparentTertiary).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Accent: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultAccent).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Gradient: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(PlasmaHomeDsTheme.gradients.surfaceDefaultAccentGradient.asLayered().asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Info: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultInfo).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Positive: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultPositive).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Warning: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultWarning).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
private val CircularProgressBarStyleBuilder.invariantProps: CircularProgressBarStyleBuilder
    ...
    get() = this
        .valueEnabled(true)
        .colors {
            trackColor(SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultTransparentSecondary).asStatefulValue())
...
public val CircularProgressBar.Xxl: WrapperCircularProgressBarXxl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(PlasmaHomeDsTheme.typography.headerH2Bold)
        .dimensions {
            width(128.0.dp)
            height(128.0.dp)
...
public val CircularProgressBar.Xl: WrapperCircularProgressBarXl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(PlasmaHomeDsTheme.typography.headerH5Bold)
        .dimensions {
            width(88.0.dp)
            height(88.0.dp)
            trackThickness(4.0.dp)
