...
public val WrapperCircularProgressBarView.Gradient: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                PlasmaHomeDsTheme.gradients.surfaceDefaultAccentGradient.asLayered().asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Info: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultInfo).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Positive: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaHomeDsTheme.colors.surfaceDefaultPositive).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
