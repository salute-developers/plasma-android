...
class ComposeButtonGroupScreenshotTest(
    ...
    @Test
    fun testButtonGroupMNoGapDefault() {
        composeTestRule.content {
            ButtonGroupHorizontal(style = BasicButtonGroup.M.NoGap.Default.style())
        }
    }
    ...
    @Test
    fun testIconButtonGroupXsNoGapPilledVertical() {
        composeTestRule.content {
            IconButtonGroupVertical(style = IconButtonGroup.Xs.NoGap.Pilled.style())
        }
    }

    @Test
    fun testIconButtonGroupMNoGapSegmentedMaxAmount() {
        composeTestRule.content {
            IconButtonGroupHorizontalMaxAmount(style = IconButtonGroup.M.NoGap.Segmented.style())
        }
    }
}
