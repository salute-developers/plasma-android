...
internal object PlasmaB2cOverlayViewVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "Default" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_OverlayView),
        )
}
