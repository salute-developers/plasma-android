...
internal object PlasmaB2cAvatarGroupVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "S" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_AvatarGroupS),
        )
}
