...
internal object PlasmaB2cTextSkeletonVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            ".Default" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_TextSkeletonDefault),
            ".Lighter" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_TextSkeletonLighter),
        )
}
