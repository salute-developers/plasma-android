...
internal object PlasmaB2cDrawerCloseInnerVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseInnerM),
            "M.HasShadow" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseInnerMHasShadow),
        )
}
