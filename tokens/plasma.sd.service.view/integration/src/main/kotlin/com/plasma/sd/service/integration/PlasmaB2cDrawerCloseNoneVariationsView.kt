...
internal object PlasmaB2cDrawerCloseNoneVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseNoneM),
            "M.HasShadow" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseNoneMHasShadow),
        )
}
