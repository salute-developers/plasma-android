...
internal object PlasmaB2cDrawerCloseOuterVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseOuterM),
            "M.HasShadow" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_DrawerCloseOuterMHasShadow),
        )
}
