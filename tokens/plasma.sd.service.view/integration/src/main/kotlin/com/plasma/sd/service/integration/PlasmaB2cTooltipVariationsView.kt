...
internal object PlasmaB2cTooltipVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_TooltipM),
            "S" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_TooltipS),
        )
}
