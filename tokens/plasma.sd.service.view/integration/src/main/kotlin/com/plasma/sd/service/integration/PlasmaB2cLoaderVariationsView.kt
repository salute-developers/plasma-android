...
internal object PlasmaB2cLoaderVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "Default" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_Loader),
        )
}
