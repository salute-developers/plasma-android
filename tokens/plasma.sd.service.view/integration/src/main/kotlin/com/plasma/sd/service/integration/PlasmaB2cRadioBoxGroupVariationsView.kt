...
internal object PlasmaB2cRadioBoxGroupVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_RadioBoxGroupM),
            "S" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_RadioBoxGroupS),
        )
}
