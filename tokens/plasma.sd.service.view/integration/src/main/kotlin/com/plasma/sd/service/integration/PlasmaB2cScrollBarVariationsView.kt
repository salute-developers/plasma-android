...
internal object PlasmaB2cScrollBarVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "S" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_ScrollBarS),
            "M" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_ScrollBarM),
        )
}
