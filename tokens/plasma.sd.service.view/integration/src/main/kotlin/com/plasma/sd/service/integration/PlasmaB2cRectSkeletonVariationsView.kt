...
internal object PlasmaB2cRectSkeletonVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            ".Default" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_RectSkeletonDefault),
            ".Lighter" to viewStyleReference(DsR.style.Plasma_SdService_ComponentOverlays_RectSkeletonLighter),
        )
}
