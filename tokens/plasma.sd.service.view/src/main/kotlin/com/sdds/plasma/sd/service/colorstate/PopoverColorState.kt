...
public enum class PopoverColorState(
    ...
    DEFAULT(intArrayOf(R.attr.plasma_popover_state_default)),
    ACCENT(intArrayOf(R.attr.plasma_popover_state_accent)),
}
...
internal class PopoverColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(R.styleable.Popover_plasma_popoverColors, 0)
        typedArray.recycle()
