...
public enum class ListItemViewColorState(
    ...
    DEFAULT(intArrayOf(R.attr.plasma_listitemview_state_default)),
    POSITIVE(intArrayOf(R.attr.plasma_listitemview_state_positive)),
    NEGATIVE(intArrayOf(R.attr.plasma_listitemview_state_negative)),
}
...
internal class ListItemViewColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int =
            typedArray.getInt(R.styleable.ListItemView_plasma_listitemviewColors, 0)
        typedArray.recycle()
