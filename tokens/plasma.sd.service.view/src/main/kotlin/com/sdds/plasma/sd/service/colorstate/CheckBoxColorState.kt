...
public enum class CheckBoxColorState(
    ...
    DEFAULT(intArrayOf(R.attr.plasma_checkbox_state_default)),
    NEGATIVE(intArrayOf(R.attr.plasma_checkbox_state_negative)),
}
...
internal class CheckBoxColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(R.styleable.CheckBox_plasma_checkboxColors, 0)
        typedArray.recycle()
