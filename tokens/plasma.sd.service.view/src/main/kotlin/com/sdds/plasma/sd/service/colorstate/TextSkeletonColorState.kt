...
public enum class TextSkeletonColorState(
    ...
    DEFAULT(intArrayOf(R.attr.plasma_textskeleton_state_default)),
    LIGHTER(intArrayOf(R.attr.plasma_textskeleton_state_lighter)),
}
...
internal class TextSkeletonColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int =
            typedArray.getInt(R.styleable.TextSkeleton_plasma_textskeletonColors, 0)
        typedArray.recycle()
