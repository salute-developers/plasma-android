...
public enum class FileColorState(
    ...
    DEFAULT(intArrayOf(R.attr.plasma_file_state_default)),
    NEGATIVE(intArrayOf(R.attr.plasma_file_state_negative)),
}
...
internal class FileColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(R.styleable.File_plasma_fileColors, 0)
        typedArray.recycle()
