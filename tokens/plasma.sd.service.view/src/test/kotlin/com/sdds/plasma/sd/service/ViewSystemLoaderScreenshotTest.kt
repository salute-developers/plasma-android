...
import com.sdds.uikit.fixtures.testcases.LoaderTestCases
...
class ViewSystemLoaderScreenshotTest(
    ...
    override fun testLoaderSpinner() {
        themedComponent(
            ...
            loaderSpinner(R.style.Plasma_SdService_ComponentOverlays_Loader)
        }
    ...
    override fun testLoaderProgress() {
        themedComponent(
            ...
            loaderProgress(R.style.Plasma_SdService_ComponentOverlays_Loader)
        }
        captureScreenRoboImage()
    }
}
