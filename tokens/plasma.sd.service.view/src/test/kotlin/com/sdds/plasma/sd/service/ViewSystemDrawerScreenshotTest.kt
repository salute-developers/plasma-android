...
class ViewSystemDrawerScreenshotTest(
    ...
    override fun testDrawerCloseInnerMStartHeader() {
        themedComponent(
            ...
            drawerCloseInnerMStartHeader(
                R.style.Plasma_SdService_ComponentOverlays_DrawerCloseInnerM,
            )
        }
    ...
    override fun testDrawerCloseOuterMHasShadowTopFooterHasOverlay() {
        themedComponent(
            ...
            drawerCloseOuterMTopFooterHasOverlay(
                R.style.Plasma_SdService_ComponentOverlays_DrawerCloseOuterMHasShadow,
            )
        }
        captureScreenRoboImage()
    }
    ...
    override fun testDrawerCloseNoneEndHeaderFooter() {
        themedComponent(
            ...
            drawerCloseNoneEndHeaderFooter(
                R.style.Plasma_SdService_ComponentOverlays_DrawerCloseNoneM,
            )
        }
        captureScreenRoboImage()
    }
    ...
    override fun testDrawerPeakOffSet() {
        themedComponent(
            ...
            drawerPeakOffSet(
                R.style.Plasma_SdService_ComponentOverlays_DrawerCloseInnerMHasShadow,
            )
        }
        captureScreenRoboImage()
    }
