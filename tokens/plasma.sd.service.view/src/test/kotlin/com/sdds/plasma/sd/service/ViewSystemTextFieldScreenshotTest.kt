...
class ViewSystemTextFieldScreenshotTest(
    ...
    override fun testTextFieldSWarningInnerRight() {
        themedComponent {
            textFieldSWarningInnerRight(
                R.style.Plasma_SdService_ComponentOverlays_TextFieldSInnerLabelRequiredEnd,
    ...
    override fun testTextFieldXsError() {
        themedComponent {
            textFieldXsError(
                R.style.Plasma_SdService_ComponentOverlays_TextFieldXs,
    ...
    override fun testTextFieldMWarningInnerLabel() {
        themedComponent {
            textFieldMWarningInnerLabel(
                R.style.Plasma_SdService_ComponentOverlays_TextFieldMInnerLabel,
                TextFieldColorState.WARNING,
            )
        }
    }
    ...
    override fun testTextFieldXSSuccessOuterLabel() {
        themedComponent {
            textFieldXSSuccessOuterLabel(
                R.style.Plasma_SdService_ComponentOverlays_TextFieldXsOuterLabel,
                TextFieldColorState.SUCCESS,
            )
        }
    }
    ...
    override fun testTextFieldLInputText() {
        themedComponent {
            textFieldLInputText(
                R.style.Plasma_SdService_ComponentOverlays_TextFieldLInnerLabel,
                TextFieldColorState.WARNING,
            )
        }
    }
