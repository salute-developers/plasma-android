...
import com.sdds.plasma.sd.service.styles.tabbar.TabBarIslandHasLabelClearSize
import com.sdds.plasma.sd.service.styles.tabbar.TabBarIslandHasLabelClearView
...
internal object PlasmaB2cTabBarIslandHasLabelClearVariationsCompose : ComposeStyleProvider<TabBarStyle>() {
    ...
    override fun resolveStyleKey(bindings: Map<String, Any?>): String {
        return TabBarStyles.IslandHasLabelClear.resolve(
            size = when (bindings["size"]?.toString()) {
                ...
                else -> TabBarIslandHasLabelClearSize.M
            },
