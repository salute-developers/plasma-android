...
import androidx.compose.ui.unit.dp
import com.sdds.plasma.sd.service.tokens.SpacingTokens

/**
 * Отступы PlasmaSdService
 */
@Immutable
public data class PlasmaSdServiceSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalPlasmaSdServiceSpacing: ProvidableCompositionLocal<PlasmaSdServiceSpacing> =
    staticCompositionLocalOf {
        PlasmaSdServiceSpacing()
    }

/**
 * Возвращает [PlasmaSdServiceSpacing]
 */
public fun defaultPlasmaSdServiceSpacing(): PlasmaSdServiceSpacing = PlasmaSdServiceSpacing(
