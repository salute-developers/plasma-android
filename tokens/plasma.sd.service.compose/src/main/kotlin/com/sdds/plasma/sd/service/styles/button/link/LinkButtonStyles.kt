...
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButton
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonAccentViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonDefaultViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonL
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonM
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonNegativeViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonPositiveViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonS
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonSecondaryViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonView
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonWarningViewTerminate
import com.sdds.plasma.sd.service.styles.button.link.WrapperLinkButtonXs
...
public val WrapperLinkButtonView.Default: WrapperLinkButtonDefaultViewTerminate
    ...
    iconColor(PlasmaSdServiceTheme.colors.textDefaultPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultPrimaryActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultPrimaryHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultPrimaryActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultPrimaryHover))
    }
...
public val WrapperLinkButtonView.Secondary: WrapperLinkButtonSecondaryViewTerminate
    ...
    get() = builder
    .colors {
    spinnerColor(PlasmaSdServiceTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultSecondaryActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultSecondaryHover))
    iconColor(PlasmaSdServiceTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultSecondaryActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultSecondaryHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultSecondaryActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultSecondaryHover))
    }
...
public val WrapperLinkButtonView.Accent: WrapperLinkButtonAccentViewTerminate
    ...
    get() = builder
    .colors {
    spinnerColor(PlasmaSdServiceTheme.colors.textDefaultAccent.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultAccentActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultAccentHover))
    iconColor(PlasmaSdServiceTheme.colors.textDefaultAccent.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultAccentActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultAccentHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultAccent.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultAccentActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultAccentHover))
    }
...
public val WrapperLinkButtonView.Positive: WrapperLinkButtonPositiveViewTerminate
    ...
    get() = builder
    .colors {
    spinnerColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultPositiveActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultPositiveHover))
    iconColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultPositiveActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultPositiveHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultPositiveActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultPositiveHover))
    }
...
public val WrapperLinkButtonView.Negative: WrapperLinkButtonNegativeViewTerminate
    ...
    get() = builder
    .colors {
    spinnerColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultNegativeActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultNegativeHover))
    iconColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultNegativeActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultNegativeHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultNegativeActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultNegativeHover))
    }
...
public val WrapperLinkButtonView.Warning: WrapperLinkButtonWarningViewTerminate
    ...
    get() = builder
    .colors {
    spinnerColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultWarningActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultWarningHover))
    iconColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultWarningActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultWarningHover))
    labelColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultWarningActive, setOf(InteractiveState.Hovered)
            to PlasmaSdServiceTheme.colors.textDefaultWarningHover))
    }
