...
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClear
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearDefaultViewTerminate
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearErrorViewTerminate
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearL
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLInnerLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLInnerLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLInnerLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLOuterLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLOuterLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLOuterLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearLRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearM
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMInnerLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMInnerLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMInnerLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMOuterLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMOuterLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMOuterLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearMRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearS
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSInnerLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSInnerLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSInnerLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSOuterLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSOuterLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSOuterLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearSuccessViewTerminate
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearView
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearWarningViewTerminate
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXs
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXsOuterLabel
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXsOuterLabelRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXsOuterLabelRequiredStart
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXsRequiredEnd
import com.sdds.plasma.sd.service.styles.textfield.clear.WrapperTextFieldClearXsRequiredStart
...
public val WrapperTextFieldClearView.Default: WrapperTextFieldClearDefaultViewTerminate
    ...
    placeholderColor(PlasmaSdServiceTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Activated)
    ...
    dividerColor(PlasmaSdServiceTheme.colors.surfaceDefaultTransparentTertiary.asInteractive(setOf(InteractiveState.Activated)
...
public val WrapperTextFieldClearView.Success: WrapperTextFieldClearSuccessViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultPrimary))
    placeholderColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultTertiary))
    startContentColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    captionColor(PlasmaSdServiceTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    dividerColor(PlasmaSdServiceTheme.colors.surfaceDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.surfaceDefaultAccent))
    }
...
public val WrapperTextFieldClearView.Warning: WrapperTextFieldClearWarningViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultPrimary))
    placeholderColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultTertiary))
    startContentColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    captionColor(PlasmaSdServiceTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    dividerColor(PlasmaSdServiceTheme.colors.surfaceDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.surfaceDefaultAccent))
    }
...
public val WrapperTextFieldClearView.Error: WrapperTextFieldClearErrorViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultPrimary))
    placeholderColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultTertiary))
    startContentColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    captionColor(PlasmaSdServiceTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.textDefaultSecondary))
    dividerColor(PlasmaSdServiceTheme.colors.surfaceDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to PlasmaSdServiceTheme.colors.surfaceDefaultAccent))
    }
...
private val TextFieldClearStyleBuilder.invariantProps: TextFieldClearStyleBuilder
    ...
    endContentColor(PlasmaSdServiceTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to PlasmaSdServiceTheme.colors.textDefaultSecondaryActive,
            setOf(InteractiveState.Hovered) to
            PlasmaSdServiceTheme.colors.textDefaultSecondaryHover))
    endContentColorReadOnly(PlasmaSdServiceTheme.colors.textDefaultSecondary.multiplyAlpha(0.4f).asInteractive())
