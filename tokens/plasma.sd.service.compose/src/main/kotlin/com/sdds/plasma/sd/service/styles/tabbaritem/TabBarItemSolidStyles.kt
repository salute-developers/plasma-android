...
package com.sdds.plasma.sd.service.styles.tabbaritem
...
public val WrapperTabBarItemSolidView.Default: WrapperTabBarItemSolidTerminate
    ...
    get() = builder
        .colors {
            backgroundColor(
                PlasmaSdServiceTheme.colors.surfaceDefaultClear.asStatefulValue(
    ...
    get() = builder
        .colors {
            backgroundColor(
                PlasmaSdServiceTheme.colors.surfaceDefaultClear.asStatefulValue(
                    setOf(InteractiveState.Selected)
                        to PlasmaSdServiceTheme.colors.surfaceDefaultTransparentAccent,
                ),
            )
            labelColor(
                PlasmaSdServiceTheme.colors.textDefaultSecondary.asStatefulValue(
                    setOf(InteractiveState.Selected)
                        to PlasmaSdServiceTheme.colors.textDefaultAccent,
                ),
            )
            iconColor(
                PlasmaSdServiceTheme.colors.textDefaultSecondary.asStatefulValue(
...
private val TabBarItemStyleBuilder.invariantProps: TabBarItemStyleBuilder
    @Composable
    get() = this
        .labelStyle(PlasmaSdServiceTheme.typography.bodyXxsBold)
