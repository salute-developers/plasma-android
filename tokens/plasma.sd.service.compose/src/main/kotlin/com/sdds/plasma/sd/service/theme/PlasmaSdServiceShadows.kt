...
import com.sdds.plasma.sd.service.tokens.ShadowTokens
import kotlin.Suppress

/**
 * Тени PlasmaSdService
 */
@Immutable
public data class PlasmaSdServiceShadows(
    /**
     * shadow down soft s
     */
...
internal val LocalPlasmaSdServiceShadows: ProvidableCompositionLocal<PlasmaSdServiceShadows> =
    staticCompositionLocalOf {
        PlasmaSdServiceShadows()
    }

/**
 * Возвращает [PlasmaSdServiceShadows]
 */
@Suppress("LongMethod")
public fun defaultPlasmaSdServiceShadows(): PlasmaSdServiceShadows = PlasmaSdServiceShadows(
