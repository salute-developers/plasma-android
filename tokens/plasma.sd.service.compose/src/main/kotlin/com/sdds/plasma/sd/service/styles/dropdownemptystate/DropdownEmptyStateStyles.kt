...
package com.sdds.plasma.sd.service.styles.dropdownemptystate
...
private val DropdownEmptyStateStyleBuilder.invariantProps: DropdownEmptyStateStyleBuilder
    ...
    get() = this
        .colors {
            ...
            descriptionColor(PlasmaSdServiceTheme.colors.textDefaultPrimary.asInteractive())
        }
...
public val DropdownEmptyState.L: WrapperDropdownEmptyStateL
    ...
    get() = DropdownEmptyStateStyle.builder(this)
        .invariantProps
        .descriptionStyle(PlasmaSdServiceTheme.typography.bodyLNormal)
        .dimensions {
