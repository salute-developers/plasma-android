...
internal object SddsServSelectItemMultipleNormalVariationsCompose : ComposeStyleProvider<SelectItemStyle>() {
    override val variations: Map<String, ComposeStyleReference<SelectItemStyle>> =
        mapOf(
            "Xl" to ComposeStyleReference { SelectItemMultipleNormal.Xl.style() },
            "L" to ComposeStyleReference { SelectItemMultipleNormal.L.style() },
            "M" to ComposeStyleReference { SelectItemMultipleNormal.M.style() },
            "S" to ComposeStyleReference { SelectItemMultipleNormal.S.style() },
            "Xs" to ComposeStyleReference { SelectItemMultipleNormal.Xs.style() },
        )
}
