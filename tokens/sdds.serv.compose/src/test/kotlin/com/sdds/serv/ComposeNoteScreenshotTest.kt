...
import com.sdds.testing.compose.note.NoteCompactNoTitleNoText
...
class ComposeNoteScreenshotTest(
    ...
    fun testNoteCompactHasCloseLScalableDefault() {
        composeTestRule.content {
            NoteCompactTitleTextHasAction(NoteCompact.L.HasCloseContentScalable.Default.style())
        }
    }
    ...
    @Test
    fun testNoteCompactNoTitleNoText() {
        composeTestRule.content {
            NoteCompactNoTitleNoText(NoteCompact.L.Default.style())
        }
    }
}
