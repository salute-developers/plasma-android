...
public fun TabBarStyles.HasLabelClear.resolve(
    size: TabBarHasLabelClearSize = TabBarHasLabelClearSize.M,
    hasShadow: Boolean = false,
    rounded: Boolean = false,
    divider: Boolean = false,
    view: TabBarHasLabelClearView,
): TabBarStyles = when {
    size == TabBarHasLabelClearSize.M && hasShadow == true && rounded == true && view ==
    ...
    size == TabBarHasLabelClearSize.L && hasShadow == true && rounded == true && view ==
...
): TabBarStyle = resolve(size, hasShadow, rounded, divider, view).style(modify)

/**
 * Возвращает экземпляр [TabBarStyles] для tab-bar-has-label-solid
 */
public fun TabBarStyles.HasLabelSolid.resolve(
    size: TabBarHasLabelSolidSize = TabBarHasLabelSolidSize.M,
    hasShadow: Boolean = false,
    rounded: Boolean = false,
    divider: Boolean = false,
    view: TabBarHasLabelSolidView,
): TabBarStyles = when {
    size == TabBarHasLabelSolidSize.M && hasShadow == true && rounded == true && view ==
    ...
    size == TabBarHasLabelSolidSize.L && hasShadow == true && rounded == true && view ==
...
public fun TabBarStyles.IslandHasLabelClear.resolve(
    size: TabBarIslandHasLabelClearSize = TabBarIslandHasLabelClearSize.M,
    hasShadow: Boolean = false,
...
public fun TabBarStyles.IslandHasLabelSolid.resolve(
    size: TabBarIslandHasLabelSolidSize = TabBarIslandHasLabelSolidSize.M,
    hasShadow: Boolean = false,
...
public fun TabBarStyles.Clear.resolve(
    size: TabBarClearSize = TabBarClearSize.M,
    hasShadow: Boolean = false,
    rounded: Boolean = false,
    divider: Boolean = false,
    view: TabBarClearView,
): TabBarStyles = when {
    size == TabBarClearSize.M && hasShadow == true && rounded == true && view ==
    ...
    size == TabBarClearSize.L && hasShadow == true && rounded == true && view ==
...
public fun TabBarStyles.Solid.resolve(
    size: TabBarSolidSize = TabBarSolidSize.M,
    hasShadow: Boolean = false,
    rounded: Boolean = false,
    divider: Boolean = false,
    view: TabBarSolidView,
): TabBarStyles = when {
    size == TabBarSolidSize.M && hasShadow == true && rounded == true && view ==
    ...
    size == TabBarSolidSize.L && hasShadow == true && rounded == true && view ==
...
public fun TabBarStyles.IslandClear.resolve(
    size: TabBarIslandClearSize = TabBarIslandClearSize.M,
    hasShadow: Boolean = false,
...
public fun TabBarStyles.IslandSolid.resolve(
    size: TabBarIslandSolidSize = TabBarIslandSolidSize.M,
    hasShadow: Boolean = false,
