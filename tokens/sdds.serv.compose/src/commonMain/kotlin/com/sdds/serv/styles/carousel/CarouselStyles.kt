...
import com.sdds.icons.compose.ChevronLeft24
import com.sdds.icons.compose.ChevronRight24
...
private val CarouselStyleBuilder.invariantProps: CarouselStyleBuilder
    ...
    get() = this
        ...
        .nextButtonIcon(imageVectorSource(SddsIcons.ChevronRight24))
        .prevButtonIcon(imageVectorSource(SddsIcons.ChevronLeft24))
        .dimensions {
