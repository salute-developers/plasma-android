...
private val ScrollBarStyleBuilder.invariantProps: ScrollBarStyleBuilder
    ...
    get() = this
        ...
        .colors {
            thumbColor(SddsServTheme.colors.surfaceDefaultSolidTertiary.asInteractive())
            trackColor(SddsServTheme.colors.surfaceDefaultTransparentPrimary.asInteractive())
        }
