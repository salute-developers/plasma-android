...
public val DropZone.Default: WrapperDropZoneDefault
    ...
    get() = DropZoneStyle.builder(this)
        ...
        .colors {
            ...
            descriptionColor(SolidColor(SddsServTheme.colors.textDefaultTertiary).asStatefulValue())
            iconColor(SolidColor(SddsServTheme.colors.textDefaultPrimary).asStatefulValue())
            borderColor(
                SolidColor(SddsServTheme.colors.outlineDefaultSolidSecondary).asStatefulValue(
                    ...
                    setOf(InteractiveState.Focused) to
                        SolidColor(SddsServTheme.colors.outlineDefaultSolidSecondaryHover),
                ),
            )
        }
        .dimensions {
