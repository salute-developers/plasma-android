...
public val WrapperNotificationContentView.Positive: WrapperNotificationContentTerminate
    ...
    get() = builder
        .colors {
            titleColor(SddsServTheme.colors.textDefaultPositive.asInteractive())
            textColor(SddsServTheme.colors.textDefaultPrimary.asInteractive())
...
public val WrapperNotificationContentView.Negative: WrapperNotificationContentTerminate
    ...
    get() = builder
        .colors {
            titleColor(SddsServTheme.colors.textDefaultNegative.asInteractive())
            textColor(SddsServTheme.colors.textDefaultPrimary.asInteractive())
...
public val WrapperNotificationContentView.Warning: WrapperNotificationContentTerminate
    ...
    get() = builder
        .colors {
            titleColor(SddsServTheme.colors.textDefaultWarning.asInteractive())
            textColor(SddsServTheme.colors.textDefaultPrimary.asInteractive())
...
public val WrapperNotificationContentView.Info: WrapperNotificationContentTerminate
    ...
    get() = builder
        .colors {
            titleColor(SddsServTheme.colors.textDefaultInfo.asInteractive())
            textColor(SddsServTheme.colors.textDefaultPrimary.asInteractive())
