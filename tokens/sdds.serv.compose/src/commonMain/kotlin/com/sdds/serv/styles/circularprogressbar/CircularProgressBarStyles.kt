...
public val WrapperCircularProgressBarView.Secondary: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(SddsServTheme.colors.surfaceDefaultTransparentTertiary).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Info: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(SddsServTheme.colors.surfaceDefaultInfo).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Positive: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(SolidColor(SddsServTheme.colors.surfaceDefaultPositive).asStatefulValue())
        }
        .wrap(::WrapperCircularProgressBarTerminate)
