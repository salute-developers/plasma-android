...
import com.sdds.serv.styles.button.basic.WrapperBasicButton
import com.sdds.serv.styles.button.basic.WrapperBasicButtonAccentViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonBlackViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonClearViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonDarkViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonDefaultViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonL
import com.sdds.serv.styles.button.basic.WrapperBasicButtonM
import com.sdds.serv.styles.button.basic.WrapperBasicButtonNegativeViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonPositiveViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonS
import com.sdds.serv.styles.button.basic.WrapperBasicButtonSecondaryViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonView
import com.sdds.serv.styles.button.basic.WrapperBasicButtonWarningViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonWhiteViewTerminate
import com.sdds.serv.styles.button.basic.WrapperBasicButtonXs
...
public val WrapperBasicButtonView.Default: WrapperBasicButtonDefaultViewTerminate
    ...
    iconColor(SddsServTheme.colors.textInversePrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textInversePrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textInversePrimaryHover))
    labelColor(SddsServTheme.colors.textInversePrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textInversePrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textInversePrimaryHover))
    valueColor(SddsServTheme.colors.textInverseSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textInverseSecondaryActive, setOf(InteractiveState.Hovered) to
...
public val WrapperBasicButtonView.Secondary: WrapperBasicButtonSecondaryViewTerminate
    ...
    labelColor(SddsServTheme.colors.textDefaultPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textDefaultPrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textDefaultPrimaryHover))
    valueColor(SddsServTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
...
public val WrapperBasicButtonView.Accent: WrapperBasicButtonAccentViewTerminate
    ...
    iconColor(SddsServTheme.colors.textOnDarkPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnDarkPrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textOnDarkPrimaryHover))
    labelColor(SddsServTheme.colors.textOnDarkPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnDarkPrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textOnDarkPrimaryHover))
    valueColor(SddsServTheme.colors.textOnDarkSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnDarkSecondaryActive, setOf(InteractiveState.Hovered) to
...
public val WrapperBasicButtonView.White: WrapperBasicButtonWhiteViewTerminate
    ...
    iconColor(SddsServTheme.colors.textOnLightPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnLightPrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textOnLightPrimaryHover))
    labelColor(SddsServTheme.colors.textOnLightPrimary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnLightPrimaryActive, setOf(InteractiveState.Hovered) to
            SddsServTheme.colors.textOnLightPrimaryHover))
    valueColor(SddsServTheme.colors.textOnLightSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textOnLightSecondaryActive, setOf(InteractiveState.Hovered) to
