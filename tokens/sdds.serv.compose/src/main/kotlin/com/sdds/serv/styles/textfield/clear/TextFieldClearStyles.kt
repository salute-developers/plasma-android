...
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClear
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearDefaultViewTerminate
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearErrorViewTerminate
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearL
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLInnerLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLInnerLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLInnerLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLOuterLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLOuterLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLOuterLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearLRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearM
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMInnerLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMInnerLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMInnerLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMOuterLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMOuterLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMOuterLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearMRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearS
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSInnerLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSInnerLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSInnerLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSOuterLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSOuterLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSOuterLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearSuccessViewTerminate
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearView
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearWarningViewTerminate
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXs
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXsOuterLabel
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXsOuterLabelRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXsOuterLabelRequiredStart
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXsRequiredEnd
import com.sdds.serv.styles.textfield.clear.WrapperTextFieldClearXsRequiredStart
...
public val WrapperTextFieldClearView.Default: WrapperTextFieldClearDefaultViewTerminate
    ...
    placeholderColor(SddsServTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Activated)
    ...
    dividerColor(SddsServTheme.colors.surfaceDefaultTransparentTertiary.asInteractive(setOf(InteractiveState.Activated)
...
public val WrapperTextFieldClearView.Success: WrapperTextFieldClearSuccessViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(SddsServTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultPrimary))
    placeholderColor(SddsServTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultTertiary))
    startContentColor(SddsServTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    captionColor(SddsServTheme.colors.textDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    dividerColor(SddsServTheme.colors.surfaceDefaultPositive.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.surfaceDefaultAccent))
    }
...
public val WrapperTextFieldClearView.Warning: WrapperTextFieldClearWarningViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(SddsServTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultPrimary))
    placeholderColor(SddsServTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultTertiary))
    startContentColor(SddsServTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    captionColor(SddsServTheme.colors.textDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    dividerColor(SddsServTheme.colors.surfaceDefaultWarning.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.surfaceDefaultAccent))
    }
...
public val WrapperTextFieldClearView.Error: WrapperTextFieldClearErrorViewTerminate
    ...
    get() = builder
    .colors {
    valueColor(SddsServTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultPrimary))
    placeholderColor(SddsServTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultTertiary))
    startContentColor(SddsServTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    captionColor(SddsServTheme.colors.textDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.textDefaultSecondary))
    dividerColor(SddsServTheme.colors.surfaceDefaultNegative.asInteractive(setOf(InteractiveState.Activated)
            to SddsServTheme.colors.surfaceDefaultAccent))
    }
...
private val TextFieldClearStyleBuilder.invariantProps: TextFieldClearStyleBuilder
    ...
    endContentColor(SddsServTheme.colors.textDefaultSecondary.asInteractive(setOf(InteractiveState.Pressed)
            to SddsServTheme.colors.textDefaultSecondaryActive, setOf(InteractiveState.Hovered) to
