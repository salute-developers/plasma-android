 ...
 */
public interface WrapperSelectItemMultipleTight :
 ...
 */
@JvmInline
public value class WrapperSelectItemMultipleTightXl(
    public override val builder: SelectItemStyleBuilder,
) : WrapperSelectItemMultipleTight

/**
 * Обертка для вариации L
 */
@JvmInline
public value class WrapperSelectItemMultipleTightL(
    public override val builder: SelectItemStyleBuilder,
) : WrapperSelectItemMultipleTight
 ...
 */
@JvmInline
public value class WrapperSelectItemMultipleTightM(
    public override val builder: SelectItemStyleBuilder,
) : WrapperSelectItemMultipleTight
 ...
 */
@JvmInline
public value class WrapperSelectItemMultipleTightS(
    public override val builder: SelectItemStyleBuilder,
) : WrapperSelectItemMultipleTight
 ...
 */
@JvmInline
public value class WrapperSelectItemMultipleTightXs(
    public override val builder: SelectItemStyleBuilder,
) : WrapperSelectItemMultipleTight
...
public val SelectItemMultipleTight.Xl: WrapperSelectItemMultipleTightXl
    @Composable
    @JvmName("WrapperSelectItemMultipleTightXl")
    get() = SelectItemStyle.builder(this)
        ...
        .wrap(::WrapperSelectItemMultipleTightXl)

public val SelectItemMultipleTight.L: WrapperSelectItemMultipleTightL
    @Composable
    @JvmName("WrapperSelectItemMultipleTightL")
    get() = SelectItemStyle.builder(this)
        .invariantProps
        ...
        .wrap(::WrapperSelectItemMultipleTightL)

public val SelectItemMultipleTight.M: WrapperSelectItemMultipleTightM
    @Composable
    @JvmName("WrapperSelectItemMultipleTightM")
    get() = SelectItemStyle.builder(this)
        .invariantProps
        ...
        .wrap(::WrapperSelectItemMultipleTightM)

public val SelectItemMultipleTight.S: WrapperSelectItemMultipleTightS
    @Composable
    @JvmName("WrapperSelectItemMultipleTightS")
    get() = SelectItemStyle.builder(this)
        .invariantProps
        ...
        .wrap(::WrapperSelectItemMultipleTightS)

public val SelectItemMultipleTight.Xs: WrapperSelectItemMultipleTightXs
    @Composable
    @JvmName("WrapperSelectItemMultipleTightXs")
    get() = SelectItemStyle.builder(this)
        .invariantProps
        ...
        .wrap(::WrapperSelectItemMultipleTightXs)
