...
public val CardClear.L: WrapperCardClearL
    ...
    get() = CardStyle.builder(this)
        ...
        .contentShape(PlasmaGigaAppTheme.shapes.roundL)
        .dimensions {
            paddingTop(0.0.dp)
...
public val CardClear.M: WrapperCardClearM
    ...
    get() = CardStyle.builder(this)
        ...
        .contentShape(PlasmaGigaAppTheme.shapes.roundL.adjustBy(all = -2.0.dp))
        .dimensions {
            paddingTop(0.0.dp)
            paddingBottom(0.0.dp)
            paddingStart(0.0.dp)
...
public val CardClear.S: WrapperCardClearS
    ...
    get() = CardStyle.builder(this)
        ...
        .contentShape(PlasmaGigaAppTheme.shapes.roundM)
        .dimensions {
            paddingTop(0.0.dp)
            paddingBottom(0.0.dp)
            paddingStart(0.0.dp)
