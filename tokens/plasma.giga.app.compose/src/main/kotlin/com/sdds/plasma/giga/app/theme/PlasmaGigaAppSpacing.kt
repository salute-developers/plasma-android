...
import androidx.compose.ui.unit.dp
import com.sdds.plasma.giga.app.tokens.SpacingTokens

/**
 * Отступы PlasmaGigaApp
 */
@Immutable
public data class PlasmaGigaAppSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalPlasmaGigaAppSpacing: ProvidableCompositionLocal<PlasmaGigaAppSpacing> =
    staticCompositionLocalOf {
        PlasmaGigaAppSpacing()
    }

/**
 * Возвращает [PlasmaGigaAppSpacing]
 */
public fun defaultPlasmaGigaAppSpacing(): PlasmaGigaAppSpacing = PlasmaGigaAppSpacing(
