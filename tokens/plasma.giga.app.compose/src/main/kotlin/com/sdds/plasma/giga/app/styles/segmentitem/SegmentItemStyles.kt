...
package com.sdds.plasma.giga.app.styles.segmentitem
        ...
        .colors {
            ...
            valueColor(
                PlasmaGigaAppTheme.colors.textDefaultSecondary.asInteractive(
                    ...
                    setOf(InteractiveState.Selected)
                        to PlasmaGigaAppTheme.colors.textInverseSecondary,
                    setOf(
                        InteractiveState.Selected,
                        InteractiveState.Pressed,
                    )
            ...
            backgroundColor(
                PlasmaGigaAppTheme.colors.surfaceDefaultClear.asInteractive(
                    setOf(InteractiveState.Hovered)
                        to PlasmaGigaAppTheme.colors.surfaceDefaultClearHover,
                    setOf(InteractiveState.Selected)
            ...
            backgroundColor(
                PlasmaGigaAppTheme.colors.surfaceDefaultClear.asInteractive(
                    setOf(InteractiveState.Hovered)
                        to PlasmaGigaAppTheme.colors.surfaceDefaultClearHover,
                    setOf(InteractiveState.Selected)
                        to PlasmaGigaAppTheme.colors.surfaceDefaultTransparentCard,
                    setOf(
                        InteractiveState.Selected,
                        InteractiveState.Pressed,
                    )
                        to PlasmaGigaAppTheme.colors.surfaceDefaultTransparentCardActive,
                    setOf(InteractiveState.Selected, InteractiveState.Hovered)
                        to PlasmaGigaAppTheme.colors.surfaceDefaultTransparentCardHover,
                ),
            )
            startContentColor(
                PlasmaGigaAppTheme.colors.textDefaultPrimary.asInteractive(
                ...
                colors {
                    backgroundColor(
                        PlasmaGigaAppTheme.colors.surfaceDefaultAccent.asInteractive(
                            setOf(InteractiveState.Selected)
                                to PlasmaGigaAppTheme.colors.surfaceOnDarkSolidDefault,
                        ),
                    )
                    textColor(
                        PlasmaGigaAppTheme.colors.textOnDarkPrimary.asInteractive(
                            setOf(InteractiveState.Selected)
                                to PlasmaGigaAppTheme.colors.textOnLightPrimary,
                        ),
                    )
                }
            }.style(),
...
public val SegmentItem.Xl: WrapperSegmentItemXl
    ...
    get() = SegmentItemStyle.builder(this)
        .invariantProps
        .shape(PlasmaGigaAppTheme.shapes.roundL.adjustBy(all = 0.0.dp))
...
public val SegmentItem.M: WrapperSegmentItemM
    ...
    get() = SegmentItemStyle.builder(this)
        .invariantProps
        .shape(PlasmaGigaAppTheme.shapes.roundM.adjustBy(all = 0.0.dp))
