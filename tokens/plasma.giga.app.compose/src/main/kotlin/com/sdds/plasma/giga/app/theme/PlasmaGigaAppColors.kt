 ...
 */
@Immutable
public class PlasmaGigaAppColors(
    ...
    /**
     * Возвращает копию [PlasmaGigaAppColors]. Предоставляет возможность переопределять цвета.
     */
    public fun copy(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaGigaAppColors {
        ...
        return PlasmaGigaAppColors(colors.mapValues { overrideMap[it.key] ?: it.value })
    }
}
...
internal val LocalPlasmaGigaAppColors: ProvidableCompositionLocal<PlasmaGigaAppColors> =
    staticCompositionLocalOf {
        lightPlasmaGigaAppColors()
    }

@Suppress("LongMethod")
internal fun PlasmaGigaAppColors.updateColorsFrom(other: PlasmaGigaAppColors) {
...
/**
 * Цвета [PlasmaGigaAppColors] для светлой темы
 */
@Suppress("LongMethod")
public fun lightPlasmaGigaAppColors(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaGigaAppColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    ...
    return PlasmaGigaAppColors(initial)
}

/**
 * Цвета [PlasmaGigaAppColors] для темной темы
 */
@Suppress("LongMethod")
public fun darkPlasmaGigaAppColors(overrideColors: ColorOverrideScope.() -> Unit = {}): PlasmaGigaAppColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    val overwrite = colorOverrideScope.overrideMap
    val initial = mutableMapOf<String, Color>()
