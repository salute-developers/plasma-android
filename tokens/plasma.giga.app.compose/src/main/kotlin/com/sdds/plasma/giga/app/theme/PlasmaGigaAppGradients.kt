...
/**
 * Градиенты PlasmaGigaApp
 */
@Immutable
public class PlasmaGigaAppGradients(
    ...
    /**
     * Возвращает копию [PlasmaGigaAppGradients]. Предоставляет возможность переопределять
     * градиенты.
     */
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaGigaAppGradients {
        ...
        return PlasmaGigaAppGradients(gradients.mapValues { overrideMap[it.key] ?: it.value })
    }
}
...
internal val LocalPlasmaGigaAppGradients: ProvidableCompositionLocal<PlasmaGigaAppGradients> =
...
/**
 * Градиенты [PlasmaGigaAppGradients] для светлой темы
 */
@Suppress("LongMethod")
public fun lightPlasmaGigaAppGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
    PlasmaGigaAppGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    ...
    return PlasmaGigaAppGradients(initial)
}

/**
 * Градиенты [PlasmaGigaAppGradients] для темной темы
 */
@Suppress("LongMethod")
public fun darkPlasmaGigaAppGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
    PlasmaGigaAppGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
