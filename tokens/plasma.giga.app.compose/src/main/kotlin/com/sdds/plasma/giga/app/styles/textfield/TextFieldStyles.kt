...
package com.sdds.plasma.giga.app.styles.textfield
        ...
        .colors {
            captionColor(
                PlasmaGigaAppTheme.colors.textDefaultPositive.asInteractive(
                    setOf(InteractiveState.Activated)
                        to PlasmaGigaAppTheme.colors.textDefaultSecondary,
                ),
            )
            backgroundColor(
...
private val TextFieldStyleBuilder.invariantProps: TextFieldStyleBuilder
    ...
    get() = this
        ...
        .counterStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
        .captionPlacement(TextFieldHelperTextPlacement.Outer)
        .counterPlacement(TextFieldHelperTextPlacement.Outer)
        .colors {
            optionalColor(
                PlasmaGigaAppTheme.colors.textDefaultTertiary.asInteractive(),
            )
            valueColor(
            ...
            endContentColorReadOnly(
                PlasmaGigaAppTheme.colors.textDefaultSecondary.multiplyAlpha(0.4f).asInteractive(),
            )
...
public val TextField.Xs: WrapperTextFieldXs
    ...
    get() = TextFieldStyle.builder(this)
        .invariantProps
        .shape(PlasmaGigaAppTheme.shapes.roundS.adjustBy(all = 0.0.dp))
        .dimensions {
        ...
        .valueStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
        .prefixStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
        .suffixStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
        .placeholderStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
...
public val WrapperTextFieldXs.OuterLabel: WrapperTextFieldXsOuterLabel
    ...
    get() = builder
        ...
        .optionalStyle(PlasmaGigaAppTheme.typography.bodyXsNormal)
...
public val TextField.S: WrapperTextFieldS
    ...
    get() = TextFieldStyle.builder(this)
        ...
        .valueStyle(PlasmaGigaAppTheme.typography.bodySNormal)
...
public val TextField.M: WrapperTextFieldM
    ...
    get() = TextFieldStyle.builder(this)
        ...
        .valueStyle(PlasmaGigaAppTheme.typography.bodyMNormal)
        .prefixStyle(PlasmaGigaAppTheme.typography.bodyMNormal)
        .suffixStyle(PlasmaGigaAppTheme.typography.bodyMNormal)
        .placeholderStyle(PlasmaGigaAppTheme.typography.bodyMNormal)
...
public val WrapperTextFieldM.OuterLabel: WrapperTextFieldMOuterLabel
    ...
    get() = builder
        ...
        .optionalStyle(PlasmaGigaAppTheme.typography.bodyMNormal)
        .labelPlacement(TextFieldLabelPlacement.Outer)
        .colors {
            labelColor(
                PlasmaGigaAppTheme.colors.textDefaultPrimary.asInteractive(),
...
public val TextField.L: WrapperTextFieldL
    ...
    get() = TextFieldStyle.builder(this)
        ...
        .valueStyle(PlasmaGigaAppTheme.typography.bodyLNormal)
        .prefixStyle(PlasmaGigaAppTheme.typography.bodyLNormal)
        .suffixStyle(PlasmaGigaAppTheme.typography.bodyLNormal)
        .placeholderStyle(PlasmaGigaAppTheme.typography.bodyLNormal)
...
public val WrapperTextFieldL.OuterLabel: WrapperTextFieldLOuterLabel
    ...
    get() = builder
        ...
        .optionalStyle(PlasmaGigaAppTheme.typography.bodyLNormal)
        .labelPlacement(TextFieldLabelPlacement.Outer)
        .colors {
            labelColor(
                PlasmaGigaAppTheme.colors.textDefaultPrimary.asInteractive(),
