...
package com.sdds.plasma.giga.app.styles.circularprogressbar
...
public val WrapperCircularProgressBarView.Default: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultSolidDefault).asStatefulValue(),
            )
        }
...
public val WrapperCircularProgressBarView.Secondary: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultTransparentTertiary).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Accent: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultAccent).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Gradient: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                PlasmaGigaAppTheme.gradients.surfaceDefaultAccentGradient.asLayered().asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Info: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultInfo).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Negative: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultNegative).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Positive: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultPositive).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
public val WrapperCircularProgressBarView.Warning: WrapperCircularProgressBarTerminate
    ...
    get() = builder
        .colors {
            indicatorColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultWarning).asStatefulValue(),
            )
        }
        .wrap(::WrapperCircularProgressBarTerminate)
...
private val CircularProgressBarStyleBuilder.invariantProps: CircularProgressBarStyleBuilder
    ...
    get() = this
        .colors {
            trackColor(
                SolidColor(PlasmaGigaAppTheme.colors.surfaceDefaultTransparentSecondary).asStatefulValue(),
            )
            valueColor(
...
public val CircularProgressBar.Xxl: WrapperCircularProgressBarXxl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(PlasmaGigaAppTheme.typography.headerH2Bold)
        .dimensions {
            width(128.0.dp)
            height(128.0.dp)
...
public val CircularProgressBar.Xl: WrapperCircularProgressBarXl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(PlasmaGigaAppTheme.typography.headerH5Bold)
        .dimensions {
            width(88.0.dp)
            height(88.0.dp)
            trackThickness(4.0.dp)
