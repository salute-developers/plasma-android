...
import androidx.compose.ui.unit.dp
import com.sdds.plasma.giga.app.tokens.TypographyLargeTokens
import com.sdds.plasma.giga.app.tokens.TypographyMediumTokens
import com.sdds.plasma.giga.app.tokens.TypographySmallTokens

/**
 * Типографика PlasmaGigaApp
 */
@Immutable
public data class PlasmaGigaAppTypography internal constructor(
    /**
...
internal val LocalPlasmaGigaAppTypography: ProvidableCompositionLocal<PlasmaGigaAppTypography> =
    staticCompositionLocalOf {
        PlasmaGigaAppTypography()
    }

/**
 * Возвращает [PlasmaGigaAppTypography] для WindowSizeClass.Compact
 */
public fun smallPlasmaGigaAppTypography(): PlasmaGigaAppTypography = PlasmaGigaAppTypography(
...
/**
 * Возвращает [PlasmaGigaAppTypography] для WindowSizeClass.Medium
 */
public fun mediumPlasmaGigaAppTypography(): PlasmaGigaAppTypography = PlasmaGigaAppTypography(
...
/**
 * Возвращает [PlasmaGigaAppTypography] для WindowSizeClass.Expanded
 */
public fun largePlasmaGigaAppTypography(): PlasmaGigaAppTypography = PlasmaGigaAppTypography(
...
/**
 * Возвращает разные [PlasmaGigaAppTypography] в зависимости от ширины окна. Значение динамически
 * изменяется при изменении ширины окна.
 */
@Composable
public fun dynamicPlasmaGigaAppTypography(): PlasmaGigaAppTypography {
    val widthClass = collectWindowSizeInfoAsState().value.widthClass
    return when (widthClass) {
        WindowSizeClass.Expanded -> largePlasmaGigaAppTypography()
        WindowSizeClass.Medium -> mediumPlasmaGigaAppTypography()
        WindowSizeClass.Compact -> smallPlasmaGigaAppTypography()
    }
}
