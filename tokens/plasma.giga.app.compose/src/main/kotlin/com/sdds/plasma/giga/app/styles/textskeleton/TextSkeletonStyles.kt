...
package com.sdds.plasma.giga.app.styles.textskeleton
...
public val TextSkeleton.Default: WrapperTextSkeletonTerminate
    ...
    get() = TextSkeletonStyle.builder(this)
        .invariantProps
        .gradient(
            PlasmaGigaAppTheme.gradients.surfaceDefaultSkeletonGradient.asLayered().asStatefulValue(),
        )
...
public val TextSkeleton.Lighter: WrapperTextSkeletonTerminate
    ...
    get() = TextSkeletonStyle.builder(this)
        ...
        .gradient(
            ...
            PlasmaGigaAppTheme.gradients.surfaceDefaultSkeletonDeepGradient.asLayered().asStatefulValue(),
        )
        .wrap(::WrapperTextSkeletonTerminate)
