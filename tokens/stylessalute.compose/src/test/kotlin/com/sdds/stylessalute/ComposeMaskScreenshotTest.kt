...
import com.sdds.compose.uikit.fixtures.testcases.MaskNumberAlwaysAction
import com.sdds.compose.uikit.fixtures.testcases.MaskNumberIconAction
import com.sdds.compose.uikit.fixtures.testcases.MaskPhoneDisplayAlwaysPlaceholder
...
import com.sdds.compose.uikit.fixtures.testcases.MaskTimeAlwaysTBTA
...
class ComposeMaskScreenshotTest(
    ...
    fun testMaskXlDefaultShortDateAlwaysIconAction() {
        composeTestRule.content {
            MaskShortDateAlwaysIconAction(TextField.L.OuterLabel.Default.style())
        }
    }
