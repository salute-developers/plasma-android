...
import com.sdds.stylessalute.theme.GradientOverrideScope
import com.sdds.stylessalute.theme.StylesSaluteGradients
import com.sdds.stylessalute.tokens.DarkGradientTokens
import com.sdds.stylessalute.tokens.LightGradientTokens
import kotlin.Float
...
/**
 * Градиенты StylesSalute
 */
@Immutable
public class StylesSaluteGradients(
    ...
    /**
     * Возвращает копию [StylesSaluteGradients]. Предоставляет возможность переопределять градиенты.
     */
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}):
            StylesSaluteGradients {
...
internal val LocalStylesSaluteGradients: ProvidableCompositionLocal<StylesSaluteGradients> =
        staticCompositionLocalOf { lightStylesSaluteGradients() }
...
/**
 * Градиенты [StylesSaluteGradients] для светлой темы
 */
public fun lightStylesSaluteGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
        StylesSaluteGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    ...
    initial.add("textDefaultPromoMinorGradient",
            ...
            overwrite)
    initial.add("textDefaultGradientAthenaHover",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientAthenaHover.colors, LightGradientTokens.TextDefaultGradientAthenaHover.positions, LightGradientTokens.TextDefaultGradientAthenaHover.angle)),
            overwrite)
    initial.add("textDefaultGradientAthenaActive",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientAthenaActive.colors, LightGradientTokens.TextDefaultGradientAthenaActive.positions, LightGradientTokens.TextDefaultGradientAthenaActive.angle)),
            overwrite)
    initial.add("textDefaultGradientAthena",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientAthena.colors, LightGradientTokens.TextDefaultGradientAthena.positions, LightGradientTokens.TextDefaultGradientAthena.angle)),
            overwrite)
    initial.add("textDefaultGradientJoyHover",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientJoyHover.colors, LightGradientTokens.TextDefaultGradientJoyHover.positions, LightGradientTokens.TextDefaultGradientJoyHover.angle)),
            overwrite)
    initial.add("textDefaultGradientJoyActive",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientJoyActive.colors, LightGradientTokens.TextDefaultGradientJoyActive.positions, LightGradientTokens.TextDefaultGradientJoyActive.angle)),
            overwrite)
    initial.add("textDefaultGradientJoy",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientJoy.colors, LightGradientTokens.TextDefaultGradientJoy.positions, LightGradientTokens.TextDefaultGradientJoy.angle)),
            overwrite)
    initial.add("textDefaultGradientBrandHover",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientBrandHover.colors, LightGradientTokens.TextDefaultGradientBrandHover.positions, LightGradientTokens.TextDefaultGradientBrandHover.angle)),
            overwrite)
    initial.add("textDefaultGradientBrandActive",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientBrandActive.colors, LightGradientTokens.TextDefaultGradientBrandActive.positions, LightGradientTokens.TextDefaultGradientBrandActive.angle)),
            overwrite)
    initial.add("textDefaultGradientBrand",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientBrand.colors, LightGradientTokens.TextDefaultGradientBrand.positions, LightGradientTokens.TextDefaultGradientBrand.angle)),
            overwrite)
    initial.add("textDefaultGradientB2EHover",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientB2EHover.colors, LightGradientTokens.TextDefaultGradientB2EHover.positions, LightGradientTokens.TextDefaultGradientB2EHover.angle)),
            overwrite)
    initial.add("textDefaultGradientB2EActive",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientB2EActive.colors, LightGradientTokens.TextDefaultGradientB2EActive.positions, LightGradientTokens.TextDefaultGradientB2EActive.angle)),
            overwrite)
    initial.add("textDefaultGradientB2E",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientB2E.colors, LightGradientTokens.TextDefaultGradientB2E.positions, LightGradientTokens.TextDefaultGradientB2E.angle)),
            overwrite)
    initial.add("textDefaultGradientMainHover",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientMainHover.colors, LightGradientTokens.TextDefaultGradientMainHover.positions, LightGradientTokens.TextDefaultGradientMainHover.angle)),
            overwrite)
    initial.add("textDefaultGradientMainActive",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientMainActive.colors, LightGradientTokens.TextDefaultGradientMainActive.positions, LightGradientTokens.TextDefaultGradientMainActive.angle)),
            overwrite)
    initial.add("textDefaultGradientMain",
            listOf(linearGradient(LightGradientTokens.TextDefaultGradientMain.colors, LightGradientTokens.TextDefaultGradientMain.positions, LightGradientTokens.TextDefaultGradientMain.angle)),
            overwrite)
    ...
    initial.add("textOnDarkPromoMinorGradient",
            ...
            overwrite)
    initial.add("textOnDarkGradientAthenaHover",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientAthenaHover.colors, LightGradientTokens.TextOnDarkGradientAthenaHover.positions, LightGradientTokens.TextOnDarkGradientAthenaHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientAthenaActive",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientAthenaActive.colors, LightGradientTokens.TextOnDarkGradientAthenaActive.positions, LightGradientTokens.TextOnDarkGradientAthenaActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientAthena",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientAthena.colors, LightGradientTokens.TextOnDarkGradientAthena.positions, LightGradientTokens.TextOnDarkGradientAthena.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoyHover",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientJoyHover.colors, LightGradientTokens.TextOnDarkGradientJoyHover.positions, LightGradientTokens.TextOnDarkGradientJoyHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoyActive",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientJoyActive.colors, LightGradientTokens.TextOnDarkGradientJoyActive.positions, LightGradientTokens.TextOnDarkGradientJoyActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoy",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientJoy.colors, LightGradientTokens.TextOnDarkGradientJoy.positions, LightGradientTokens.TextOnDarkGradientJoy.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2EHover",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientB2EHover.colors, LightGradientTokens.TextOnDarkGradientB2EHover.positions, LightGradientTokens.TextOnDarkGradientB2EHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2EActive",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientB2EActive.colors, LightGradientTokens.TextOnDarkGradientB2EActive.positions, LightGradientTokens.TextOnDarkGradientB2EActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2E",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientB2E.colors, LightGradientTokens.TextOnDarkGradientB2E.positions, LightGradientTokens.TextOnDarkGradientB2E.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrandHover",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientBrandHover.colors, LightGradientTokens.TextOnDarkGradientBrandHover.positions, LightGradientTokens.TextOnDarkGradientBrandHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrandActive",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientBrandActive.colors, LightGradientTokens.TextOnDarkGradientBrandActive.positions, LightGradientTokens.TextOnDarkGradientBrandActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrand",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientBrand.colors, LightGradientTokens.TextOnDarkGradientBrand.positions, LightGradientTokens.TextOnDarkGradientBrand.angle)),
            overwrite)
    initial.add("textOnDarkGradientMainHover",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientMainHover.colors, LightGradientTokens.TextOnDarkGradientMainHover.positions, LightGradientTokens.TextOnDarkGradientMainHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientMainActive",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientMainActive.colors, LightGradientTokens.TextOnDarkGradientMainActive.positions, LightGradientTokens.TextOnDarkGradientMainActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientMain",
            listOf(linearGradient(LightGradientTokens.TextOnDarkGradientMain.colors, LightGradientTokens.TextOnDarkGradientMain.positions, LightGradientTokens.TextOnDarkGradientMain.angle)),
            overwrite)
    ...
    initial.add("textOnLightPromoMinorGradient",
            ...
            overwrite)
    initial.add("textOnLightGradientAthenaHover",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientAthenaHover.colors, LightGradientTokens.TextOnLightGradientAthenaHover.positions, LightGradientTokens.TextOnLightGradientAthenaHover.angle)),
            overwrite)
    initial.add("textOnLightGradientAthenaActive",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientAthenaActive.colors, LightGradientTokens.TextOnLightGradientAthenaActive.positions, LightGradientTokens.TextOnLightGradientAthenaActive.angle)),
            overwrite)
    initial.add("textOnLightGradientAthena",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientAthena.colors, LightGradientTokens.TextOnLightGradientAthena.positions, LightGradientTokens.TextOnLightGradientAthena.angle)),
            overwrite)
    initial.add("textOnLightGradientJoyHover",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientJoyHover.colors, LightGradientTokens.TextOnLightGradientJoyHover.positions, LightGradientTokens.TextOnLightGradientJoyHover.angle)),
            overwrite)
    initial.add("textOnLightGradientJoyActive",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientJoyActive.colors, LightGradientTokens.TextOnLightGradientJoyActive.positions, LightGradientTokens.TextOnLightGradientJoyActive.angle)),
            overwrite)
    initial.add("textOnLightGradientJoy",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientJoy.colors, LightGradientTokens.TextOnLightGradientJoy.positions, LightGradientTokens.TextOnLightGradientJoy.angle)),
            overwrite)
    initial.add("textOnLightGradientB2EHover",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientB2EHover.colors, LightGradientTokens.TextOnLightGradientB2EHover.positions, LightGradientTokens.TextOnLightGradientB2EHover.angle)),
            overwrite)
    initial.add("textOnLightGradientB2EActive",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientB2EActive.colors, LightGradientTokens.TextOnLightGradientB2EActive.positions, LightGradientTokens.TextOnLightGradientB2EActive.angle)),
            overwrite)
    initial.add("textOnLightGradientB2E",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientB2E.colors, LightGradientTokens.TextOnLightGradientB2E.positions, LightGradientTokens.TextOnLightGradientB2E.angle)),
            overwrite)
    initial.add("textOnLightGradientBrandHover",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientBrandHover.colors, LightGradientTokens.TextOnLightGradientBrandHover.positions, LightGradientTokens.TextOnLightGradientBrandHover.angle)),
            overwrite)
    initial.add("textOnLightGradientBrandActive",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientBrandActive.colors, LightGradientTokens.TextOnLightGradientBrandActive.positions, LightGradientTokens.TextOnLightGradientBrandActive.angle)),
            overwrite)
    initial.add("textOnLightGradientBrand",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientBrand.colors, LightGradientTokens.TextOnLightGradientBrand.positions, LightGradientTokens.TextOnLightGradientBrand.angle)),
            overwrite)
    initial.add("textOnLightGradientMainHover",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientMainHover.colors, LightGradientTokens.TextOnLightGradientMainHover.positions, LightGradientTokens.TextOnLightGradientMainHover.angle)),
            overwrite)
    initial.add("textOnLightGradientMainActive",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientMainActive.colors, LightGradientTokens.TextOnLightGradientMainActive.positions, LightGradientTokens.TextOnLightGradientMainActive.angle)),
            overwrite)
    initial.add("textOnLightGradientMain",
            listOf(linearGradient(LightGradientTokens.TextOnLightGradientMain.colors, LightGradientTokens.TextOnLightGradientMain.positions, LightGradientTokens.TextOnLightGradientMain.angle)),
            overwrite)
    ...
    initial.add("textInversePromoMinorGradient",
            ...
            overwrite)
    initial.add("textInverseGradientMainHover",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientMainHover.colors, LightGradientTokens.TextInverseGradientMainHover.positions, LightGradientTokens.TextInverseGradientMainHover.angle)),
            overwrite)
    initial.add("textInverseGradientMainActive",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientMainActive.colors, LightGradientTokens.TextInverseGradientMainActive.positions, LightGradientTokens.TextInverseGradientMainActive.angle)),
            overwrite)
    initial.add("textInverseGradientAthenaHover",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientAthenaHover.colors, LightGradientTokens.TextInverseGradientAthenaHover.positions, LightGradientTokens.TextInverseGradientAthenaHover.angle)),
            overwrite)
    initial.add("textInverseGradientAthenaActive",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientAthenaActive.colors, LightGradientTokens.TextInverseGradientAthenaActive.positions, LightGradientTokens.TextInverseGradientAthenaActive.angle)),
            overwrite)
    initial.add("textInverseGradientJoyHover",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientJoyHover.colors, LightGradientTokens.TextInverseGradientJoyHover.positions, LightGradientTokens.TextInverseGradientJoyHover.angle)),
            overwrite)
    initial.add("textInverseGradientJoyActive",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientJoyActive.colors, LightGradientTokens.TextInverseGradientJoyActive.positions, LightGradientTokens.TextInverseGradientJoyActive.angle)),
            overwrite)
    initial.add("textInverseGradientBrandHover",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientBrandHover.colors, LightGradientTokens.TextInverseGradientBrandHover.positions, LightGradientTokens.TextInverseGradientBrandHover.angle)),
            overwrite)
    initial.add("textInverseGradientBrandActive",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientBrandActive.colors, LightGradientTokens.TextInverseGradientBrandActive.positions, LightGradientTokens.TextInverseGradientBrandActive.angle)),
            overwrite)
    initial.add("textInverseGradientB2EHover",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientB2EHover.colors, LightGradientTokens.TextInverseGradientB2EHover.positions, LightGradientTokens.TextInverseGradientB2EHover.angle)),
            overwrite)
    initial.add("textInverseGradientB2EActive",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientB2EActive.colors, LightGradientTokens.TextInverseGradientB2EActive.positions, LightGradientTokens.TextInverseGradientB2EActive.angle)),
            overwrite)
    initial.add("textInverseGradientMain",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientMain.colors, LightGradientTokens.TextInverseGradientMain.positions, LightGradientTokens.TextInverseGradientMain.angle)),
            overwrite)
    initial.add("textInverseGradientAthena",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientAthena.colors, LightGradientTokens.TextInverseGradientAthena.positions, LightGradientTokens.TextInverseGradientAthena.angle)),
            overwrite)
    initial.add("textInverseGradientJoy",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientJoy.colors, LightGradientTokens.TextInverseGradientJoy.positions, LightGradientTokens.TextInverseGradientJoy.angle)),
            overwrite)
    initial.add("textInverseGradientB2E",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientB2E.colors, LightGradientTokens.TextInverseGradientB2E.positions, LightGradientTokens.TextInverseGradientB2E.angle)),
            overwrite)
    initial.add("textInverseGradientBrand",
            listOf(linearGradient(LightGradientTokens.TextInverseGradientBrand.colors, LightGradientTokens.TextInverseGradientBrand.positions, LightGradientTokens.TextInverseGradientBrand.angle)),
            overwrite)
    ...
    initial.add("surfaceDefaultTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceDefaultSkeleton",
            listOf(linearGradient(LightGradientTokens.SurfaceDefaultSkeleton.colors, LightGradientTokens.SurfaceDefaultSkeleton.positions, LightGradientTokens.SurfaceDefaultSkeleton.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMainHover",
            listOf(linearGradient(LightGradientTokens.SurfaceDefaultGradientMainHover.colors, LightGradientTokens.SurfaceDefaultGradientMainHover.positions, LightGradientTokens.SurfaceDefaultGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMainActive",
            listOf(linearGradient(LightGradientTokens.SurfaceDefaultGradientMainActive.colors, LightGradientTokens.SurfaceDefaultGradientMainActive.positions, LightGradientTokens.SurfaceDefaultGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMain",
            listOf(linearGradient(LightGradientTokens.SurfaceDefaultGradientMain.colors, LightGradientTokens.SurfaceDefaultGradientMain.positions, LightGradientTokens.SurfaceDefaultGradientMain.angle)),
            overwrite)
    ...
    initial.add("surfaceOnDarkTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceOnDarkGradientMainHover",
            listOf(linearGradient(LightGradientTokens.SurfaceOnDarkGradientMainHover.colors, LightGradientTokens.SurfaceOnDarkGradientMainHover.positions, LightGradientTokens.SurfaceOnDarkGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceOnDarkGradientMainActive",
            listOf(linearGradient(LightGradientTokens.SurfaceOnDarkGradientMainActive.colors, LightGradientTokens.SurfaceOnDarkGradientMainActive.positions, LightGradientTokens.SurfaceOnDarkGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceOnDarkGradientMain",
            listOf(linearGradient(LightGradientTokens.SurfaceOnDarkGradientMain.colors, LightGradientTokens.SurfaceOnDarkGradientMain.positions, LightGradientTokens.SurfaceOnDarkGradientMain.angle)),
            overwrite)
    ...
    initial.add("surfaceOnLightTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceOnLightGradientMainHover",
            listOf(linearGradient(LightGradientTokens.SurfaceOnLightGradientMainHover.colors, LightGradientTokens.SurfaceOnLightGradientMainHover.positions, LightGradientTokens.SurfaceOnLightGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceOnLightGradientMainActive",
            listOf(linearGradient(LightGradientTokens.SurfaceOnLightGradientMainActive.colors, LightGradientTokens.SurfaceOnLightGradientMainActive.positions, LightGradientTokens.SurfaceOnLightGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceOnLightGradientMain",
            listOf(linearGradient(LightGradientTokens.SurfaceOnLightGradientMain.colors, LightGradientTokens.SurfaceOnLightGradientMain.positions, LightGradientTokens.SurfaceOnLightGradientMain.angle)),
            overwrite)
    ...
    initial.add("surfaceInverseTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceInverseGradientMainHover",
            listOf(linearGradient(LightGradientTokens.SurfaceInverseGradientMainHover.colors, LightGradientTokens.SurfaceInverseGradientMainHover.positions, LightGradientTokens.SurfaceInverseGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceInverseGradientMainActive",
            listOf(linearGradient(LightGradientTokens.SurfaceInverseGradientMainActive.colors, LightGradientTokens.SurfaceInverseGradientMainActive.positions, LightGradientTokens.SurfaceInverseGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceInverseGradientMain",
            listOf(linearGradient(LightGradientTokens.SurfaceInverseGradientMain.colors, LightGradientTokens.SurfaceInverseGradientMain.positions, LightGradientTokens.SurfaceInverseGradientMain.angle)),
            overwrite)
    ...
    initial.add("surfaceInverseSkeletonDeepGradientActive",
            ...
            overwrite)
    initial.add("backgroundDefaultMobileAssistantAthena",
            ...
            overwrite)
    initial.add("backgroundDefaultMobileAssistantJoy",
    ...
    initial.add("outlineInversePromoMinorGradient",
            ...
            overwrite)
    return StylesSaluteGradients(initial)
}

/**
 * Градиенты [StylesSaluteGradients] для темной темы
 */
public fun darkStylesSaluteGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
        StylesSaluteGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
    ...
    initial.add("textDefaultPromoMinorGradient",
            ...
            overwrite)
    initial.add("textDefaultGradientAthenaHover",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientAthenaHover.colors, DarkGradientTokens.TextDefaultGradientAthenaHover.positions, DarkGradientTokens.TextDefaultGradientAthenaHover.angle)),
            overwrite)
    initial.add("textDefaultGradientAthenaActive",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientAthenaActive.colors, DarkGradientTokens.TextDefaultGradientAthenaActive.positions, DarkGradientTokens.TextDefaultGradientAthenaActive.angle)),
            overwrite)
    initial.add("textDefaultGradientAthena",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientAthena.colors, DarkGradientTokens.TextDefaultGradientAthena.positions, DarkGradientTokens.TextDefaultGradientAthena.angle)),
            overwrite)
    initial.add("textDefaultGradientJoyHover",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientJoyHover.colors, DarkGradientTokens.TextDefaultGradientJoyHover.positions, DarkGradientTokens.TextDefaultGradientJoyHover.angle)),
            overwrite)
    initial.add("textDefaultGradientJoyActive",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientJoyActive.colors, DarkGradientTokens.TextDefaultGradientJoyActive.positions, DarkGradientTokens.TextDefaultGradientJoyActive.angle)),
            overwrite)
    initial.add("textDefaultGradientJoy",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientJoy.colors, DarkGradientTokens.TextDefaultGradientJoy.positions, DarkGradientTokens.TextDefaultGradientJoy.angle)),
            overwrite)
    initial.add("textDefaultGradientBrandHover",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientBrandHover.colors, DarkGradientTokens.TextDefaultGradientBrandHover.positions, DarkGradientTokens.TextDefaultGradientBrandHover.angle)),
            overwrite)
    initial.add("textDefaultGradientBrandActive",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientBrandActive.colors, DarkGradientTokens.TextDefaultGradientBrandActive.positions, DarkGradientTokens.TextDefaultGradientBrandActive.angle)),
            overwrite)
    initial.add("textDefaultGradientBrand",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientBrand.colors, DarkGradientTokens.TextDefaultGradientBrand.positions, DarkGradientTokens.TextDefaultGradientBrand.angle)),
            overwrite)
    initial.add("textDefaultGradientB2EHover",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientB2EHover.colors, DarkGradientTokens.TextDefaultGradientB2EHover.positions, DarkGradientTokens.TextDefaultGradientB2EHover.angle)),
            overwrite)
    initial.add("textDefaultGradientB2EActive",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientB2EActive.colors, DarkGradientTokens.TextDefaultGradientB2EActive.positions, DarkGradientTokens.TextDefaultGradientB2EActive.angle)),
            overwrite)
    initial.add("textDefaultGradientB2E",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientB2E.colors, DarkGradientTokens.TextDefaultGradientB2E.positions, DarkGradientTokens.TextDefaultGradientB2E.angle)),
            overwrite)
    initial.add("textDefaultGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientMainHover.colors, DarkGradientTokens.TextDefaultGradientMainHover.positions, DarkGradientTokens.TextDefaultGradientMainHover.angle)),
            overwrite)
    initial.add("textDefaultGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientMainActive.colors, DarkGradientTokens.TextDefaultGradientMainActive.positions, DarkGradientTokens.TextDefaultGradientMainActive.angle)),
            overwrite)
    initial.add("textDefaultGradientMain",
            listOf(linearGradient(DarkGradientTokens.TextDefaultGradientMain.colors, DarkGradientTokens.TextDefaultGradientMain.positions, DarkGradientTokens.TextDefaultGradientMain.angle)),
            overwrite)
    initial.add("textOnDarkAccentGradientHover",
    ...
    initial.add("textOnDarkPromoMinorGradient",
            ...
            overwrite)
    initial.add("textOnDarkGradientAthenaHover",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientAthenaHover.colors, DarkGradientTokens.TextOnDarkGradientAthenaHover.positions, DarkGradientTokens.TextOnDarkGradientAthenaHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientAthenaActive",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientAthenaActive.colors, DarkGradientTokens.TextOnDarkGradientAthenaActive.positions, DarkGradientTokens.TextOnDarkGradientAthenaActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientAthena",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientAthena.colors, DarkGradientTokens.TextOnDarkGradientAthena.positions, DarkGradientTokens.TextOnDarkGradientAthena.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoyHover",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientJoyHover.colors, DarkGradientTokens.TextOnDarkGradientJoyHover.positions, DarkGradientTokens.TextOnDarkGradientJoyHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoyActive",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientJoyActive.colors, DarkGradientTokens.TextOnDarkGradientJoyActive.positions, DarkGradientTokens.TextOnDarkGradientJoyActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientJoy",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientJoy.colors, DarkGradientTokens.TextOnDarkGradientJoy.positions, DarkGradientTokens.TextOnDarkGradientJoy.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2EHover",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientB2EHover.colors, DarkGradientTokens.TextOnDarkGradientB2EHover.positions, DarkGradientTokens.TextOnDarkGradientB2EHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2EActive",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientB2EActive.colors, DarkGradientTokens.TextOnDarkGradientB2EActive.positions, DarkGradientTokens.TextOnDarkGradientB2EActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientB2E",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientB2E.colors, DarkGradientTokens.TextOnDarkGradientB2E.positions, DarkGradientTokens.TextOnDarkGradientB2E.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrandHover",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientBrandHover.colors, DarkGradientTokens.TextOnDarkGradientBrandHover.positions, DarkGradientTokens.TextOnDarkGradientBrandHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrandActive",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientBrandActive.colors, DarkGradientTokens.TextOnDarkGradientBrandActive.positions, DarkGradientTokens.TextOnDarkGradientBrandActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientBrand",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientBrand.colors, DarkGradientTokens.TextOnDarkGradientBrand.positions, DarkGradientTokens.TextOnDarkGradientBrand.angle)),
            overwrite)
    initial.add("textOnDarkGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientMainHover.colors, DarkGradientTokens.TextOnDarkGradientMainHover.positions, DarkGradientTokens.TextOnDarkGradientMainHover.angle)),
            overwrite)
    initial.add("textOnDarkGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientMainActive.colors, DarkGradientTokens.TextOnDarkGradientMainActive.positions, DarkGradientTokens.TextOnDarkGradientMainActive.angle)),
            overwrite)
    initial.add("textOnDarkGradientMain",
            listOf(linearGradient(DarkGradientTokens.TextOnDarkGradientMain.colors, DarkGradientTokens.TextOnDarkGradientMain.positions, DarkGradientTokens.TextOnDarkGradientMain.angle)),
            overwrite)
    initial.add("textOnLightAccentGradientHover",
    ...
    initial.add("textOnLightPromoMinorGradient",
            ...
            overwrite)
    initial.add("textOnLightGradientAthenaHover",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientAthenaHover.colors, DarkGradientTokens.TextOnLightGradientAthenaHover.positions, DarkGradientTokens.TextOnLightGradientAthenaHover.angle)),
            overwrite)
    initial.add("textOnLightGradientAthenaActive",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientAthenaActive.colors, DarkGradientTokens.TextOnLightGradientAthenaActive.positions, DarkGradientTokens.TextOnLightGradientAthenaActive.angle)),
            overwrite)
    initial.add("textOnLightGradientAthena",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientAthena.colors, DarkGradientTokens.TextOnLightGradientAthena.positions, DarkGradientTokens.TextOnLightGradientAthena.angle)),
            overwrite)
    initial.add("textOnLightGradientJoyHover",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientJoyHover.colors, DarkGradientTokens.TextOnLightGradientJoyHover.positions, DarkGradientTokens.TextOnLightGradientJoyHover.angle)),
            overwrite)
    initial.add("textOnLightGradientJoyActive",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientJoyActive.colors, DarkGradientTokens.TextOnLightGradientJoyActive.positions, DarkGradientTokens.TextOnLightGradientJoyActive.angle)),
            overwrite)
    initial.add("textOnLightGradientJoy",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientJoy.colors, DarkGradientTokens.TextOnLightGradientJoy.positions, DarkGradientTokens.TextOnLightGradientJoy.angle)),
            overwrite)
    initial.add("textOnLightGradientB2EHover",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientB2EHover.colors, DarkGradientTokens.TextOnLightGradientB2EHover.positions, DarkGradientTokens.TextOnLightGradientB2EHover.angle)),
            overwrite)
    initial.add("textOnLightGradientB2EActive",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientB2EActive.colors, DarkGradientTokens.TextOnLightGradientB2EActive.positions, DarkGradientTokens.TextOnLightGradientB2EActive.angle)),
            overwrite)
    initial.add("textOnLightGradientB2E",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientB2E.colors, DarkGradientTokens.TextOnLightGradientB2E.positions, DarkGradientTokens.TextOnLightGradientB2E.angle)),
            overwrite)
    initial.add("textOnLightGradientBrandHover",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientBrandHover.colors, DarkGradientTokens.TextOnLightGradientBrandHover.positions, DarkGradientTokens.TextOnLightGradientBrandHover.angle)),
            overwrite)
    initial.add("textOnLightGradientBrandActive",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientBrandActive.colors, DarkGradientTokens.TextOnLightGradientBrandActive.positions, DarkGradientTokens.TextOnLightGradientBrandActive.angle)),
            overwrite)
    initial.add("textOnLightGradientBrand",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientBrand.colors, DarkGradientTokens.TextOnLightGradientBrand.positions, DarkGradientTokens.TextOnLightGradientBrand.angle)),
            overwrite)
    initial.add("textOnLightGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientMainHover.colors, DarkGradientTokens.TextOnLightGradientMainHover.positions, DarkGradientTokens.TextOnLightGradientMainHover.angle)),
            overwrite)
    initial.add("textOnLightGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientMainActive.colors, DarkGradientTokens.TextOnLightGradientMainActive.positions, DarkGradientTokens.TextOnLightGradientMainActive.angle)),
            overwrite)
    initial.add("textOnLightGradientMain",
            listOf(linearGradient(DarkGradientTokens.TextOnLightGradientMain.colors, DarkGradientTokens.TextOnLightGradientMain.positions, DarkGradientTokens.TextOnLightGradientMain.angle)),
            overwrite)
    initial.add("textInverseAccentGradientHover",
    ...
    initial.add("textInversePromoMinorGradient",
            ...
            overwrite)
    initial.add("textInverseGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientMainHover.colors, DarkGradientTokens.TextInverseGradientMainHover.positions, DarkGradientTokens.TextInverseGradientMainHover.angle)),
            overwrite)
    initial.add("textInverseGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientMainActive.colors, DarkGradientTokens.TextInverseGradientMainActive.positions, DarkGradientTokens.TextInverseGradientMainActive.angle)),
            overwrite)
    initial.add("textInverseGradientAthenaHover",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientAthenaHover.colors, DarkGradientTokens.TextInverseGradientAthenaHover.positions, DarkGradientTokens.TextInverseGradientAthenaHover.angle)),
            overwrite)
    initial.add("textInverseGradientAthenaActive",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientAthenaActive.colors, DarkGradientTokens.TextInverseGradientAthenaActive.positions, DarkGradientTokens.TextInverseGradientAthenaActive.angle)),
            overwrite)
    initial.add("textInverseGradientJoyHover",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientJoyHover.colors, DarkGradientTokens.TextInverseGradientJoyHover.positions, DarkGradientTokens.TextInverseGradientJoyHover.angle)),
            overwrite)
    initial.add("textInverseGradientJoyActive",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientJoyActive.colors, DarkGradientTokens.TextInverseGradientJoyActive.positions, DarkGradientTokens.TextInverseGradientJoyActive.angle)),
            overwrite)
    initial.add("textInverseGradientBrandHover",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientBrandHover.colors, DarkGradientTokens.TextInverseGradientBrandHover.positions, DarkGradientTokens.TextInverseGradientBrandHover.angle)),
            overwrite)
    initial.add("textInverseGradientBrandActive",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientBrandActive.colors, DarkGradientTokens.TextInverseGradientBrandActive.positions, DarkGradientTokens.TextInverseGradientBrandActive.angle)),
            overwrite)
    initial.add("textInverseGradientB2EHover",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientB2EHover.colors, DarkGradientTokens.TextInverseGradientB2EHover.positions, DarkGradientTokens.TextInverseGradientB2EHover.angle)),
            overwrite)
    initial.add("textInverseGradientB2EActive",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientB2EActive.colors, DarkGradientTokens.TextInverseGradientB2EActive.positions, DarkGradientTokens.TextInverseGradientB2EActive.angle)),
            overwrite)
    initial.add("textInverseGradientMain",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientMain.colors, DarkGradientTokens.TextInverseGradientMain.positions, DarkGradientTokens.TextInverseGradientMain.angle)),
            overwrite)
    initial.add("textInverseGradientAthena",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientAthena.colors, DarkGradientTokens.TextInverseGradientAthena.positions, DarkGradientTokens.TextInverseGradientAthena.angle)),
            overwrite)
    initial.add("textInverseGradientJoy",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientJoy.colors, DarkGradientTokens.TextInverseGradientJoy.positions, DarkGradientTokens.TextInverseGradientJoy.angle)),
            overwrite)
    initial.add("textInverseGradientB2E",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientB2E.colors, DarkGradientTokens.TextInverseGradientB2E.positions, DarkGradientTokens.TextInverseGradientB2E.angle)),
            overwrite)
    initial.add("textInverseGradientBrand",
            listOf(linearGradient(DarkGradientTokens.TextInverseGradientBrand.colors, DarkGradientTokens.TextInverseGradientBrand.positions, DarkGradientTokens.TextInverseGradientBrand.angle)),
            overwrite)
    initial.add("surfaceDefaultAccentGradientHover",
    ...
    initial.add("surfaceDefaultTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceDefaultSkeleton",
            listOf(linearGradient(DarkGradientTokens.SurfaceDefaultSkeleton.colors, DarkGradientTokens.SurfaceDefaultSkeleton.positions, DarkGradientTokens.SurfaceDefaultSkeleton.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.SurfaceDefaultGradientMainHover.colors, DarkGradientTokens.SurfaceDefaultGradientMainHover.positions, DarkGradientTokens.SurfaceDefaultGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.SurfaceDefaultGradientMainActive.colors, DarkGradientTokens.SurfaceDefaultGradientMainActive.positions, DarkGradientTokens.SurfaceDefaultGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceDefaultGradientMain",
            listOf(linearGradient(DarkGradientTokens.SurfaceDefaultGradientMain.colors, DarkGradientTokens.SurfaceDefaultGradientMain.positions, DarkGradientTokens.SurfaceDefaultGradientMain.angle)),
            overwrite)
    initial.add("surfaceDefaultSkeletonGradient",
    ...
    initial.add("surfaceOnDarkTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceOnDarkGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnDarkGradientMainHover.colors, DarkGradientTokens.SurfaceOnDarkGradientMainHover.positions, DarkGradientTokens.SurfaceOnDarkGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceOnDarkGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnDarkGradientMainActive.colors, DarkGradientTokens.SurfaceOnDarkGradientMainActive.positions, DarkGradientTokens.SurfaceOnDarkGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceOnDarkGradientMain",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnDarkGradientMain.colors, DarkGradientTokens.SurfaceOnDarkGradientMain.positions, DarkGradientTokens.SurfaceOnDarkGradientMain.angle)),
            overwrite)
    initial.add("surfaceOnDarkSkeletonGradient",
    ...
    initial.add("surfaceOnLightTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceOnLightGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnLightGradientMainHover.colors, DarkGradientTokens.SurfaceOnLightGradientMainHover.positions, DarkGradientTokens.SurfaceOnLightGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceOnLightGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnLightGradientMainActive.colors, DarkGradientTokens.SurfaceOnLightGradientMainActive.positions, DarkGradientTokens.SurfaceOnLightGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceOnLightGradientMain",
            listOf(linearGradient(DarkGradientTokens.SurfaceOnLightGradientMain.colors, DarkGradientTokens.SurfaceOnLightGradientMain.positions, DarkGradientTokens.SurfaceOnLightGradientMain.angle)),
            overwrite)
    initial.add("surfaceOnLightSkeletonGradient",
    ...
    initial.add("surfaceInverseTransparentPromoGradient",
            ...
            overwrite)
    initial.add("surfaceInverseGradientMainHover",
            listOf(linearGradient(DarkGradientTokens.SurfaceInverseGradientMainHover.colors, DarkGradientTokens.SurfaceInverseGradientMainHover.positions, DarkGradientTokens.SurfaceInverseGradientMainHover.angle)),
            overwrite)
    initial.add("surfaceInverseGradientMainActive",
            listOf(linearGradient(DarkGradientTokens.SurfaceInverseGradientMainActive.colors, DarkGradientTokens.SurfaceInverseGradientMainActive.positions, DarkGradientTokens.SurfaceInverseGradientMainActive.angle)),
            overwrite)
    initial.add("surfaceInverseGradientMain",
            listOf(linearGradient(DarkGradientTokens.SurfaceInverseGradientMain.colors, DarkGradientTokens.SurfaceInverseGradientMain.positions, DarkGradientTokens.SurfaceInverseGradientMain.angle)),
            overwrite)
    initial.add("surfaceInverseSkeletonGradient",
    ...
    initial.add("surfaceInverseSkeletonDeepGradientActive",
            ...
            overwrite)
    initial.add("backgroundDefaultMobileAssistantAthena",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer0.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer0.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer0.angle),radialGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer1.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer1.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer1.radius, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer1.centerX, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer1.centerY),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer2.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer2.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer2.angle),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer3.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer3.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer3.angle),singleColor(DarkGradientTokens.BackgroundDefaultMobileAssistantAthena.Layer4.background)),
            overwrite)
    initial.add("backgroundDefaultMobileAssistantJoy",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer0.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer0.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer0.angle),radialGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer1.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer1.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer1.radius, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer1.centerX, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer1.centerY),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer2.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer2.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer2.angle),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer3.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer3.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer3.angle),singleColor(DarkGradientTokens.BackgroundDefaultMobileAssistantJoy.Layer4.background)),
            overwrite)
    initial.add("backgroundDefaultMobileAssistantBrand",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer0.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer0.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer0.angle),radialGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer1.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer1.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer1.radius, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer1.centerX, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer1.centerY),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer2.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer2.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer2.angle),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer3.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer3.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer3.angle),singleColor(DarkGradientTokens.BackgroundDefaultMobileAssistantBrand.Layer4.background)),
            overwrite)
    initial.add("backgroundDefaultModalSheet",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultModalSheet.Layer0.colors, DarkGradientTokens.BackgroundDefaultModalSheet.Layer0.positions, DarkGradientTokens.BackgroundDefaultModalSheet.Layer0.angle),singleColor(DarkGradientTokens.BackgroundDefaultModalSheet.Layer1.background)),
            overwrite)
    initial.add("backgroundDefaultMobileAssistantB2E",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer0.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer0.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer0.angle),radialGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer1.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer1.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer1.radius, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer1.centerX, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer1.centerY),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer2.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer2.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer2.angle),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer3.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer3.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer3.angle),singleColor(DarkGradientTokens.BackgroundDefaultMobileAssistantB2E.Layer4.background)),
            overwrite)
    initial.add("backgroundDefaultMobileAssistantMain",
            listOf(linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer0.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer0.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer0.angle),radialGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer1.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer1.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer1.radius, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer1.centerX, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer1.centerY),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer2.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer2.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer2.angle),linearGradient(DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer3.colors, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer3.positions, DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer3.angle),singleColor(DarkGradientTokens.BackgroundDefaultMobileAssistantMain.Layer4.background)),
            overwrite)
    initial.add("outlineDefaultAccentGradientHover",
