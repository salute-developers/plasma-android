...
import androidx.compose.ui.unit.dp
import com.sdds.stylessalute.tokens.SpacingTokens

/**
 * Отступы StylesSalute
 */
@Immutable
public data class StylesSaluteSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalStylesSaluteSpacing: ProvidableCompositionLocal<StylesSaluteSpacing> =
    staticCompositionLocalOf {
        StylesSaluteSpacing()
    }

/**
 * Возвращает [StylesSaluteSpacing]
 */
public fun defaultStylesSaluteSpacing(): StylesSaluteSpacing = StylesSaluteSpacing(
