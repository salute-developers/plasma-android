...
import com.sdds.stylessalute.tokens.ShadowTokens
 ...
 */
@Immutable
public data class StylesSaluteShadows(
    /**
     * shadow down soft s
     */
...
internal val LocalStylesSaluteShadows: ProvidableCompositionLocal<StylesSaluteShadows> =
    staticCompositionLocalOf {
        StylesSaluteShadows()
    }

/**
 * Возвращает [StylesSaluteShadows]
 */
@Suppress("LongMethod")
public fun defaultStylesSaluteShadows(): StylesSaluteShadows = StylesSaluteShadows(
