...
package com.sdds.stylessalute.styles.notificationcontent
...
public val WrapperNotificationContentLooseView.Info: WrapperNotificationContentLooseTerminate
    ...
    get() = builder
        .colors {
            titleColor(
                StylesSaluteTheme.colors.textDefaultInfo.asInteractive(),
            )
            textColor(
                StylesSaluteTheme.colors.textDefaultPrimary.asInteractive(),
            )
...
private val NotificationContentStyleBuilder.invariantProps: NotificationContentStyleBuilder
    ...
    get() = this
        ...
        .textStyle(StylesSaluteTheme.typography.textSNormal)
        .dimensions {
            iconSize(24.0.dp)
            textPadding(4.0.dp)
