...
import com.sdds.plasma.b2c.tokens.compose.GradientOverrideScope
 ...
 */
@Immutable
public class PlasmaB2cGradients(
    ...
    /**
     * Возвращает копию [PlasmaB2cGradients]. Предоставляет возможность переопределять градиенты.
     */
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}): PlasmaB2cGradients {
        ...
        return PlasmaB2cGradients(gradients.mapValues { overrideMap[it.key] ?: it.value })
    }
...
internal val LocalPlasmaB2cGradients: ProvidableCompositionLocal<PlasmaB2cGradients> =
        staticCompositionLocalOf { lightPlasmaB2cGradients() }
...
/**
 * Градиенты [PlasmaB2cGradients] для светлой темы
 */
public fun lightPlasmaB2cGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
        PlasmaB2cGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    ...
    initial.add("surfaceInverseSkeletonDeepGradientActive",
            ...
            overwrite)
    return PlasmaB2cGradients(initial)
}

/**
 * Градиенты [PlasmaB2cGradients] для темной темы
 */
public fun darkPlasmaB2cGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}):
        PlasmaB2cGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
