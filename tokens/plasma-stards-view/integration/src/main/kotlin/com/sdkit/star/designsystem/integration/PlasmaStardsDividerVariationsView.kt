...
internal object PlasmaStardsDividerVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "Default" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_Divider),
        )
}
