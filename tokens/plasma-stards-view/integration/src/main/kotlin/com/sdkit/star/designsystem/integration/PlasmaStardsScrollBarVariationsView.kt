...
internal object PlasmaStardsScrollBarVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "S" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_ScrollBarS),
            "M" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_ScrollBarM),
        )
}
