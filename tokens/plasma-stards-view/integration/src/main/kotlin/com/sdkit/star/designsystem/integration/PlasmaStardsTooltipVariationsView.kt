...
internal object PlasmaStardsTooltipVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_TooltipM),
            "S" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_TooltipS),
        )
}
