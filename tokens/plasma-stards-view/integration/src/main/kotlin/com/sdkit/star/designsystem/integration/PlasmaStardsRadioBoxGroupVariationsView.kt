...
internal object PlasmaStardsRadioBoxGroupVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "M" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_RadioBoxGroupM),
            "S" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_RadioBoxGroupS),
        )
}
