...
internal object PlasmaStardsRectSkeletonVariationsView : AndroidViewStyleProvider() {
    override val variations: Map<String, AndroidViewStyleReference> =
        mapOf(
            "Default" to viewStyleReference(DsR.style.Sdkit_StarDs_ComponentOverlays_RectSkeleton),
        )
}
