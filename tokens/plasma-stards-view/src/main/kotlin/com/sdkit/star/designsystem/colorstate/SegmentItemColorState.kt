...
public enum class SegmentItemColorState(
    ...
    PRIMARY(intArrayOf(R.attr.sdkit_segmentitem_state_primary)),
    SECONDARY(intArrayOf(R.attr.sdkit_segmentitem_state_secondary)),
}
...
internal class SegmentItemColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(
            R.styleable.SegmentItem_sdkit_segmentitemColors,
            0,
        )
        typedArray.recycle()
