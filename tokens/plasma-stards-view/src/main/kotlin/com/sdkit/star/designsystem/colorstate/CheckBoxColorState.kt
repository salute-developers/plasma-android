...
public enum class CheckBoxColorState(
    ...
    DEFAULT(intArrayOf(R.attr.sdkit_checkbox_state_default)),
    NEGATIVE(intArrayOf(R.attr.sdkit_checkbox_state_negative)),
}
...
internal class CheckBoxColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(R.styleable.CheckBox_sdkit_checkboxColors, 0)
        typedArray.recycle()
