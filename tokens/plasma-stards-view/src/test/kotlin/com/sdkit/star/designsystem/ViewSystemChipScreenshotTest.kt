...
class ViewSystemChipScreenshotTest : ChipTestCases("+night") {

    @Test
    override fun testChipLDefault() {
        themedComponent {
            chipLDefault(R.style.Sdkit_StarDs_ComponentOverlays_ChipLDefault)
        }
    }
    ...
    override fun testChipMSecondary() {
        themedComponent {
            chipMSecondary(R.style.Sdkit_StarDs_ComponentOverlays_ChipMPilledSecondary)
        }
    }
    ...
    override fun testChipSAccent() {
        themedComponent {
            chipSAccent(R.style.Sdkit_StarDs_ComponentOverlays_ChipSAccent)
        }
    }
