...
public enum class RectSkeletonColorState(
    ...
    DEFAULT(intArrayOf(R.attr.salute_rectskeleton_state_default)),
    LIGHTER(intArrayOf(R.attr.salute_rectskeleton_state_lighter)),
}
...
internal class RectSkeletonColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int =
            typedArray.getInt(R.styleable.RectSkeleton_salute_rectskeletonColors, 0)
        typedArray.recycle()
