...
public enum class SegmentColorState(
    ...
    PRIMARY(intArrayOf(R.attr.salute_segment_state_primary)),
    SECONDARY(intArrayOf(R.attr.salute_segment_state_secondary)),
}
...
internal class SegmentColorStateProvider : ColorStateProvider {
    public override fun obtain(
        ...
        val stateOrdinal: Int = typedArray.getInt(R.styleable.Segment_salute_segmentColors, 0)
        typedArray.recycle()
