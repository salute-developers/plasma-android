...
class ViewSystemRectSkeletonScreenshotTest(
    ...
    override fun testRectSkeleton() {
        themedComponent(
            ...
            rectSkeletonTest(style = R.style.Salute_StylesSalute_ComponentOverlays_RectSkeletonDefault)
        }
    ...
    override fun testRectSkeletonLighter() {
        themedComponent(
            ...
            rectSkeletonTest(style = R.style.Salute_StylesSalute_ComponentOverlays_RectSkeletonLighter)
        }
        captureScreenRoboImage()
    }
}
