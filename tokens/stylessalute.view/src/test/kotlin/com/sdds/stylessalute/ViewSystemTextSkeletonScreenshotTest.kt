...
class ViewSystemTextSkeletonScreenshotTest(
    ...
    override fun testTextSkeletonDefaultNoTextRandom() {
        themedComponent(
            ...
            textSkeletonLineCountThreeNoTextRandom(R.style.Salute_StylesSalute_ComponentOverlays_TextSkeletonDefault)
        }
    ...
    override fun testTextSkeletonDefaultFullWidth() {
        themedComponent(
            ...
            textSkeletonLineCountTenTextFullWidth(R.style.Salute_StylesSalute_ComponentOverlays_TextSkeletonDefault)
        }
        captureScreenRoboImage()
    }
    ...
    override fun testTextSkeletonLighterNoTextRandom() {
        themedComponent(
            ...
            textSkeletonLineCountThreeNoTextRandom(R.style.Salute_StylesSalute_ComponentOverlays_TextSkeletonLighter)
        }
        captureScreenRoboImage()
    }
