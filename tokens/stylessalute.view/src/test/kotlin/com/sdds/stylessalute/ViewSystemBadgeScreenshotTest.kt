...
class ViewSystemBadgeScreenshotTest(
    ...
    override fun testBadgeSizeLDefaultClear() {
        themedComponent {
            badgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_BadgeClearLDefault)
        }
    }
    ...
    override fun testBadgeSizeLDefaultTransparent() {
        themedComponent {
            badgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_BadgeTransparentLDefault)
        }
    }
    ...
    override fun testBadgeSizeMNegativeClear() {
        themedComponent {
            badgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_BadgeClearMNegative)
        }
    }
    ...
    override fun testBadgeSizeSWarningPilledTransparent() {
        themedComponent {
            badgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_BadgeTransparentSPilledWarning)
        }
    }
    ...
    override fun testIconBadgeSizeSPositiveClear() {
        themedComponent {
            iconBadgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_IconBadgeClearSPositive)
        }
    }
    ...
    override fun testIconBadgeSizeXsWarningTransparent() {
        themedComponent {
            iconBadgeCommon(R.style.Salute_StylesSalute_ComponentOverlays_IconBadgeTransparentXsWarning)
        }
    }
