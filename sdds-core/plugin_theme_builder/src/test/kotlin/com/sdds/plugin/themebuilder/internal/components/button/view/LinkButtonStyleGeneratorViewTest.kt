...
class LinkButtonStyleGeneratorViewTest {
    ...
    fun generate() {
        ...
        Assert.assertEquals(
            getResourceAsText("component-outputs/attrs/link-button-attrs.xml"),
            attrsOutputXml.toString(),
        )
        Assert.assertEquals(
            getResourceAsText("component-outputs/colors/link-button-color.xml"),
            colorOutputXml.toString(),
        )
        Assert.assertEquals(
            getResourceAsText("component-outputs/colorstate/LinkButtonColorStateKt.txt"),
