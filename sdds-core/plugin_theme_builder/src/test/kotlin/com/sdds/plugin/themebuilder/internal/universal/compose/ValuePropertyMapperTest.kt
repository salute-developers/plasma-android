...
import com.sdds.plugin.themebuilder.internal.universal.compose.mappers.ValuePropertyMapper
    ...
    fun `возвращает enum значение с кастомным state enum`() {
        val underTest = ValuePropertyMapper(
            ...
            stateEnum = ComposeStateEnum(
                ...
                values = listOf(
                    ComposeEnumValueInfo(name = "Focused", configName = "activated"),
                    ComposeEnumValueInfo(name = "Hovered", configName = "moved"),
                ),
            ),
        )
