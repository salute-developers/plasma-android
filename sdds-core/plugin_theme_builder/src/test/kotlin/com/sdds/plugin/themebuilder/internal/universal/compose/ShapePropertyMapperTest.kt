...
import com.sdds.plugin.themebuilder.internal.universal.compose.mappers.ShapePropertyMapper
...
class ShapePropertyMapperTest {
    ...
    fun `возвращает shape с кастомным stateEnum`() {
        val underTest = mapper(
            ...
            stateEnum = ComposeStateEnum(
                ...
                values = listOf(ComposeEnumValueInfo(name = "Active", configName = "active")),
            ),
        )
    ...
    private fun shapeParam(methodName: String) = ComposeShapePropertyMeta(
        id = "",
