...
class LinkButtonStyleGeneratorComposeTest {
    private lateinit var outputKt: ByteArrayOutputStream
    private lateinit var underTest: LinkButtonStyleGeneratorCompose
    ...
    fun before() {
        ...
        underTest = LinkButtonStyleGeneratorCompose(
    ...
    @Test
    fun `LinkButtonStyleGeneratorCompose должен генерировать kotlin файлы со стилями LinkButton`() {
        ...
        Assert.assertEquals(
            getResourceAsText("component-outputs/LinkButtonStylesKt.txt"),
            outputKt.toString(),
        )
    }
