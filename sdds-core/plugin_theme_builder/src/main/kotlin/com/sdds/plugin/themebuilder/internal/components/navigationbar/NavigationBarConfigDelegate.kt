...
import com.sdds.plugin.themebuilder.internal.components.navigationbar.compose.NavigationBarComposeVariationGenerator
import com.sdds.plugin.themebuilder.internal.components.navigationbar.view.NavigationBarStyleGeneratorView
...
internal class NavigationBarConfigDelegate : ComponentConfigDelegate<NavigationBarConfig>() {
    override fun parseConfig(file: File): NavigationBarConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<NavigationBarConfig>? {
        return NavigationBarStyleGeneratorView(
    ...
    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ) = NavigationBarComposeVariationGenerator(
