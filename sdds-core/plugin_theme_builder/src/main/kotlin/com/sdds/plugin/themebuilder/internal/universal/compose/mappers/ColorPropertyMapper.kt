...
import com.sdds.plugin.themebuilder.internal.universal.compose.ComposeColorPropertyMeta
...
internal class ColorPropertyMapper(
...
) : PropertyMapper<String, ComposeColorPropertyMeta, ColorState, Color>(stateEnum) {

    override fun map(meta: ComposeColorPropertyMeta, tokenValue: Color, variationId: String): String =
        when {
    ...
    private fun mapInteractiveColor(meta: ComposeColorPropertyMeta, color: Color): String {
    ...
    private fun mapSolidColorAsBrush(meta: ComposeColorPropertyMeta, color: SolidColor): String {
    ...
    private fun mapSolidColorAsColor(meta: ComposeColorPropertyMeta, color: SolidColor): String {
        val alphaStr = color.alpha?.let { ".multiplyAlpha(${it}f)" }.orEmpty()
    ...
    private fun mapGradientParam(meta: ComposeColorPropertyMeta, color: Gradient): String {
    ...
    private val ComposeColorPropertyMeta.isStatefulValue: Boolean
        get() = "StatefulValue" in paramQualifiedType

    private val ComposeColorPropertyMeta.isInteractiveColor: Boolean
