...
import com.sdds.plugin.themebuilder.internal.universal.compose.ComposeDimensionPropertyMeta
...
internal class DimensionPropertyMapper(
...
) : PropertyMapper<Float, ComposeDimensionPropertyMeta, FloatState, Dimension>(stateEnum) {
    ...
    override fun map(
        meta: ComposeDimensionPropertyMeta,
