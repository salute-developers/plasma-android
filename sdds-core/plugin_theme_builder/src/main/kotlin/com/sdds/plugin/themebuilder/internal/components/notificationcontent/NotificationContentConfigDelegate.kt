...
import com.sdds.plugin.themebuilder.internal.components.notificationcontent.compose.NotificationContentComposeVariationGenerator
import com.sdds.plugin.themebuilder.internal.components.notificationcontent.view.NotificationContentStyleGeneratorView
...
internal class NotificationContentConfigDelegate :
    ComponentConfigDelegate<NotificationContentConfig>() {
    override fun parseConfig(file: File): NotificationContentConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ) = NotificationContentStyleGeneratorView(
    ...
    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ) = NotificationContentComposeVariationGenerator(
        buttonGroupStylesPackage = "${deps.packageResolver.getPackage(TargetPackage.STYLES)}.buttongroup",
