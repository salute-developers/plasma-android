...
import com.sdds.plugin.themebuilder.internal.components.list.compose.ListComposeVariationGenerator
import com.sdds.plugin.themebuilder.internal.components.list.view.ListStyleGeneratorView
...
internal class ListConfigDelegate : ComponentConfigDelegate<ListConfig>() {
    override fun parseConfig(file: File): ListConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<ListConfig> =
        ListStyleGeneratorView(
    ...
    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ): ComponentStyleGenerator<ListConfig>? = ListComposeVariationGenerator(
