...
internal class LoaderConfigDelegate : ComponentConfigDelegate<LoaderConfig>() {
    override fun parseConfig(file: File): LoaderConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<LoaderConfig> =
        LoaderStyleGeneratorView(
    ...
    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ): ComponentStyleGenerator<LoaderConfig>? = LoaderComposeVariationGenerator(
        ...
        spinnerStylesPackage = "${deps.packageResolver.getPackage(TargetPackage.STYLES)}.spinner",
        circularProgressStylesPackage = "${deps.packageResolver.getPackage(TargetPackage.STYLES)}.circularprogressbar",
