...
import com.sdds.plugin.themebuilder.internal.universal.view.MetaDimensionProperty
...
internal class DimensionViewPropertyMapper(
    ...
    private val property = MetaDimensionProperty(meta)
    ...
    override fun map(
        ...
        when (value) {
            ...
            is SingleValue<Dimension> -> {
                if (value.isStateful) {
                    resources.addDimensionToStateList(
                        property,
                        value.value,
                        variation,
            ...
            is ViewStateValue<Dimension> -> value.values.forEach { (colorStateName, dimension) ->
                resources.addDimensionToStateList(
                    property,
                    dimension,
                    variation,
    ...
    override fun mapDirect(
        ...
        property.provide(props)?.let {
            resources.appendDimen(element, variation, property.attribute, property.fileSuffix, it.value)
        }
    }
