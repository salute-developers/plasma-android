...
internal class BasicButtonStyleGeneratorCompose(
                            ...
                            sizeData.shapeAdjustmentIfNeed(fromResources, size)
                                ...
                                .dimensions(
                                    Button.Dimensions(
                                        ...
                                        valueMargin = ${sizeData.getValueMargin(fromResources, size)},
                                    ),
                                )
    ...
    private fun ButtonComponentConfig.Size.getValueMargin(
        fromResources: Boolean,
        size: String,
    ): String {
        return getDimension("value_margin", valueMargin ?: 0f, fromResources, size)
    }
    ...
    private fun getDimension(
        ...
        return if (fromResources) {
            val dimenData = DimenData(
                name = "${BASIC_BUTTON_XML_PREFIX}_${dimenName}_size_$size",
                value = dimenValue,
    ...
    private companion object {
        const val BASIC_BUTTON_XML_PREFIX = "basic_button"
    }
}
