...
import com.sdds.plugin.themebuilder.internal.components.editable.view.EditableStyleGeneratorView
...
internal class EditableConfigDelegate : ComponentConfigDelegate<EditableConfig>() {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<EditableConfig>? {
        return EditableStyleGeneratorView(
