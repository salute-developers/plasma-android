...
internal class BottomSheetConfigDelegate : ComponentConfigDelegate<BottomSheetConfig>() {

    override fun parseConfig(file: File): BottomSheetConfig {
        return file.decode(Serializer.componentConfig)
    }

    override fun createViewGenerator(deps: StyleGeneratorDependencies, component: Component) = null

    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ): ComponentStyleGenerator<BottomSheetConfig>? =
