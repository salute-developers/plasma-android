...
internal class CodeInputConfigDelegate : ComponentConfigDelegate<CodeInputConfig>() {
    override fun parseConfig(file: File): CodeInputConfig {
    ...
    override fun createComposeGenerator(
        ...
        return CodeInputComposeVariationGenerator(
