...
internal class DividerConfigDelegate : ComponentConfigDelegate<DividerConfig>() {
    override fun parseConfig(file: File): DividerConfig {
        return file.decode<DividerConfig>(Serializer.componentConfig)
    }

    override fun createViewGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ): ComponentStyleGenerator<DividerConfig>? {
        return DividerStyleGeneratorView(
    ...
    override fun createComposeGenerator(
        ...
        return DividerComposeVariationGenerator(
