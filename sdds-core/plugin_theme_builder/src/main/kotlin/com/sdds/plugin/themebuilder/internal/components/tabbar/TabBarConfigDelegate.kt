...
internal class TabBarConfigDelegate : ComponentConfigDelegate<TabBarConfig>() {
    override fun parseConfig(file: File): TabBarConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<TabBarConfig>? = null

    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ): ComponentStyleGenerator<TabBarConfig> = TabBarComposeVariationGenerator(
        ...
        tabBarItemStylesPackage = "${deps.packageResolver.getPackage(TargetPackage.STYLES)}.tabbaritem",
    )
}
