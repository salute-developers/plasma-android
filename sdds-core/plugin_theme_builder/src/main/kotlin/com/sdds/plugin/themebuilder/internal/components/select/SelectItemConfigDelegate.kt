...
import com.sdds.plugin.themebuilder.internal.components.select.view.SelectItemStyleGeneratorView
...
internal class SelectItemConfigDelegate : ComponentConfigDelegate<SelectItemConfig>() {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<SelectItemConfig>? {
        return SelectItemStyleGeneratorView(
