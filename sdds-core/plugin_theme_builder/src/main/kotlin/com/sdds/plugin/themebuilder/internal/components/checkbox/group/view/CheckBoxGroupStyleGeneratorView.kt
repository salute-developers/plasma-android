...
internal open class CheckBoxGroupStyleGeneratorView(
    ...
    private fun Element.addProps(variation: String, variationNode: VariationNode<CheckBoxGroupProperties>) {
        ...
        props.checkBoxStyle?.let { componentOverlayAttribute("android:theme", it.camelCaseValue("")) }
    }
