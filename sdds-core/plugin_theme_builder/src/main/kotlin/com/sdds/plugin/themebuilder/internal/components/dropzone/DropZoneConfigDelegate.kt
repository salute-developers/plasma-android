...
internal class DropZoneConfigDelegate : ComponentConfigDelegate<DropZoneConfig>() {
    override fun parseConfig(file: File): DropZoneConfig {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<DropZoneConfig>? = null

    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ) = DropZoneComposeVariationGenerator(
