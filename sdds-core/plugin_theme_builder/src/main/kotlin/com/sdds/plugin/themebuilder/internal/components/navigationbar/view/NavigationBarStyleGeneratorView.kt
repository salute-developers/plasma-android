...
internal class NavigationBarStyleGeneratorView(
    ...
    private enum class NavigationBarDimensionsProperty(
        ...
        PADDING_START("sd_contentPaddingStart", "content_padding_start"),
        PADDING_END("sd_contentPaddingEnd", "content_padding_end"),
        PADDING_TOP("sd_contentPaddingTop", "content_padding_top"),
        PADDING_BOTTOM("sd_contentPaddingBottom", "content_padding_bottom"),
