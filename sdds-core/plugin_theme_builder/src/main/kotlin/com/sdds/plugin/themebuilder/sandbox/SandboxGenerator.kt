...
internal class ComposeComponentsGenerator(
    ...
    private val styleProviderTemplatePath = when (scheme) {
        SandboxScheme.V1 -> "ComposeStyleProviderKt_V1.txt"
        SandboxScheme.V2 -> "ComposeStyleProviderKt_V2.txt"
    }

    private val styleInstanceTemplatePath = when (scheme) {
        SandboxScheme.V1 -> "ComposeStyleInstanceKt_V1.txt"
        SandboxScheme.V2 -> "ComposeStyleInstanceKt_V2.txt"
    }

    private val componentInstanceTemplatePath = when (scheme) {
        SandboxScheme.V1 -> "ComposeComponentInstanceKt_V1.txt"
        SandboxScheme.V2 -> "ComposeComponentInstanceKt_V2.txt"
    }

    private val componentProviderTemplatePath = when (scheme) {
        SandboxScheme.V1 -> "ComposeComponentProviderKt_V1.txt"
        SandboxScheme.V2 -> "ComposeComponentProviderKt_V2.txt"
    }
    ...
    private fun createRegisterTheme(
        ...
        if (scheme != SandboxScheme.V2) return
...
internal class XmlComponentsGenerator(
    ...
    private val viewStyleProviderTemplateName: String = when (scheme) {
        SandboxScheme.V1 -> "ViewStyleProviderKt.txt"
        SandboxScheme.V2 -> "ViewStyleProviderKt_V2.txt"
    }

    private val viewStyleInstanceTemplateName: String = when (scheme) {
        SandboxScheme.V1 -> "ViewStyleInstanceKt.txt"
        SandboxScheme.V2 -> "ViewStyleInstanceKt_V2.txt"
    }

    private val viewComponentInstanceTemplateName: String = when (scheme) {
        SandboxScheme.V1 -> "ViewComponentInstanceKt.txt"
        SandboxScheme.V2 -> "ViewComponentInstanceKt_V2.txt"
    }

    private val viewComponentProviderTemplateName: String = when (scheme) {
        SandboxScheme.V1 -> "ViewComponentProviderKt.txt"
        SandboxScheme.V2 -> "ViewComponentProviderKt_V2.txt"
    }
