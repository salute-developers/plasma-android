...
import com.sdds.plugin.themebuilder.internal.components.drawer.view.DrawerStyleGeneratorView
...
internal class DrawerConfigDelegate : ComponentConfigDelegate<DrawerConfig>() {
    override fun parseConfig(file: File): DrawerConfig {
    ...
    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ) = DrawerComposeVariationGenerator(
