...
import com.sdds.plugin.themebuilder.internal.components.slider.compose.SliderComposeVariationGenerator
...
internal class SliderConfigDelegate : ComponentConfigDelegate<SliderConfig>() {
    ...
    override fun createViewGenerator(
        ...
        component: Component,
    ): ComponentStyleGenerator<SliderConfig>?= null

    override fun createComposeGenerator(
        deps: StyleGeneratorDependencies,
        component: Component,
    ) = SliderComposeVariationGenerator(
