...
internal data class TabBarItemProperties(
    ...
    val extraOffsetX: Dimension? = null,
    val extraOffsetY: Dimension? = null,
    ...
    override fun merge(parent: PropertyOwner): PropertyOwner {
        ...
        return copy(
            ...
            extraOffsetX = extraOffsetX ?: otherProps.extraOffsetX,
            extraOffsetY = extraOffsetY ?: otherProps.extraOffsetY,
