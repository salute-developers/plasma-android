...
private fun consumeSwipeWithinBottomSheetBoundsNestedScrollConnection(
    ...
    override fun onPostScroll(
        ...
        return if (source == NestedScrollSource.Drag) {
            state.dispatchRawDelta(available.mainAxisOffset()).toOffset()
        } else {
            Offset.Zero
        }
    }
    ...
    override suspend fun onPreFling(available: Velocity): Velocity {
        val toFling = available.mainAxisVelocity()
    ...
    override suspend fun onPostFling(consumed: Velocity, available: Velocity): Velocity {
        state.settle(velocity = available.mainAxisVelocity())
        return available
    }
    ...
    private fun Velocity.mainAxisVelocity() = if (orientation == Orientation.Horizontal) x else y

    private fun Offset.mainAxisOffset(): Float = if (orientation == Orientation.Horizontal) x else y
}
