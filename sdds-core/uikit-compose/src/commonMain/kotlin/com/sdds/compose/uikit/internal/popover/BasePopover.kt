...
internal interface PopoverAnchor

internal interface DeferredConstraintsUpdater {
...
@Composable
internal expect fun rememberPopoverAnchor(): PopoverAnchor

@Composable
internal expect fun rememberPopoverRootSize(anchor: PopoverAnchor): IntSize

@Composable
internal expect fun rememberDeferredConstraintsUpdater(
    apply: (IntSize) -> Unit,
): DeferredConstraintsUpdater

@Composable
internal expect fun PlatformPopupContentEffects(
