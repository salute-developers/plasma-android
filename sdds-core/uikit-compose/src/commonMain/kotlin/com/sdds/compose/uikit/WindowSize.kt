...
fun collectWindowSizeInfoAsState(): State<WindowSizeInfo> {
    ...
    info.value = remember(windowSize) {
        val widthClass = when {
            windowSize.width < mediumWidthBreakPoint -> WindowSizeClass.Compact
            windowSize.width in mediumWidthBreakPoint until expandedWidthBreakPoint -> WindowSizeClass.Medium
            else -> WindowSizeClass.Expanded
        }
        val heightClass = when {
            windowSize.height < mediumHeightBreakPoint -> WindowSizeClass.Compact
            windowSize.height in mediumHeightBreakPoint until expandedHeightBreakPoint -> WindowSizeClass.Medium
            else -> WindowSizeClass.Expanded
        }
...
@Composable
internal expect fun rememberWindowSize(): IntSize
