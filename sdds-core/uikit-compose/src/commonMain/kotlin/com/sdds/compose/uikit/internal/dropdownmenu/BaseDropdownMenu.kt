...
private fun ModalDropdownMenuContent(
    ...
    val dialogLocation = rememberDialogLocationInScreen()
                ...
                if (cutoutEnabled) {
                    Box(
                        modifier = Modifier
                            .offset {
                                IntOffset(
                                    x = triggerInfo.positionInScreen.x - dialogLocation.x,
                                    y = triggerInfo.positionInScreen.y - dialogLocation.y,
                                )
                            }
                            .requiredSize(
...
@Composable
internal expect fun rememberDialogLocationInScreen(): IntOffset

private fun Rect.toDialogBounds(dialogLocation: IntOffset): Rect = Rect(
    left = left - dialogLocation.x,
    top = top - dialogLocation.y,
    right = right - dialogLocation.x,
    bottom = bottom - dialogLocation.y,
)
...
internal expect val DefaultModalDropdownDialogProperties: DialogProperties

internal expect val DefaultModalDropdownPopupProperties: PopupProperties
