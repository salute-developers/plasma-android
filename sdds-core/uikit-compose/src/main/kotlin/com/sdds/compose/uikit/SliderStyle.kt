...
interface SliderStyleBuilder : StyleBuilder<SliderStyle> {
     ...
     */
    fun alignment(alignment: Alignment): SliderStyleBuilder
...
private data class DefaultSliderStyle(
    ...
    class Builder : SliderStyleBuilder {
        ...
        override fun alignment(alignment: Alignment): SliderStyleBuilder = apply {
...
interface SliderColors {
    ...
    /**
     * Цвет бордера ползунка
     */
    val thumbStrokeColor: InteractiveColor

    /**
     * Цвет (или градиент) бордера ползунка
     */
    val thumbStrokeBrush: StatefulValue<Brush>?
...
interface SliderColorsBuilder {
    ...
    fun thumbStrokeColor(thumbStrokeColor: Color): SliderColorsBuilder =
        thumbStrokeColor(thumbStrokeColor.asInteractive())

    /**
     * Устанавливает цвет [thumbStrokeColor] индикатора компонента.
     * @see SliderColors.thumbStrokeColor
     */
    fun thumbStrokeColor(thumbStrokeColor: InteractiveColor): SliderColorsBuilder
...
private data class DefaultSliderColors(
    ...
    override val thumbStrokeColor: InteractiveColor,
    override val thumbStrokeBrush: StatefulValue<Brush>?,
    ...
    class Builder : SliderColorsBuilder {
        ...
        override fun thumbStrokeColor(thumbStrokeColor: InteractiveColor): SliderColorsBuilder = apply {
        ...
        override fun build(): SliderColors = DefaultSliderColors(
            ...
            thumbStrokeColor = thumbStrokeColor ?: Color.Green.asInteractive(),
            thumbStrokeBrush = thumbStrokeBrush,
