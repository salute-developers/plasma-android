...
interface TextAreaStyleBuilder : StyleBuilder<TextFieldStyle> {
    ...
    @Composable
    fun dimensions(dimensions: TextFieldDimensions): TextAreaStyleBuilder
     ...
     */
    fun labelPlacement(labelPlacement: TextFieldLabelPlacement): TextAreaStyleBuilder

    /**
     * Устанавливает тип поля [fieldType]
     */
    fun fieldType(fieldType: TextFieldType): TextAreaStyleBuilder
     ...
     */
    fun prefixStyle(prefixStyle: TextStyle): TextAreaStyleBuilder

    /**
     * Устанавливает стиль суффикса [suffixStyle]
     */
    fun suffixStyle(suffixStyle: TextStyle): TextAreaStyleBuilder
...
interface TextAreaColorsBuilder {
     ...
     */
    fun cursorColorReadOnly(cursorColorReadOnly: Color): TextAreaColorsBuilder =
        cursorColorReadOnly(cursorColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет курсора [cursorColorReadOnly]
     */
    fun cursorColorReadOnly(cursorColorReadOnly: InteractiveColor): TextAreaColorsBuilder
     ...
     */
    fun startContentColorReadOnly(startContentColorReadOnly: Color): TextAreaColorsBuilder =
        startContentColorReadOnly(startContentColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет контента в начале [startContentColorReadOnly]
     */
    fun startContentColorReadOnly(startContentColorReadOnly: InteractiveColor): TextAreaColorsBuilder
     ...
     */
    fun endContentColorReadOnly(endContentColorReadOnly: Color): TextAreaColorsBuilder =
        endContentColorReadOnly(endContentColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет контента в конце [endContentColorReadOnly]
     */
    fun endContentColorReadOnly(endContentColorReadOnly: InteractiveColor): TextAreaColorsBuilder
     ...
     */
    fun optionalColorReadOnly(optionalColorReadOnly: Color): TextAreaColorsBuilder =
        optionalColorReadOnly(optionalColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет опционального текста [optionalColorReadOnly]
     */
    fun optionalColorReadOnly(optionalColorReadOnly: InteractiveColor): TextAreaColorsBuilder
     ...
     */
    fun counterColorReadOnly(counterColorReadOnly: Color): TextAreaColorsBuilder =
        counterColorReadOnly(counterColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет счетчика [counterColorReadOnly]
     */
    fun counterColorReadOnly(counterColorReadOnly: InteractiveColor): TextAreaColorsBuilder
     ...
     * Устанавливает цвет индикатора
     */
    fun indicatorColorReadOnly(indicatorColorReadOnly: Color): TextAreaColorsBuilder =
        indicatorColorReadOnly(indicatorColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет индикатора
     */
    fun indicatorColorReadOnly(indicatorColorReadOnly: InteractiveColor): TextAreaColorsBuilder

    /**
     * Устанавливает цвет префикса
     */
    fun prefixColor(prefixColor: Color): TextAreaColorsBuilder =
        prefixColor(prefixColor.asInteractive())

    /**
     * Устанавливает цвет префикса
     */
    fun prefixColor(prefixColor: InteractiveColor): TextAreaColorsBuilder

    /**
     * Устанавливает цвет суффикса
     */
    fun suffixColor(suffixColor: Color): TextAreaColorsBuilder =
        suffixColor(suffixColor.asInteractive())

    /**
     * Устанавливает цвет суффикса
     */
    fun suffixColor(suffixColor: InteractiveColor): TextAreaColorsBuilder

    /**
     * Устанавливает цвет префикса
     */
    fun prefixColorReadOnly(prefixColorReadOnly: Color): TextAreaColorsBuilder =
        prefixColorReadOnly(prefixColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет префикса
     */
    fun prefixColorReadOnly(prefixColorReadOnly: InteractiveColor): TextAreaColorsBuilder

    /**
     * Устанавливает цвет суффикса
     */
    fun suffixColorReadOnly(suffixColorReadOnly: Color): TextAreaColorsBuilder =
        suffixColorReadOnly(suffixColorReadOnly.asInteractive())

    /**
     * Устанавливает цвет суффикса
     */
    fun suffixColorReadOnly(suffixColorReadOnly: InteractiveColor): TextAreaColorsBuilder
    ...
    class Builder(override val receiver: Any?) : TextAreaStyleBuilder {
        ...
        override fun style(): TextFieldStyle {
            return DefaultTextAreaStyle(
                singleLine = false,
                hasDivider = false,
                fieldAppearance = TextFieldAppearance.Solid,
...
private class DefaultTextAreaColors(
    ...
    class Builder : TextAreaColorsBuilder {
        ...
        override fun counterColorReadOnly(counterColorReadOnly: InteractiveColor) = apply {
            this.cursorColorReadOnly = counterColorReadOnly
        }
