...
private fun Thumb(
    ...
    val strokeColor = style.colors.thumbStrokeColor.colorForInteraction(interactionSource)
...
private fun Modifier.sliderPress(state: SliderState, reverse: Boolean) =
...
private fun Modifier.sliderDrag(state: SliderState, reverse: Boolean) =
    pointerInput(state, reverse) {
        awaitPointerEventScope {
            while (true) {
...
private fun SliderImpl(
    ...
    val dragModifier = Modifier.sliderDrag(state, reversed)
    val pressModifier = Modifier.sliderPress(state, reversed)
