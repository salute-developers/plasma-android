...
interface NewFocusSelector {
    fun Modifier.applyFocus(isFocused: () -> Boolean): Modifier
}

fun Modifier.applyFocus(
    selector: NewFocusSelector,
    isFocused: () -> Boolean
): Modifier {
    return selector.run { applyFocus { isFocused() } }
}

class BorderFocus(
    private val stroke: BorderStroke,
    private val strokePadding: Dp,
    private val originalShape: CornerBasedShape,
    private val isFocused: () -> Boolean,
) : NewFocusSelector {
    override fun Modifier.applyFocus(isFocused: () -> Boolean): Modifier {
