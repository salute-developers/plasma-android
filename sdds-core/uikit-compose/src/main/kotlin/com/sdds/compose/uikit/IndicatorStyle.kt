...
interface IndicatorStyle : Style {
     ...
     * Размеры
     */
    val dimensions: Indicator.Dimensions
...
interface IndicatorDimensionsBuilder {
    ...
    /**
     * Возвращает [Indicator.Dimensions]
     */
    fun build(): Indicator.Dimensions

    companion object {
        /**
         * Вернет экземпляр билдера [IndicatorDimensionsBuilder]
         */
        fun builder(): IndicatorDimensionsBuilder = DefaultIndicatorDimensionsBuilder()
    }
}

private class DefaultIndicatorDimensionsBuilder : IndicatorDimensionsBuilder {
    ...
    override fun build(): Indicator.Dimensions {
...
internal class DefaultIndicatorStyle(
    ...
    override val dimensions: Indicator.Dimensions,
) : IndicatorStyle

@Stable
private class IndicatorStyleBuilderImpl(override val receiver: Any?) : IndicatorStyleBuilder {
    private var shape: CornerBasedShape? = null
    private var colorBuilder: IndicatorColorBuilder = IndicatorColor.builder()
