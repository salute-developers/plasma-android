...
interface TextFieldClearStyleBuilder : StyleBuilder<TextFieldStyle> {
    ...
    @Composable
    fun dimensions(dimensions: TextFieldDimensions): TextFieldClearStyleBuilder
     ...
     */
    fun labelPlacement(labelPlacement: TextFieldLabelPlacement): TextFieldClearStyleBuilder

    /**
     * Устанавливает тип поля [fieldType]
     */
    fun fieldType(fieldType: TextFieldType): TextFieldClearStyleBuilder
