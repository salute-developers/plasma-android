...
private class DefaultTextFieldStyle(
    ...
    class Builder(override val receiver: Any?) : TextFieldStyleBuilder {
        ...
        private var scrollBarBuilder: TextFieldScrollBarBuilder = TextFieldScrollBarBuilder.builder()
        ...
        override fun helperTextPlacement(helperTextPlacement: TextFieldHelperTextPlacement) = apply {
        ...
        @Composable
        override fun scrollBar(builder: @Composable (TextFieldScrollBarBuilder.() -> Unit)) = apply {
