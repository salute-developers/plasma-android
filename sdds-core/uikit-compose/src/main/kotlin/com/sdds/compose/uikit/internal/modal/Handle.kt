 ...
 * @param progressProvider используется для режима handlePlacement.Auto
...
internal fun Modifier.handle(
    ...
    handleShape: State<Shape>,
    handleColor: BrushProducer,
    handleWidth: State<Dp>,
                ...
                onDrawWithContent {
                    ...
                    if (sheetState?.currentValue != BottomSheetValue.Hidden) {
                        ...
                        translate(resultOffset.x.toFloat(), resultOffset.y.toFloat()) {
                            drawOutline(outline = outline, brush = handleColor.invoke())
                        }
                    }
                }
            }
