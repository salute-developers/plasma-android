...
## Стиль ModalBottmoSheet

Стиль ModalBottmoSheet можно настроить с помощью ModalBottmoSheet.builder().Так же существует набор сгенерированных стилей.
...
## ModalBottmoSheet HandlePlacement (Ручка)
...
В режиме Auto (по дефолту) изначально handle находится снаружи, но по мере выдвижения
ModalBottomSheet - смещается во внутрь.
