...
internal class CustomCenteringLayout @JvmOverloads constructor(
    ...
    private val actionEnd = LinearLayout(context).apply {
        layoutParams = MarginLayoutParams(
            LayoutParams.WRAP_CONTENT,
            LayoutParams.WRAP_CONTENT,
        )
    ...
    var centeringStrategy: CenteringStrategy = CenteringStrategy.ABSOLUTE
        set(value) {
            if (field != value) {
                field = value
                requestLayout()
    ...
    fun setActionStart(view: View?, params: LinearLayout.LayoutParams? = null) {
        removeActionStart()
        actionStart.addView(view)
    }

    fun setActionEnd(view: View?, params: LinearLayout.LayoutParams? = null) {
        removeActionEnd()
        actionEnd.addView(view)
    }

    fun setCenterContent(view: View?, params: LinearLayout.LayoutParams? = null) {
        removeCenterContent()
        centerContent.addView(view)
    }

    fun addCenterContent(view: View?, params: LinearLayout.LayoutParams? = null) {
        centerContent.addView(view)
    }
}
