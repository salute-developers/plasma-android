...
open class Segment @JvmOverloads constructor(
    ...
    private var _distributeEqually: Boolean = false
    ...
    init {
        ...
        _distributeEqually = typedArray.getBoolean(R.styleable.Segment_sd_distributeEqually, true)
    ...
    override fun addView(child: View?, index: Int, params: ViewGroup.LayoutParams?) {
        ...
        if (_distributeEqually) {
            (params as? LayoutParams)?.apply {
                this.weight = 1F
            }
        }
