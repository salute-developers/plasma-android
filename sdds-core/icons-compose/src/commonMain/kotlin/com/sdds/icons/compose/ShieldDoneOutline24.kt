...
public val SddsIcons.ShieldDoneOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ShieldDoneOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 16.544 10.016 c 0.285 -0.3 0.273 -0.775 -0.028 -1.06 c -0.3 -0.285 -0.775 -0.273 -1.06 0.028 l -4.243 4.474 l -1.716 -1.52 c -0.31 -0.274 -0.784 -0.245 -1.059 0.065 c -0.274 0.31 -0.245 0.784 0.065 1.058 l 2.258 2.0 c 0.303 0.268 0.764 0.248 1.042 -0.045 l 4.741 -5.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
