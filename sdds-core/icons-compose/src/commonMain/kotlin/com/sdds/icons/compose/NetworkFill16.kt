...
public val SddsIcons.NetworkFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "NetworkFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 10.0 6.2 c 0.0 1.105 -0.895 2.0 -2.0 2.0 s -2.0 -0.895 -2.0 -2.0 s 0.895 -2.0 2.0 -2.0 s 2.0 0.895 2.0 2.0 Z")
        )
    }.build()
}
