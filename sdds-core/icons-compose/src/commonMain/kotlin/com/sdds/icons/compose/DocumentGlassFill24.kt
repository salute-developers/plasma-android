...
public val SddsIcons.DocumentGlassFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "DocumentGlassFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 16.25 17.0 c 0.0 -0.966 0.784 -1.75 1.75 -1.75 s 1.75 0.784 1.75 1.75 s -0.784 1.75 -1.75 1.75 s -1.75 -0.784 -1.75 -1.75 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 23.0 17.5 c 0.0 3.038 -2.462 5.5 -5.5 5.5 S 12.0 20.538 12.0 17.5 s 2.462 -5.5 5.5 -5.5 s 5.5 2.462 5.5 5.5 Z m -5.0 -3.25 c -1.519 0.0 -2.75 1.231 -2.75 2.75 c 0.0 0.579 0.179 1.116 0.484 1.559 l -1.338 1.337 c -0.195 0.196 -0.195 0.512 0.0 0.708 c 0.196 0.195 0.512 0.195 0.708 0.0 l 1.337 -1.338 c 0.443 0.305 0.98 0.484 1.559 0.484 c 1.519 0.0 2.75 -1.231 2.75 -2.75 s -1.231 -2.75 -2.75 -2.75 Z")
        )
    }.build()
}
