...
public val SddsIcons.CalendarEventOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CalendarEventOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 15.0 24.0 c 0.0 1.657 -1.343 3.0 -3.0 3.0 s -3.0 -1.343 -3.0 -3.0 s 1.343 -3.0 3.0 -3.0 s 3.0 1.343 3.0 3.0 Z")
        )
    }.build()
}
