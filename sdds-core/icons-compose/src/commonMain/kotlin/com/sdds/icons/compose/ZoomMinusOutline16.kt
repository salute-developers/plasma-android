...
public val SddsIcons.ZoomMinusOutline16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ZoomMinusOutline16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 4.2 7.0 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 4.6 c 0.275 0.0 0.5 0.224 0.5 0.5 S 9.574 7.5 9.3 7.5 H 4.7 C 4.422 7.5 4.2 7.276 4.2 7.0 Z")
        )
    }.build()
}
