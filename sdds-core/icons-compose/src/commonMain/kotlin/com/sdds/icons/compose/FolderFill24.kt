...
public val SddsIcons.FolderFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "FolderFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
