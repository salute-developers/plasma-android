...
public val SddsIcons.Battery100Outline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Battery100Outline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 9.0 12.6 c -0.277 0.0 -0.5 -0.223 -0.5 -0.5 v -0.5 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 6.0 c 0.276 0.0 0.5 0.224 0.5 0.5 v 0.5 c 0.0 0.277 -0.224 0.5 -0.5 0.5 H 9.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 9.0 10.3 c -0.277 0.0 -0.5 -0.223 -0.5 -0.5 V 9.3 c 0.0 -0.275 0.223 -0.5 0.5 -0.5 h 6.0 c 0.276 0.0 0.5 0.225 0.5 0.5 v 0.5 c 0.0 0.277 -0.224 0.5 -0.5 0.5 H 9.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 9.0 8.001 c -0.277 0.0 -0.5 -0.224 -0.5 -0.5 v -0.5 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 6.0 c 0.276 0.0 0.5 0.224 0.5 0.5 v 0.5 c 0.0 0.276 -0.224 0.5 -0.5 0.5 H 9.0 Z")
        )
    }.build()
}
