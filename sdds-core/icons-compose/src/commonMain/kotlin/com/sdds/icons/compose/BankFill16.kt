...
public val SddsIcons.BankFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BankFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 7.501 1.28 c 0.317 -0.146 0.682 -0.146 0.999 0.0 l 5.49 2.51 c 0.177 0.081 0.291 0.26 0.291 0.455 v 1.322 c 0.0 0.276 -0.224 0.5 -0.5 0.5 H 2.228 c -0.276 0.0 -0.5 -0.224 -0.5 -0.5 V 4.245 l 0.004 -0.072 C 1.757 4.007 1.864 3.86 2.02 3.79 L 7.5 1.28 Z")
        )
    }.build()
}
