...
public val SddsIcons.ScenarioSyncAuto65Fill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ScenarioSyncAuto65Fill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
            pathData = addPathNodes("M 7.75 14.0 v -1.25 H 9.5 c 0.138 0.0 0.25 0.112 0.25 0.25 v 1.0 c 0.0 0.138 -0.112 0.25 -0.25 0.25 H 8.0 c -0.138 0.0 -0.25 -0.112 -0.25 -0.25 Z")
        )
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 4.5 12.0 c 0.0 -4.142 3.358 -7.5 7.5 -7.5 c 4.142 0.0 7.5 3.358 7.5 7.5 c 0.0 4.142 -3.358 7.5 -7.5 7.5 c -4.142 0.0 -7.5 -3.358 -7.5 -7.5 Z M 8.0 8.25 c -0.966 0.0 -1.75 0.784 -1.75 1.75 v 4.0 c 0.0 0.966 0.784 1.75 1.75 1.75 h 1.5 c 0.966 0.0 1.75 -0.784 1.75 -1.75 v -1.0 c 0.0 -0.966 -0.784 -1.75 -1.75 -1.75 H 7.75 V 10.0 c 0.0 -0.138 0.112 -0.25 0.25 -0.25 h 2.5 c 0.414 0.0 0.75 -0.336 0.75 -0.75 s -0.336 -0.75 -0.75 -0.75 H 8.0 Z M 12.5 9.0 c 0.0 -0.414 0.336 -0.75 0.75 -0.75 h 3.5 c 0.414 0.0 0.75 0.336 0.75 0.75 s -0.336 0.75 -0.75 0.75 H 14.0 v 1.5 h 1.75 c 0.966 0.0 1.75 0.784 1.75 1.75 v 1.0 c 0.0 0.966 -0.784 1.75 -1.75 1.75 h -2.5 c -0.414 0.0 -0.75 -0.336 -0.75 -0.75 s 0.336 -0.75 0.75 -0.75 h 2.5 c 0.138 0.0 0.25 -0.112 0.25 -0.25 v -1.0 c 0.0 -0.138 -0.112 -0.25 -0.25 -0.25 h -2.5 c -0.414 0.0 -0.75 -0.336 -0.75 -0.75 V 9.0 Z")
        )
    }.build()
}
