...
public val SddsIcons.MessageChatOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "MessageChatOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 23.68 20.174 c 1.084 0.0 1.963 -0.879 1.963 -1.963 c 0.0 -1.085 -0.879 -1.964 -1.963 -1.964 c -1.085 0.0 -1.964 0.88 -1.964 1.964 s 0.88 1.963 1.964 1.963 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 19.753 18.21 c 0.0 1.085 -0.879 1.964 -1.963 1.964 c -1.085 0.0 -1.964 -0.879 -1.964 -1.963 c 0.0 -1.085 0.879 -1.964 1.963 -1.964 c 1.085 0.0 1.964 0.88 1.964 1.964 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 11.898 20.174 c 1.084 0.0 1.963 -0.879 1.963 -1.963 c 0.0 -1.085 -0.879 -1.964 -1.963 -1.964 c -1.085 0.0 -1.964 0.88 -1.964 1.964 s 0.88 1.963 1.964 1.963 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
