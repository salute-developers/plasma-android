...
public val SddsIcons.Button2X2BotLOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Button2X2BotLOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 4.25 13.0 C 3.007 13.0 2.0 14.007 2.0 15.25 v 4.5 C 2.0 20.993 3.007 22.0 4.25 22.0 h 4.5 C 9.993 22.0 11.0 20.993 11.0 19.75 v -4.5 C 11.0 14.007 9.993 13.0 8.75 13.0 h -4.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 4.75 3.0 C 3.784 3.0 3.0 3.784 3.0 4.75 v 3.5 C 3.0 9.216 3.784 10.0 4.75 10.0 h 3.5 C 9.216 10.0 10.0 9.216 10.0 8.25 v -3.5 C 10.0 3.784 9.216 3.0 8.25 3.0 h -3.5 Z M 4.5 4.75 c 0.0 -0.138 0.112 -0.25 0.25 -0.25 h 3.5 c 0.138 0.0 0.25 0.112 0.25 0.25 v 3.5 c 0.0 0.138 -0.112 0.25 -0.25 0.25 h -3.5 C 4.612 8.5 4.5 8.388 4.5 8.25 v -3.5 Z")
        )
    }.build()
}
