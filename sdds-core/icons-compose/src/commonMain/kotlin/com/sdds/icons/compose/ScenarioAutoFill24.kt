...
public val SddsIcons.ScenarioAutoFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ScenarioAutoFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
            pathData = addPathNodes("M 13.037 11.75 L 12.0 9.677 l -1.037 2.073 h 2.074 Z")
        )
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 12.0 4.5 c -4.142 0.0 -7.5 3.358 -7.5 7.5 c 0.0 4.142 3.358 7.5 7.5 7.5 c 4.142 0.0 7.5 -3.358 7.5 -7.5 c 0.0 -4.142 -3.358 -7.5 -7.5 -7.5 Z m 0.0 2.75 c 0.284 0.0 0.544 0.16 0.67 0.415 l 3.5 7.0 c 0.186 0.37 0.036 0.82 -0.335 1.006 c -0.37 0.185 -0.82 0.035 -1.006 -0.336 l -1.043 -2.085 h -3.572 L 9.17 15.335 c -0.185 0.37 -0.636 0.521 -1.006 0.336 s -0.521 -0.636 -0.336 -1.006 l 3.5 -7.0 C 11.456 7.41 11.716 7.25 12.0 7.25 Z")
        )
    }.build()
}
