...
public val SddsIcons.OpenOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "OpenOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        addPath(
            ...
            pathData = addPathNodes("M 9.0 8.0 C 8.586 8.0 8.25 8.336 8.25 8.75 S 8.586 9.5 9.0 9.5 h 4.44 l -5.47 5.47 c -0.293 0.293 -0.293 0.767 0.0 1.06 c 0.293 0.293 0.767 0.293 1.06 0.0 l 5.47 -5.47 V 15.0 c 0.0 0.414 0.336 0.75 0.75 0.75 S 16.0 15.414 16.0 15.0 V 8.75 C 16.0 8.336 15.664 8.0 15.25 8.0 H 9.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White.copy(alpha = 0.9607843f)),
