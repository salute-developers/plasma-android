...
public val SddsIcons.CoinRialOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CoinRialOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 10.75 8.0 c 0.0 -0.414 0.336 -0.75 0.75 -0.75 h 2.25 c 1.657 0.0 3.0 1.343 3.0 3.0 c 0.0 1.248 -0.762 2.318 -1.847 2.77 l 1.75 3.112 c 0.204 0.361 0.076 0.819 -0.285 1.022 c -0.361 0.203 -0.819 0.075 -1.022 -0.286 l -2.035 -3.618 H 12.25 v 3.25 c 0.0 0.414 -0.336 0.75 -0.75 0.75 s -0.75 -0.336 -0.75 -0.75 V 8.0 Z m 2.985 3.75 H 12.25 h 1.485 Z m 0.026 0.0 c 0.823 -0.006 1.489 -0.675 1.489 -1.5 c 0.0 -0.828 -0.672 -1.5 -1.5 -1.5 h -1.5 v 3.0")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 8.5 7.25 c 0.414 0.0 0.75 0.336 0.75 0.75 v 8.5 c 0.0 0.414 -0.336 0.75 -0.75 0.75 s -0.75 -0.336 -0.75 -0.75 V 8.0 c 0.0 -0.414 0.336 -0.75 0.75 -0.75 Z")
        )
    }.build()
}
