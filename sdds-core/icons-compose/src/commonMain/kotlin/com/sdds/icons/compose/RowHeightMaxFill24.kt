...
public val SddsIcons.RowHeightMaxFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "RowHeightMaxFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color(0xFFF5F5F5)),
            pathData = addPathNodes("M 3.0 8.5 C 3.0 7.12 4.12 6.0 5.5 6.0 h 13.0 C 19.88 6.0 21.0 7.12 21.0 8.5 v 7.0 c 0.0 1.38 -1.12 2.5 -2.5 2.5 h -13.0 C 4.12 18.0 3.0 16.88 3.0 15.5 v -7.0 Z")
        )
        addPath(
            fill = SolidColor(Color(0xFFF5F5F5)),
