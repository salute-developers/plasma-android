...
public val SddsIcons.BlankJpgOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BlankJpgOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 14.97 16.04 v 0.703 h 0.634 v 0.648 c -0.12 0.032 -0.27 0.07 -0.494 0.07 c -0.685 0.0 -0.995 -0.33 -0.995 -1.197 c 0.0 -0.83 0.29 -1.164 1.065 -1.164 c 0.364 0.0 0.665 0.095 0.904 0.25 v -0.835 c -0.16 -0.075 -0.47 -0.165 -0.96 -0.165 c -1.33 0.0 -1.854 0.622 -1.854 1.962 c 0.0 1.324 0.555 1.898 1.774 1.898 c 0.59 0.0 1.055 -0.16 1.276 -0.282 v -1.887 h -1.35 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 10.191 18.14 v -3.71 l 0.162 -0.008 c 0.34 -0.017 0.58 -0.03 1.028 -0.03 c 1.105 0.0 1.515 0.357 1.515 1.303 c 0.0 0.962 -0.465 1.404 -1.525 1.404 c -0.13 0.0 -0.23 -0.006 -0.36 -0.016 v 1.058 h -0.82 Z m 0.82 -1.775 c 0.135 0.01 0.22 0.016 0.36 0.016 c 0.51 0.0 0.68 -0.213 0.68 -0.643 c 0.0 -0.426 -0.145 -0.628 -0.685 -0.628 c -0.135 0.0 -0.225 0.0 -0.355 0.016 v 1.24 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 8.56 14.419 v 2.472 c 0.0 0.426 -0.12 0.532 -0.42 0.532 c -0.195 0.0 -0.4 -0.08 -0.49 -0.16 v 0.835 c 0.155 0.048 0.33 0.085 0.615 0.085 c 0.825 0.0 1.115 -0.335 1.115 -1.18 v -2.584 H 8.56 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
