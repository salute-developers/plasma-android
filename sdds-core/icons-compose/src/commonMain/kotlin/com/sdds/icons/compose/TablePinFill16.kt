...
public val SddsIcons.TablePinFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TablePinFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
