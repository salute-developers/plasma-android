...
public val SddsIcons.CoinRandFallingOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CoinRandFallingOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 9.75 11.0 c 0.0 -0.276 0.224 -0.5 0.5 -0.5 h 2.147 c 1.3 0.0 2.353 1.053 2.353 2.353 c 0.0 1.063 -0.705 1.96 -1.672 2.253 l 1.6 2.635 c 0.143 0.236 0.067 0.543 -0.169 0.686 c -0.236 0.144 -0.543 0.069 -0.686 -0.168 l -1.854 -3.053 H 10.75 V 18.0 c 0.0 0.276 -0.224 0.5 -0.5 0.5 s -0.5 -0.224 -0.5 -0.5 v -7.0 Z m 1.0 3.206 h 1.491 h 0.017 h 0.14 c 0.746 0.0 1.352 -0.606 1.352 -1.353 S 13.144 11.5 12.397 11.5 H 10.75 v 2.706 Z")
        )
    }.build()
}
