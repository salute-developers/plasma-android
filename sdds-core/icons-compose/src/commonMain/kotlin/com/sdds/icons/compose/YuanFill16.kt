...
public val SddsIcons.YuanFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "YuanFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
