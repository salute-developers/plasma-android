...
public val SddsIcons.BatteryHoriz80Outline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BatteryHoriz80Outline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 9.1 9.0 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 0.5 c 0.276 0.0 0.5 0.224 0.5 0.5 v 6.0 c 0.0 0.276 -0.224 0.5 -0.5 0.5 H 9.6 c -0.277 0.0 -0.5 -0.224 -0.5 -0.5 V 9.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 11.4 9.0 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 0.5 c 0.276 0.0 0.5 0.224 0.5 0.5 v 6.0 c 0.0 0.276 -0.224 0.5 -0.5 0.5 h -0.5 c -0.277 0.0 -0.5 -0.224 -0.5 -0.5 V 9.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 13.7 9.0 c 0.0 -0.276 0.223 -0.5 0.5 -0.5 h 0.5 c 0.275 0.0 0.5 0.224 0.5 0.5 v 6.0 c 0.0 0.276 -0.225 0.5 -0.5 0.5 h -0.5 c -0.277 0.0 -0.5 -0.224 -0.5 -0.5 V 9.0 Z")
        )
    }.build()
}
