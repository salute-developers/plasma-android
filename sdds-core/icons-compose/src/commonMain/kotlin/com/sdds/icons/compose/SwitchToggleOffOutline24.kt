...
public val SddsIcons.SwitchToggleOffOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "SwitchToggleOffOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 8.0 15.0 c 1.657 0.0 3.0 -1.343 3.0 -3.0 S 9.657 9.0 8.0 9.0 s -3.0 1.343 -3.0 3.0 s 1.343 3.0 3.0 3.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
