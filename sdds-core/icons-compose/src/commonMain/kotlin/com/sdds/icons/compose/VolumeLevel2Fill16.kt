...
public val SddsIcons.VolumeLevel2Fill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "VolumeLevel2Fill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 12.144 2.9 c 0.193 -0.197 0.51 -0.2 0.707 -0.006 c 0.68 0.67 1.221 1.465 1.59 2.341 C 14.81 6.112 15.0 7.051 15.0 8.0 c 0.0 0.949 -0.19 1.888 -0.559 2.765 c -0.369 0.876 -0.91 1.672 -1.59 2.341 c -0.197 0.194 -0.514 0.191 -0.707 -0.005 c -0.194 -0.197 -0.191 -0.514 0.005 -0.707 c 0.588 -0.578 1.053 -1.264 1.37 -2.017 C 13.837 9.623 14.0 8.815 14.0 8.0 c 0.0 -0.815 -0.163 -1.623 -0.48 -2.377 c -0.318 -0.753 -0.783 -1.439 -1.37 -2.017 c -0.197 -0.193 -0.2 -0.51 -0.006 -0.707 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
