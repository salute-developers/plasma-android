...
public val SddsIcons.AlarmAddOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "AlarmAddOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 12.75 7.75 C 12.75 7.336 12.414 7.0 12.0 7.0 s -0.75 0.336 -0.75 0.75 v 3.5 h -3.5 C 7.336 11.25 7.0 11.586 7.0 12.0 s 0.336 0.75 0.75 0.75 h 3.5 v 3.5 c 0.0 0.414 0.336 0.75 0.75 0.75 s 0.75 -0.336 0.75 -0.75 v -3.5 h 3.5 c 0.414 0.0 0.75 -0.336 0.75 -0.75 s -0.336 -0.75 -0.75 -0.75 h -3.5 v -3.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
