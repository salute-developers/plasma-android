...
public val SddsIcons.PipOnFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "PipOnFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
