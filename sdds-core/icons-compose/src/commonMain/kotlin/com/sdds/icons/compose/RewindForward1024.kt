...
public val SddsIcons.RewindForward1024: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "RewindForward1024",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 12.0 20.5 c -4.694 0.0 -8.5 -3.806 -8.5 -8.5 c 0.0 -3.105 1.665 -5.822 4.153 -7.306 v 1.653 c 0.0 0.414 0.336 0.75 0.75 0.75 s 0.75 -0.336 0.75 -0.75 V 2.75 C 9.153 2.336 8.817 2.0 8.403 2.0 H 4.806 c -0.415 0.0 -0.75 0.336 -0.75 0.75 S 4.39 3.5 4.806 3.5 H 6.73 C 3.89 5.264 2.0 8.41 2.0 12.0 c 0.0 5.523 4.477 10.0 10.0 10.0 s 10.0 -4.477 10.0 -10.0 c 0.0 -4.145 -2.521 -7.699 -6.11 -9.215 c -0.382 -0.162 -0.822 0.017 -0.984 0.399 c -0.16 0.381 0.018 0.821 0.4 0.982 C 18.358 5.456 20.5 8.48 20.5 12.0 c 0.0 4.694 -3.806 8.5 -8.5 8.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
