...
public val SddsIcons.TvPlayOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "TvPlayOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 23.375 13.985 c 1.167 0.673 1.167 2.357 0.0 3.03 l -6.75 3.898 C 15.458 21.587 14.0 20.744 14.0 19.397 v -7.794 c 0.0 -1.347 1.458 -2.189 2.625 -1.515 l 6.75 3.897 Z M 22.0 15.5 l -6.0 -3.464 v 6.928 l 6.0 -3.464 Z")
        )
    }.build()
}
