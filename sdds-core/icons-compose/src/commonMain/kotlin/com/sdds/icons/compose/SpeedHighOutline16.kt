...
public val SddsIcons.SpeedHighOutline16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "SpeedHighOutline16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 10.147 4.4 c 0.195 -0.2 0.511 -0.2 0.707 0.0 l 3.164 3.251 c 0.189 0.194 0.189 0.504 0.0 0.698 l -3.164 3.25 c -0.196 0.201 -0.512 0.201 -0.707 0.0 c -0.196 -0.2 -0.196 -0.525 0.0 -0.726 L 12.943 8.0 l -2.796 -2.873 c -0.196 -0.2 -0.196 -0.526 0.0 -0.727 Z")
        )
    }.build()
}
