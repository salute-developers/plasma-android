...
public val SddsIcons.SortAlphabetAsc24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "SortAlphabetAsc24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 13.978 13.881 c -0.297 0.288 -0.305 0.763 -0.017 1.06 l 2.5 2.581 c 0.142 0.146 0.336 0.229 0.539 0.229 s 0.397 -0.083 0.539 -0.229 l 2.5 -2.58 c 0.288 -0.298 0.28 -0.773 -0.017 -1.06 c -0.298 -0.289 -0.772 -0.281 -1.06 0.016 l -1.212 1.25 V 7.0 c 0.0 -0.414 -0.336 -0.75 -0.75 -0.75 S 16.25 6.586 16.25 7.0 v 8.148 l -1.211 -1.25 c -0.288 -0.297 -0.763 -0.305 -1.06 -0.017 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
