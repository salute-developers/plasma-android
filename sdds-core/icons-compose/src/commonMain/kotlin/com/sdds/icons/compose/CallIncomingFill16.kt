...
public val SddsIcons.CallIncomingFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CallIncomingFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 14.483 4.269 c 0.138 0.239 0.056 0.545 -0.183 0.683 L 10.336 7.24 l 1.853 0.337 c 0.272 0.05 0.452 0.31 0.402 0.581 c -0.05 0.272 -0.31 0.452 -0.581 0.403 L 8.817 7.98 c -0.145 -0.027 -0.27 -0.115 -0.344 -0.242 C 8.4 7.61 8.386 7.459 8.435 7.32 L 9.53 4.264 c 0.093 -0.26 0.379 -0.395 0.639 -0.302 c 0.26 0.093 0.395 0.379 0.302 0.639 L 9.836 6.375 l 3.964 -2.29 c 0.24 -0.137 0.545 -0.055 0.683 0.184 Z")
        )
    }.build()
}
