...
public val SddsIcons.GroupAltFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "GroupAltFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        ...
        addPath(
            ...
            pathData = addPathNodes("M 16.25 10.25 c 0.828 0.0 1.5 0.672 1.5 1.5 v 4.5 c 0.0 0.828 -0.672 1.5 -1.5 1.5 h -4.5 c -0.828 0.0 -1.5 -0.672 -1.5 -1.5 v -1.5 h 2.25 c 1.243 0.0 2.25 -1.007 2.25 -2.25 v -2.25 h 1.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 12.25 6.25 c 0.828 0.0 1.5 0.672 1.5 1.5 v 4.5 c 0.0 0.828 -0.672 1.5 -1.5 1.5 h -4.5 c -0.828 0.0 -1.5 -0.672 -1.5 -1.5 v -4.5 c 0.0 -0.828 0.672 -1.5 1.5 -1.5 h 4.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
