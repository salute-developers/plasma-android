...
public val SddsIcons.ProductImportOutline16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ProductImportOutline16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 12.0 8.25 c 2.071 0.0 3.75 1.68 3.75 3.75 c 0.0 2.071 -1.679 3.75 -3.75 3.75 c -2.071 0.0 -3.75 -1.679 -3.75 -3.75 c 0.0 -2.07 1.679 -3.75 3.75 -3.75 Z m -0.093 1.798 c -0.136 -0.137 -0.358 -0.136 -0.495 0.0 l -1.704 1.704 c -0.137 0.137 -0.137 0.359 0.0 0.495 l 1.704 1.704 c 0.137 0.137 0.359 0.137 0.495 0.0 c 0.12 -0.12 0.134 -0.303 0.045 -0.44 l -0.045 -0.055 L 10.8 12.35 h 3.246 l 0.07 -0.007 c 0.16 -0.033 0.28 -0.175 0.28 -0.344 c 0.0 -0.193 -0.157 -0.35 -0.35 -0.35 H 10.8 l 1.107 -1.107 c 0.136 -0.136 0.136 -0.357 0.0 -0.494 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
