...
public val SddsIcons.ZoomMinusOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "ZoomMinusOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 7.0 9.75 c -0.414 0.0 -0.75 0.336 -0.75 0.75 S 6.586 11.25 7.0 11.25 h 7.0 c 0.414 0.0 0.75 -0.336 0.75 -0.75 S 14.414 9.75 14.0 9.75 H 7.0 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
