...
public val SddsIcons.CallOutgoingFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CallOutgoingFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 8.473 7.739 c -0.138 -0.24 -0.056 -0.545 0.183 -0.683 l 3.964 -2.29 l -1.853 -0.336 c -0.271 -0.05 -0.452 -0.31 -0.402 -0.582 c 0.05 -0.272 0.31 -0.452 0.581 -0.402 l 3.194 0.58 c 0.144 0.027 0.27 0.116 0.343 0.243 c 0.073 0.127 0.087 0.28 0.038 0.418 l -1.094 3.056 c -0.092 0.26 -0.379 0.396 -0.639 0.303 c -0.26 -0.093 -0.395 -0.38 -0.302 -0.64 l 0.634 -1.773 l -3.964 2.289 C 8.916 8.06 8.611 7.978 8.473 7.739 Z")
        )
    }.build()
}
