...
public val SddsIcons.Button2X2TopROutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "Button2X2TopROutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 15.25 2.0 C 14.007 2.0 13.0 3.007 13.0 4.25 v 4.5 C 13.0 9.993 14.007 11.0 15.25 11.0 h 4.5 C 20.993 11.0 22.0 9.993 22.0 8.75 v -4.5 C 22.0 3.007 20.993 2.0 19.75 2.0 h -4.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
