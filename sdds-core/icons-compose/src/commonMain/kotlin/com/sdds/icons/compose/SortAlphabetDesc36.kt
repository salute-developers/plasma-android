...
public val SddsIcons.SortAlphabetDesc36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "SortAlphabetDesc36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 30.196 15.09 c 0.396 -0.384 0.406 -1.017 0.022 -1.413 l -3.75 -3.871 C 26.28 9.61 26.021 9.5 25.75 9.5 c -0.27 0.0 -0.53 0.11 -0.718 0.305 l -3.75 3.87 c -0.384 0.397 -0.375 1.03 0.022 1.415 c 0.397 0.384 1.03 0.374 1.414 -0.023 l 2.032 -2.097 V 25.5 c 0.0 0.553 0.448 1.0 1.0 1.0 s 1.0 -0.447 1.0 -1.0 v -12.53 l 2.032 2.097 c 0.384 0.397 1.017 0.407 1.414 0.023 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
