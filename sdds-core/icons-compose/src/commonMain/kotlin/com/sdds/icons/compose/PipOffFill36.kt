...
public val SddsIcons.PipOffFill36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "PipOffFill36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
