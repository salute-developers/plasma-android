...
public val SddsIcons.BlankTxtOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BlankTxtOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 14.835 15.156 v 3.194 h 0.815 v -3.194 h 1.01 V 14.35 h -2.835 v 0.806 h 1.01 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 10.354 18.35 l 1.02 -2.051 l -0.944 -1.949 h 0.95 l 0.634 1.337 l 0.66 -1.337 h 0.936 l -1.005 1.932 l 1.06 2.068 H 12.7 l -0.72 -1.423 l -0.686 1.423 h -0.94 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 8.35 15.156 v 3.194 h 0.815 v -3.194 h 1.01 V 14.35 H 7.34 v 0.806 h 1.01 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
