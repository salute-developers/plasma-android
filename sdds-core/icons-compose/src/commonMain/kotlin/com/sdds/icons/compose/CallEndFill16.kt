...
public val SddsIcons.CallEndFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CallEndFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        ...
        addPath(
            ...
            pathData = addPathNodes("M 8.0 7.2 c 0.276 0.0 0.5 0.224 0.5 0.5 v 4.577 l 1.219 -1.436 c 0.178 -0.21 0.494 -0.236 0.705 -0.057 c 0.21 0.178 0.236 0.494 0.057 0.704 l -2.1 2.475 C 8.286 14.075 8.147 14.14 8.0 14.14 s -0.286 -0.065 -0.381 -0.177 l -2.1 -2.475 c -0.179 -0.21 -0.153 -0.526 0.058 -0.704 c 0.21 -0.18 0.526 -0.153 0.704 0.057 L 7.5 12.278 V 7.7 c 0.0 -0.276 0.224 -0.5 0.5 -0.5 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
