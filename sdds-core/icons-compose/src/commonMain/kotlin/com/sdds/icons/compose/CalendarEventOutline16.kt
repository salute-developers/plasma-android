...
public val SddsIcons.CalendarEventOutline16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CalendarEventOutline16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 6.5 11.0 c 0.0 0.828 -0.672 1.5 -1.5 1.5 S 3.5 11.828 3.5 11.0 S 4.172 9.5 5.0 9.5 s 1.5 0.672 1.5 1.5 Z")
        )
    }.build()
}
