...
public val SddsIcons.MessageAttentionFill24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "MessageAttentionFill24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 12.025 7.725 c 0.47 0.0 0.85 0.38 0.85 0.85 v 3.4 c 0.0 0.47 -0.38 0.85 -0.85 0.85 s -0.85 -0.38 -0.85 -0.85 v -3.4 c 0.0 -0.47 0.38 -0.85 0.85 -0.85 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 12.875 15.375 c 0.0 0.47 -0.38 0.85 -0.85 0.85 s -0.85 -0.38 -0.85 -0.85 s 0.38 -0.85 0.85 -0.85 s 0.85 0.38 0.85 0.85 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
