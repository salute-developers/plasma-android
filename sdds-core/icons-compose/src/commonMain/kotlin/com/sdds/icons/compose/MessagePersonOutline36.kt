...
public val SddsIcons.MessagePersonOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "MessagePersonOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 22.697 15.265 c 0.0 2.53 -2.051 4.582 -4.582 4.582 c -2.53 0.0 -4.582 -2.051 -4.582 -4.582 c 0.0 -2.53 2.052 -4.582 4.582 -4.582 s 4.582 2.052 4.582 4.582 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 25.201 23.167 c -1.61 2.156 -4.184 3.552 -7.083 3.552 s -5.472 -1.396 -7.083 -3.552 c 2.128 -1.077 4.535 -1.684 7.083 -1.684 c 2.549 0.0 4.955 0.607 7.084 1.684 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
