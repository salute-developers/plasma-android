...
public val SddsIcons.BirrOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BirrOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        ...
        addPath(
            ...
            pathData = addPathNodes("M 12.0 10.75 c -0.552 0.0 -1.0 0.448 -1.0 1.0 V 24.5 c 0.0 0.552 0.448 1.0 1.0 1.0 h 3.525 c 2.332 0.0 4.214 -1.905 4.187 -4.237 c -0.02 -1.642 -0.982 -3.054 -2.368 -3.723 c 0.567 -0.715 0.906 -1.62 0.906 -2.602 c 0.0 -2.313 -1.875 -4.188 -4.188 -4.188 H 12.0 Z m 1.0 12.75 v -4.375 h 2.525 c 1.198 0.0 2.173 0.964 2.187 2.162 c 0.014 1.218 -0.97 2.213 -2.187 2.213 H 13.0 Z m 1.063 -6.375 H 13.0 V 12.75 h 1.063 c 1.208 0.0 2.187 0.98 2.187 2.188 c 0.0 1.208 -0.98 2.187 -2.188 2.187 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
