...
public val SddsIcons.BlankXlsOutline24: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "BlankXlsOutline24",
        defaultWidth = 24.dp,
        defaultHeight = 24.dp,
        viewportWidth = 24f,
        viewportHeight = 24f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 15.02 16.738 c 0.33 0.113 0.606 0.207 0.606 0.472 c 0.0 0.242 -0.175 0.402 -0.59 0.402 c -0.56 0.0 -0.935 -0.276 -1.115 -0.446 v 0.92 c 0.255 0.16 0.705 0.264 1.16 0.264 c 1.015 0.0 1.44 -0.43 1.44 -1.174 c 0.0 -0.89 -0.65 -1.101 -1.165 -1.269 c -0.339 -0.11 -0.62 -0.201 -0.62 -0.455 c 0.0 -0.204 0.125 -0.364 0.6 -0.364 c 0.375 0.0 0.755 0.15 1.005 0.337 v -0.888 c -0.24 -0.11 -0.625 -0.187 -1.07 -0.187 c -1.0 0.0 -1.365 0.424 -1.365 1.119 c 0.0 0.888 0.618 1.1 1.114 1.269 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 11.285 18.279 v -3.857 h 0.82 v 3.03 h 1.54 v 0.827 h -2.36 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 8.52 16.3 L 7.5 18.28 h 0.94 l 0.685 -1.372 l 0.72 1.372 h 0.965 l -1.06 -1.995 l 1.005 -1.862 H 9.82 l -0.66 1.29 l -0.635 -1.29 h -0.95 L 8.52 16.3 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
