...
public val SddsIcons.CoinYuanFallingOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CoinYuanFallingOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            fill = SolidColor(Color.White),
            pathData = addPathNodes("M 18.75 23.308 h 2.75 c 0.414 0.0 0.75 -0.336 0.75 -0.75 c 0.0 -0.415 -0.336 -0.75 -0.75 -0.75 h -2.154 l 3.042 -4.913 c 0.218 -0.352 0.109 -0.815 -0.243 -1.033 c -0.352 -0.218 -0.815 -0.109 -1.033 0.243 L 18.0 21.133 l -3.112 -5.028 c -0.218 -0.352 -0.68 -0.46 -1.033 -0.243 c -0.352 0.218 -0.46 0.68 -0.243 1.033 l 3.042 4.913 H 14.5 c -0.414 0.0 -0.75 0.335 -0.75 0.75 c 0.0 0.414 0.336 0.75 0.75 0.75 h 2.75 v 1.961 H 14.5 c -0.414 0.0 -0.75 0.336 -0.75 0.75 c 0.0 0.415 0.336 0.75 0.75 0.75 h 2.75 v 0.98 c 0.0 0.415 0.336 0.75 0.75 0.75 s 0.75 -0.335 0.75 -0.75 v -0.98 h 2.75 c 0.414 0.0 0.75 -0.335 0.75 -0.75 c 0.0 -0.414 -0.336 -0.75 -0.75 -0.75 h -2.75 v -1.961 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
            pathFillType = PathFillType.EvenOdd,
            pathData = addPathNodes("M 29.25 21.75 c 0.0 -6.213 -5.037 -11.25 -11.25 -11.25 S 6.75 15.537 6.75 21.75 S 11.787 33.0 18.0 33.0 s 11.25 -5.037 11.25 -11.25 Z m -11.25 -9.0 c 4.97 0.0 9.0 4.03 9.0 9.0 s -4.03 9.0 -9.0 9.0 s -9.0 -4.03 -9.0 -9.0 s 4.03 -9.0 9.0 -9.0 Z")
        )
    }.build()
}
