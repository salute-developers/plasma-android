...
public val SddsIcons.CameraVideoRecOutline36: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CameraVideoRecOutline36",
        defaultWidth = 36.dp,
        defaultHeight = 36.dp,
        viewportWidth = 36f,
        viewportHeight = 36f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 16.75 18.288 c 0.0 1.795 -1.455 3.25 -3.25 3.25 s -3.25 -1.455 -3.25 -3.25 s 1.455 -3.25 3.25 -3.25 s 3.25 1.455 3.25 3.25 Z")
        )
        addPath(
            fill = SolidColor(Color.White),
