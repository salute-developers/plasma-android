...
public val SddsIcons.CallBlockFill16: ImageVector by lazy(LazyThreadSafetyMode.NONE) {
    ImageVector.Builder(
        name = "CallBlockFill16",
        defaultWidth = 16.dp,
        defaultHeight = 16.dp,
        viewportWidth = 16f,
        viewportHeight = 16f
        ...
        addPath(
            ...
            pathData = addPathNodes("M 10.086 4.66 l 3.579 2.065 c 0.271 -0.92 -0.11 -1.94 -0.977 -2.44 s -1.94 -0.32 -2.602 0.374 Z m 3.079 2.931 L 9.585 5.525 c -0.271 0.92 0.11 1.94 0.977 2.44 c 0.867 0.501 1.94 0.321 2.601 -0.374 Z M 8.918 4.563 c 0.863 -1.495 2.774 -2.007 4.269 -1.144 c 1.495 0.863 2.007 2.774 1.144 4.269 c -0.863 1.495 -2.774 2.007 -4.27 1.144 c -1.494 -0.863 -2.006 -2.774 -1.143 -4.27 Z")
        )
    }.build()
}
