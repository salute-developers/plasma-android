...
/**
 * A [ProvidableCompositionLocal] which provides the default [HazeBlurStyle] for all [com.sdds.haze.hazeEffect]
 ...
 *
 *  - Value set in [com.sdds.haze.HazeEffectScope], if specified.
 *  - Value set in style provided to [com.sdds.haze.hazeEffect] (or [com.sdds.haze.HazeEffectScope.style]), if specified.
 ...
 *
 * Can be set via [com.sdds.haze.hazeSource] and [com.sdds.haze.hazeEffect].
 *
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        imports = ["com.sdds.haze.blur.HazeBlurStyle"],
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        imports = ["com.sdds.haze.blur.LocalHazeBlurStyle"],
    ),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        imports = ["com.sdds.haze.blur.HazeColorEffect"],
    ),
)
