...
public interface VisualEffectContext {
    ...
    /**
     * Returns the [requireLayoutDirection].
     */
    public fun requireLayoutDirection(): LayoutDirection
}
...
internal class HazeEffectNodeVisualEffectContext(
    ...
    override fun requireLayoutDirection(): LayoutDirection = node.requireLayoutDirection()
}
