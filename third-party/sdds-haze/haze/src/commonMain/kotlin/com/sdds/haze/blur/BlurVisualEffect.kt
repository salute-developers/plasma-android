...
import com.sdds.haze.HazeInputScale
import com.sdds.haze.HazeLogger
import com.sdds.haze.VisualEffect
...
public class BlurVisualEffect : VisualEffect {
    ...
    override fun update(context: VisualEffectContext) {
        ...
        _clipPath = context.createClipPathIfNeeded()
    ...
    public var shape: Shape = RectangleShape
        set(value) {
            if (value != field) {
                HazeLogger.d(TAG) { "blurredEdgeTreatment changed. Current: $field. New: $value" }
                field = value
                dirtyTracker += BlurDirtyFields.Shape
            }
        }
