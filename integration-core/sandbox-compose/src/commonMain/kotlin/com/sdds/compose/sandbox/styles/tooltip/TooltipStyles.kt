...
package com.sdds.compose.sandbox.styles.tooltip
...
private val TooltipStyleBuilder.invariantProps: TooltipStyleBuilder
    ...
    get() = this
        ...
        .colors {
            ...
            textColor(SolidColor(SddsSandboxTheme.colors.textDefaultPrimary).asStatefulValue())
            contentStartColor(SddsSandboxTheme.colors.textDefaultSecondary.asInteractive())
        }
        .dimensions {
