...
package com.sdds.compose.sandbox.styles.notificationcontent

import androidx.compose.runtime.Composable
import androidx.compose.ui.unit.dp
import com.sdds.compose.sandbox.styles.buttongroup.BasicButtonGroup
import com.sdds.compose.sandbox.styles.buttongroup.Default
import com.sdds.compose.sandbox.styles.buttongroup.Dense
import com.sdds.compose.sandbox.styles.buttongroup.Xs
import com.sdds.compose.sandbox.styles.buttongroup.Xxs
...
private val NotificationContentStyleBuilder.invariantProps: NotificationContentStyleBuilder
    @Composable
    get() = this
        .icon(imageVectorSource(SddsIcons.InfoCircleOutline24))
