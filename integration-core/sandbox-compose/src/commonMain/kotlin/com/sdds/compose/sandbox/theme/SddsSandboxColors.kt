...
import com.sdds.compose.sandbox.tokens.DarkColorTokens
import com.sdds.compose.sandbox.tokens.LightColorTokens
 ...
 */
@Immutable
public class SddsSandboxColors(
    ...
    /**
     * Возвращает копию [SddsSandboxColors]. Предоставляет возможность переопределять цвета.
     */
    public fun copy(overrideColors: ColorOverrideScope.() -> Unit = {}): SddsSandboxColors {
        ...
        return SddsSandboxColors(colors.mapValues { overrideMap[it.key] ?: it.value })
    }

    /**
     * Возвращает копию [SddsSandboxColors]. Предоставляет возможность переопределять цвета.
     */
    internal fun copyAttrs(overrideColors: ColorAttrOverrideScope.() -> Unit = {}): SddsSandboxColors {
        val colorOverrideScope = ColorAttrOverrideScope()
        overrideColors.invoke(colorOverrideScope)
        val overrideMap = colorOverrideScope.overrideMap
        return SddsSandboxColors(colors.mapValues { colors[overrideMap[it.key]] ?: it.value })
    }
}
...
internal val LocalSddsSandboxColors: ProvidableCompositionLocal<SddsSandboxColors> =
    staticCompositionLocalOf {
        lightSddsSandboxColors()
    }

@Suppress("LongMethod")
internal fun SddsSandboxColors.updateColorsFrom(other: SddsSandboxColors) {
...
/**
 * Цвета [SddsSandboxColors] для светлой темы
 */
@Suppress("LongMethod")
public fun lightSddsSandboxColors(overrideColors: ColorOverrideScope.() -> Unit = {}): SddsSandboxColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    ...
    return SddsSandboxColors(initial)
}

/**
 * Цвета [SddsSandboxColors] для темной темы
 */
@Suppress("LongMethod")
public fun darkSddsSandboxColors(overrideColors: ColorOverrideScope.() -> Unit = {}): SddsSandboxColors {
    val colorOverrideScope = ColorOverrideScope()
    overrideColors.invoke(colorOverrideScope)
    val overwrite = colorOverrideScope.overrideMap
    val initial = mutableMapOf<String, Color>()
