...
package com.sdds.compose.sandbox.styles.tabitem
...
private val TabItemStyleBuilder.invariantProps: TabItemStyleBuilder
    ...
    get() = this
        .disableAlpha(0.4f)
        .actionIcon(imageVectorSource(SddsIcons.Close36))
        .colors {
            labelColor(
...
public val TabItemHeader.H1: WrapperTabItemHeaderH1
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsSandboxTheme.typography.headerH1Normal)
        .valueStyle(SddsSandboxTheme.typography.headerH1Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H2: WrapperTabItemHeaderH2
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsSandboxTheme.typography.headerH2Normal)
        .valueStyle(SddsSandboxTheme.typography.headerH2Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H3: WrapperTabItemHeaderH3
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsSandboxTheme.typography.headerH3Normal)
        .valueStyle(SddsSandboxTheme.typography.headerH3Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H4: WrapperTabItemHeaderH4
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsSandboxTheme.typography.headerH4Normal)
        .valueStyle(SddsSandboxTheme.typography.headerH4Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
...
public val TabItemHeader.H5: WrapperTabItemHeaderH5
    ...
    get() = TabItemStyle.builder(this)
        .invariantProps
        .labelStyle(SddsSandboxTheme.typography.headerH5Normal)
        .valueStyle(SddsSandboxTheme.typography.headerH5Normal)
        .dimensions {
            paddingStart(0.0.dp)
            paddingEnd(0.0.dp)
            valuePadding(10.0.dp)
