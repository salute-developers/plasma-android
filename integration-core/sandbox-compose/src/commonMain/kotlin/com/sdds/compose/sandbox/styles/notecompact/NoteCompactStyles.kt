...
package com.sdds.compose.sandbox.styles.notecompact
...
public val WrapperNoteCompactView.Info: WrapperNoteCompactTerminate
    ...
    get() = builder
        .colors {
            ...
            backgroundColor(SolidColor(SddsSandboxTheme.colors.surfaceDefaultTransparentInfo).asStatefulValue())
        }
        .wrap(::WrapperNoteCompactTerminate)
...
public val WrapperNoteCompactL.HasClose: WrapperNoteCompactLHasClose
    ...
    get() = builder
        .closeIcon(imageVectorSource(SddsIcons.Close24))
        .dimensions {
            closeSize(24.0.dp)
...
public val NoteCompact.S: WrapperNoteCompactS
    ...
    get() = NoteCompactStyle.builder(this)
        ...
        .contentBeforeArrangement(ContentBeforeVerticalArrangement.Top)
        .titleStyle(SddsSandboxTheme.typography.textSBold)
...
public val NoteCompact.Xs: WrapperNoteCompactXs
    ...
    get() = NoteCompactStyle.builder(this)
        ...
        .contentBeforeArrangement(ContentBeforeVerticalArrangement.Top)
        .titleStyle(SddsSandboxTheme.typography.textXsBold)
        .textStyle(SddsSandboxTheme.typography.textXsNormal)
        .dimensions {
            iconSize(16.0.dp)
            closeStartMargin(0.0.dp)
...
public val WrapperNoteCompactXs.HasClose: WrapperNoteCompactXsHasClose
    ...
    get() = builder
        .closeIcon(imageVectorSource(SddsIcons.Close16))
        .dimensions {
            closeSize(16.0.dp)
            closeStartMargin(2.0.dp)
            actionEndMargin(12.0.dp)
