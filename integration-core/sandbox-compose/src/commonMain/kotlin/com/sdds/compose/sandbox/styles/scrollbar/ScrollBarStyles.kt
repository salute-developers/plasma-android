...
package com.sdds.compose.sandbox.styles.scrollbar
...
private val ScrollBarStyleBuilder.invariantProps: ScrollBarStyleBuilder
    ...
    get() = this
        ...
        .colors {
            thumbColor(SddsSandboxTheme.colors.surfaceDefaultSolidTertiary.asInteractive())
            trackColor(SddsSandboxTheme.colors.surfaceDefaultTransparentPrimary.asInteractive())
        }
