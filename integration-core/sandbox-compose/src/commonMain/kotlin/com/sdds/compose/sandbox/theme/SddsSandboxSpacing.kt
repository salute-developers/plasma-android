...
import androidx.compose.ui.unit.dp
import com.sdds.compose.sandbox.tokens.SpacingTokens

/**
 * Отступы SddsSandbox
 */
@Immutable
public data class SddsSandboxSpacing(
    /**
     * spacing 0x
     */
...
internal val LocalSddsSandboxSpacing: ProvidableCompositionLocal<SddsSandboxSpacing> =
    staticCompositionLocalOf {
        SddsSandboxSpacing()
    }

/**
 * Возвращает [SddsSandboxSpacing]
 */
public fun defaultSddsSandboxSpacing(): SddsSandboxSpacing = SddsSandboxSpacing(
