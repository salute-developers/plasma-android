...
import com.sdds.compose.sandbox.tokens.DarkGradientTokens
import com.sdds.compose.sandbox.tokens.LightGradientTokens
...
/**
 * Градиенты SddsSandbox
 */
@Immutable
public class SddsSandboxGradients(
    ...
    /**
     * Возвращает копию [SddsSandboxGradients]. Предоставляет возможность переопределять градиенты.
     */
    public fun copy(overrideGradients: GradientOverrideScope.() -> Unit = {}): SddsSandboxGradients {
        ...
        return SddsSandboxGradients(gradients.mapValues { overrideMap[it.key] ?: it.value })
    }

    /**
     * Возвращает копию [SddsSandboxGradients]. Предоставляет возможность переопределять цвета.
     */
    internal fun copyAttrs(overrideGradients: GradientAttrOverrideScope.() -> Unit = {}): SddsSandboxGradients {
        val gradientOverrideScope = GradientAttrOverrideScope()
        overrideGradients.invoke(gradientOverrideScope)
        val overrideMap = gradientOverrideScope.overrideMap
        return SddsSandboxGradients(
            gradients.mapValues {
...
internal val LocalSddsSandboxGradients: ProvidableCompositionLocal<SddsSandboxGradients> =
...
/**
 * Градиенты [SddsSandboxGradients] для светлой темы
 */
@Suppress("LongMethod")
public fun lightSddsSandboxGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): SddsSandboxGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    ...
    return SddsSandboxGradients(initial)
}

/**
 * Градиенты [SddsSandboxGradients] для темной темы
 */
@Suppress("LongMethod")
public fun darkSddsSandboxGradients(overrideGradients: GradientOverrideScope.() -> Unit = {}): SddsSandboxGradients {
    val gradientOverrideScope = GradientOverrideScope()
    overrideGradients.invoke(gradientOverrideScope)
    val overwrite = gradientOverrideScope.overrideMap
    val initial = mutableMapOf<String, List<ShaderBrush>>()
