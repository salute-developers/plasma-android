...
package com.sdds.compose.sandbox.styles.circularprogressbar
...
private val CircularProgressBarStyleBuilder.invariantProps: CircularProgressBarStyleBuilder
    ...
    get() = this
        .valueEnabled(true)
        .colors {
            trackColor(SolidColor(SddsSandboxTheme.colors.surfaceDefaultTransparentSecondary).asStatefulValue())
            valueColor(SolidColor(SddsSandboxTheme.colors.textDefaultPrimary).asStatefulValue())
        }
...
public val CircularProgressBar.Xxl: WrapperCircularProgressBarXxl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(SddsSandboxTheme.typography.headerH2Bold)
        .dimensions {
            width(128.0.dp)
            height(128.0.dp)
...
public val CircularProgressBar.Xl: WrapperCircularProgressBarXl
    ...
    get() = CircularProgressBarStyle.builder(this)
        .invariantProps
        .valueStyle(SddsSandboxTheme.typography.headerH5Bold)
        .dimensions {
            width(88.0.dp)
            height(88.0.dp)
            trackThickness(4.0.dp)
