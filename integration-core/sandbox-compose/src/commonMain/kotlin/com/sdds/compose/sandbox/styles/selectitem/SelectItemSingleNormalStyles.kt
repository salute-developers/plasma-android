...
import com.sdds.icons.compose.Done16
import com.sdds.icons.compose.Done24
...
private val SelectItemStyleBuilder.invariantProps: SelectItemStyleBuilder
    ...
    get() = this
        ...
        .disableAlpha(0.4f)
        .colors {
            iconColor(SolidColor(SddsSandboxTheme.colors.textDefaultAccent).asStatefulValue())
            backgroundColor(
...
public val SelectItemSingleNormal.Xl: WrapperSelectItemSingleNormalXl
    ...
    get() = SelectItemStyle.builder(this)
        ...
        .icon(imageVectorSource(SddsIcons.Done24))
...
public val SelectItemSingleNormal.Xs: WrapperSelectItemSingleNormalXs
    ...
    get() = SelectItemStyle.builder(this)
        ...
        .icon(imageVectorSource(SddsIcons.Done16))
