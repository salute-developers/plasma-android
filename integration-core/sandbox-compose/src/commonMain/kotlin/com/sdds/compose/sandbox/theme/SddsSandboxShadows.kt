...
import com.sdds.compose.sandbox.tokens.ShadowTokens
 ...
 */
@Immutable
public data class SddsSandboxShadows(
    /**
     * shadow down soft s
     */
...
internal val LocalSddsSandboxShadows: ProvidableCompositionLocal<SddsSandboxShadows> =
    staticCompositionLocalOf {
        SddsSandboxShadows()
    }

/**
 * Возвращает [SddsSandboxShadows]
 */
@Suppress("LongMethod")
public fun defaultSddsSandboxShadows(): SddsSandboxShadows = SddsSandboxShadows(
