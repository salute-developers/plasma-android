...
import androidx.compose.ui.unit.dp
import com.sdds.compose.sandbox.tokens.TypographyLargeTokens
import com.sdds.compose.sandbox.tokens.TypographyMediumTokens
import com.sdds.compose.sandbox.tokens.TypographySmallTokens

/**
 * Типографика SddsSandbox
 */
@Immutable
public data class SddsSandboxTypography internal constructor(
    /**
...
internal val LocalSddsSandboxTypography: ProvidableCompositionLocal<SddsSandboxTypography> =
    staticCompositionLocalOf {
        SddsSandboxTypography()
    }

/**
 * Возвращает [SddsSandboxTypography] для WindowSizeClass.Compact
 */
public fun smallSddsSandboxTypography(): SddsSandboxTypography = SddsSandboxTypography(
...
/**
 * Возвращает [SddsSandboxTypography] для WindowSizeClass.Medium
 */
public fun mediumSddsSandboxTypography(): SddsSandboxTypography = SddsSandboxTypography(
...
/**
 * Возвращает [SddsSandboxTypography] для WindowSizeClass.Expanded
 */
public fun largeSddsSandboxTypography(): SddsSandboxTypography = SddsSandboxTypography(
...
/**
 * Возвращает разные [SddsSandboxTypography] в зависимости от ширины окна. Значение динамически
 * изменяется при изменении ширины окна.
 */
@Composable
public fun dynamicSddsSandboxTypography(): SddsSandboxTypography {
    val widthClass = collectWindowSizeInfoAsState().value.widthClass
    return when (widthClass) {
        WindowSizeClass.Expanded -> largeSddsSandboxTypography()
        WindowSizeClass.Medium -> mediumSddsSandboxTypography()
        WindowSizeClass.Compact -> smallSddsSandboxTypography()
    }
}
