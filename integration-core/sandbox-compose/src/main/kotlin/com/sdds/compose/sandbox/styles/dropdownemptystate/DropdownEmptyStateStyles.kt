...
package com.sdds.compose.sandbox.styles.dropdownemptystate

import androidx.compose.runtime.Composable
import androidx.compose.ui.unit.dp
import com.sdds.compose.sandbox.styles.basicbutton.BasicButton
import com.sdds.compose.sandbox.styles.basicbutton.Clear
...
private val DropdownEmptyStateStyleBuilder.invariantProps: DropdownEmptyStateStyleBuilder
    ...
    get() = this
        .colors {
            ...
            descriptionColor(SddsSandboxTheme.colors.textDefaultPrimary.asInteractive())
        }
...
public val DropdownEmptyState.L: WrapperDropdownEmptyStateL
    ...
    get() = DropdownEmptyStateStyle.builder(this)
        .invariantProps
        .descriptionStyle(SddsSandboxTheme.typography.bodyLNormal)
        .dimensions {
