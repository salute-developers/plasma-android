...
package com.sdds.compose.sandbox.styles.segment
...
import com.sdds.compose.sandbox.styles.segmentitem.M
import com.sdds.compose.sandbox.styles.segmentitem.Pilled
import com.sdds.compose.sandbox.styles.segmentitem.Primary
import com.sdds.compose.sandbox.styles.segmentitem.S
import com.sdds.compose.sandbox.styles.segmentitem.Secondary
import com.sdds.compose.sandbox.styles.segmentitem.SegmentItem
import com.sdds.compose.sandbox.styles.segmentitem.Xl
import com.sdds.compose.sandbox.styles.segmentitem.Xs
...
public val Segment.Xl: WrapperSegmentXl
    ...
    get() = SegmentStyle.builder(this)
        .invariantProps
        .shape(SddsSandboxTheme.shapes.roundXl.adjustBy(all = -2.0.dp))
        .dimensions {
            paddingStart(2.0.dp)
            paddingEnd(2.0.dp)
            paddingTop(2.0.dp)
