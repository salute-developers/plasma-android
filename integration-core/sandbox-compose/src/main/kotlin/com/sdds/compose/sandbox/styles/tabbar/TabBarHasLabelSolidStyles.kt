...
import com.sdds.compose.sandbox.styles.tabbaritem.L
import com.sdds.compose.sandbox.styles.tabbaritem.Label
import com.sdds.compose.sandbox.styles.tabbaritem.M
import com.sdds.compose.sandbox.styles.tabbaritem.Secondary
import com.sdds.compose.sandbox.styles.tabbaritem.TabBarItemSolid
...
public val WrapperTabBarHasLabelSolidM.Shadow: WrapperTabBarHasLabelSolidMShadow
    ...
    get() = builder
        .shadow(SddsSandboxTheme.shadows.upSoftM)
