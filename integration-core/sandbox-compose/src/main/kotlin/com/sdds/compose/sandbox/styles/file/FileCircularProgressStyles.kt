...
package com.sdds.compose.sandbox.styles.`file`
...
import com.sdds.compose.sandbox.styles.circularprogressbar.Negative
import com.sdds.compose.sandbox.styles.circularprogressbar.S
import com.sdds.compose.sandbox.styles.circularprogressbar.Xs
        ...
        .colors {
            descriptionColor(
                SddsSandboxTheme.colors.textDefaultNegative.asInteractive(
                    ...
                    setOf(InteractiveState.Pressed) to
                        SddsSandboxTheme.colors.textDefaultNegativeActive,
                ),
            )
        }
        .wrap(::WrapperFileCircularProgressTerminate)
