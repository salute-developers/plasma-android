...
package com.sdds.compose.sandbox.styles.dropdownmenu
...
import com.sdds.compose.sandbox.styles.dropdownemptystate.DropdownEmptyState
import com.sdds.compose.sandbox.styles.dropdownemptystate.HasButton
import com.sdds.compose.sandbox.styles.dropdownemptystate.L
import com.sdds.compose.sandbox.styles.dropdownemptystate.M
import com.sdds.compose.sandbox.styles.dropdownemptystate.S
import com.sdds.compose.sandbox.styles.dropdownemptystate.Xl
import com.sdds.compose.sandbox.styles.dropdownemptystate.Xs
import com.sdds.compose.sandbox.styles.list.DropdownMenuListNormal
import com.sdds.compose.sandbox.styles.list.L
import com.sdds.compose.sandbox.styles.list.M
import com.sdds.compose.sandbox.styles.list.S
import com.sdds.compose.sandbox.styles.list.Xl
import com.sdds.compose.sandbox.styles.list.Xs
import com.sdds.compose.sandbox.styles.scrollbar.S
import com.sdds.compose.sandbox.styles.scrollbar.ScrollBar
...
private val DropdownMenuStyleBuilder.invariantProps: DropdownMenuStyleBuilder
    @Composable
    get() = this
        .shadow(SddsSandboxTheme.shadows.downHardM)
        .colors {
            backgroundColor(
