...
/**
 * История компонента TextArea для сторибука.
 *
 * Демонстрирует все возможные состояния и конфигурации TextArea.
 *
 * @see Story
 * @see ViewBaseStory
 * @see ComponentKey.TextArea
 */
@Story
object TextAreaStory : ViewBaseStory<TextFieldUiState, TextArea>(
    ...
    override fun getComponent(context: Context): TextArea {
        return textArea(context) { deleteChip(it) }
            .apply {
                addChipsHandler()
            }
    }
