...
fun ButtonSizeSWarning(style: ButtonStyle) {
    Button(
        style = style,
        icons = ButtonIcons(end = rememberVectorPainter(SddsIcons.Plasma24)),
        label = "Label",
        enabled = true,
        loading = false,
        onClick = {},
...
fun ButtonSizeMSpaceBetween(style: ButtonStyle) {
    Button(
        ...
        style = style,
        icons = ButtonIcons(start = rememberVectorPainter(SddsIcons.Plasma16)),
...
fun ButtonSizeSLongText(style: ButtonStyle) {
    Button(
        style = style,
        icons = ButtonIcons(end = rememberVectorPainter(SddsIcons.Plasma16)),
        spacing = ButtonSpacing.Packed,
...
fun IconButtonLDefault(iconButtonStyle: ButtonStyle) {
    IconButton(
        ...
        icon = rememberVectorPainter(SddsIcons.Plasma24),
        onClick = {},
        enabled = true,
        loading = false,
    )
...
fun IconButtonXsDark(iconButtonStyle: ButtonStyle) {
    IconButton(
        style = iconButtonStyle,
        icon = rememberVectorPainter(SddsIcons.Plasma16),
        onClick = {},
        enabled = true,
        loading = false,
    )
