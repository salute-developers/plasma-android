 ...
 */
@Composable
fun PopoverMDefaultStrictBottomEndTopStart(
    style: PopoverStyle,
    buttonStyle: ButtonStyle,
    initialOpened: Boolean = false,
) {
    Box(modifier = Modifier.fillMaxSize()) {
        val showPopover = remember { mutableStateOf(initialOpened) }
 ...
 */
@Composable
fun PopoverMDefaultLooseTopEnd(
    style: PopoverStyle,
    buttonStyle: ButtonStyle,
    initialOpened: Boolean = false,
) {
 ...
 */
@Composable
fun PopoverMDefaultLooseStartCenterBottomEnd(
    style: PopoverStyle,
    buttonStyle: ButtonStyle,
    initialOpened: Boolean = false,
) {
