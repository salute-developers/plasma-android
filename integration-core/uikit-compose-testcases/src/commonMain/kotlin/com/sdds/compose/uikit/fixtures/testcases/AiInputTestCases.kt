...
fun AiInputCommon(
    ...
    AiInput(
        ...
        sendButton = { IconButton(iconSource = imageVectorSource(SddsIcons.SendOutline24), onClick = {}) },
        placeholder = placeholder,
    )
}

private fun ButtonGroupScope.aiInputHasActionsBefore() {
    button { IconButton(iconSource = imageVectorSource(SddsIcons.Clip24), onClick = {}) }
    button { IconButton(iconSource = imageVectorSource(SddsIcons.SettingsFilter24), onClick = {}) }
}

private fun ButtonGroupScope.aiInputHasActionsAfter() {
    button { IconButton(iconSource = imageVectorSource(SddsIcons.MicOutline24), onClick = {}) }
}
