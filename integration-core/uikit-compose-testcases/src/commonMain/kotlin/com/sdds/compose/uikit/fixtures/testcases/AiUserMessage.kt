...
private fun ButtonGroupScope.aiUserMessageActions() {
    button { IconButton(iconSource = imageVectorSource(SddsIcons.BackwardOutline24), onClick = {}) }
    ...
    button {
        IconButton(iconSource = imageVectorSource(SddsIcons.EditOutline24), onClick = {})
    }
}
