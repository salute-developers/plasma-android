...
import com.sdds.playground.sandbox.plasma.sd.service.integration.codeinput.PlasmaSdServiceCodeInputVariationsView
...
import com.sdds.playground.sandbox.plasma.sd.service.integration.notificationcontent.PlasmaSdServiceNotificationContentVariationsView
...
import com.sdds.playground.sandbox.plasma.sd.service.integration.textskeleton.PlasmaSdServiceTextSkeletonVariationsView
    ...
    override val all: Map<ComponentKey, ViewComponent<String>> =
        listOf(
            ...
            ViewComponent(
                ...
                PlasmaSdServiceDropdownMenuNormalVariationsView,
            ),
            ViewComponent(
                ComponentKey("DropdownMenuTight", CoreComponent.DROPDOWN_MENU),
                PlasmaSdServiceDropdownMenuTightVariationsView,
            ),
            ViewComponent(
                ComponentKey.Cell,
            ...
            ViewComponent(
                ...
                PlasmaSdServiceNotificationContentVariationsView,
            ),
            ViewComponent(
            ...
            ViewComponent(
                ...
                PlasmaSdServiceTextSkeletonVariationsView,
            ),
            ViewComponent(
            ...
            ViewComponent(
                ...
                PlasmaSdServiceCodeInputVariationsView,
            ),
        ).associateBy { it.key }
}
