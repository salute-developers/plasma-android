...
internal object SddsServDropdownMenuTightVariationsView : ViewStyleProvider<String>() {
    ...
    override val variations: Map<String, Int> =
        mapOf(
            "Xl" to s.Serv_Sdds_ComponentOverlays_DropdownMenuTightXl,
            "L" to s.Serv_Sdds_ComponentOverlays_DropdownMenuTightL,
            "M" to s.Serv_Sdds_ComponentOverlays_DropdownMenuTightM,
            "S" to s.Serv_Sdds_ComponentOverlays_DropdownMenuTightS,
            "Xs" to s.Serv_Sdds_ComponentOverlays_DropdownMenuTightXs,
        )
}
