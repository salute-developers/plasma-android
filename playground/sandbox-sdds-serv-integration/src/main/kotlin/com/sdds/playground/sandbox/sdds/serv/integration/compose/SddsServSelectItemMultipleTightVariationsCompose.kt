...
internal object SddsServSelectItemMultipleTightVariationsCompose : ComposeStyleProvider<String, SelectItemStyle>() {
    override val variations: Map<String, @Composable () -> SelectItemStyle> =
        mapOf(
            "Xl" to { SelectItemMultipleTight.Xl.style() },
            "L" to { SelectItemMultipleTight.L.style() },
            "M" to { SelectItemMultipleTight.M.style() },
            "S" to { SelectItemMultipleTight.S.style() },
            "Xs" to { SelectItemMultipleTight.Xs.style() },
        )
}
