...
internal object StylesSaluteRectSkeletonVariationsView : ViewStyleProvider<String>() {
    override val variations: Map<String, Int> =
        mapOf(
            ".Default" to DsR.style.Salute_StylesSalute_ComponentOverlays_RectSkeletonDefault,
            ".Lighter" to DsR.style.Salute_StylesSalute_ComponentOverlays_RectSkeletonLighter,
        )
}
