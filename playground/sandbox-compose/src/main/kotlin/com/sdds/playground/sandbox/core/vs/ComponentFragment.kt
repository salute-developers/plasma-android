...
internal abstract class ComponentFragment<State : UiState, Component : View, VM : ComponentViewModel<State>> :
    ...
    private var _propsBottomSheetCallback: PropertiesBottomSheetCallback? = null
    ...
    private fun createProperties() = _binding?.run {
        ...
        if (behavior != null) {
            ...
            _propsBottomSheetCallback = PropertiesBottomSheetCallback()
            behavior.addBottomSheetCallback(_propsBottomSheetCallback!!)
    ...
    private fun dispatchThemeChanged(theme: Theme) {
        _binding?.apply {
            ...
            _propsBottomSheetCallback?.run { offsetComponentLayout(currentOffset) }
        }
    }
    ...
    private inner class PropertiesBottomSheetCallback : BottomSheetBehavior.BottomSheetCallback() {
