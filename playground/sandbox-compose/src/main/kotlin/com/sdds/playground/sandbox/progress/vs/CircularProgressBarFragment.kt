 ...
 */
internal class CircularProgressBarFragment : ComponentFragment<CircularProgressUiState, CircularProgressBar>() {

    override val componentViewModel by viewModels<CircularProgressBarViewModel> {
