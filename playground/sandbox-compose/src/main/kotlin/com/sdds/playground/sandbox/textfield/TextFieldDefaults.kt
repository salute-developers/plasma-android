...
//    ): TextField.DotBadge {
//        return when {
//            labelPosition == LabelPlacement.Outer && hasLabel -> {
//                val horizontalPadding: Dp
//                val verticalPadding: Dp
//                if (position == TextField.DotBadge.Position.Start) {
...
//            labelPadding = if (labelPosition == LabelPlacement.Outer) {
//                outerLabelBottomPadding(size, isClear)
//            } else {
//                innerLabelToValuePadding(size)
//            },
//            helperTextPadding = if (helperTextPlacement == HelperTextPlacement.Outer || isClear) {
