...
internal fun MenuItem.preview(context: Context, style: Int): View {
    return when (this.componentKey.core) {
        ...
        CoreComponent.CELL -> cellLayout(context, style, CellUiState())
        CoreComponent.CHECKBOX -> checkBox(context, style, CheckBoxUiState())
        CoreComponent.CHECKBOX_GROUP -> checkBoxGroup(context, style, CheckBoxUiState())
        CoreComponent.CHIP -> chip(context, style, ChipUiState())
        CoreComponent.CHIP_GROUP -> chipGroup(context, style, ChipUiState())
        CoreComponent.COUNTER -> counter(context, style, CounterUiState())
        CoreComponent.INDICATOR -> indicator(context, style)
        CoreComponent.PROGRESS -> progressBar(context, style, ProgressUiState())
        CoreComponent.RADIOBOX -> radioBox(context, style, RadioBoxUiState())
        CoreComponent.RADIOBOX_GROUP -> radioBoxGroup(context, style, RadioBoxUiState())
        ...
        CoreComponent.FLOW -> flowLayout(context, style, FlowUiState())
        CoreComponent.CARD -> card(context, style, CardUiState())
        CoreComponent.DIVIDER -> divider(context, style)
